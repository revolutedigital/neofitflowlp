...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/automacao-retencao-academia',
  },
  openGraph: {
    title: "Automação de Retenção Para Academia Com IA | NeoFitFlow",
    description: "Automação completa de retenção: sistema detecta alunos em risco automaticamente e envia mensagens personalizadas no momento certo.",
    url: 'https://neofitflow.com.br/automacao-retencao-academia',
    type: "website",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <article className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Automatize a Retenção da Sua Academia: IA Detecta Risco e Age Via WhatsApp</h1>
            <p className="text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Automação end-to-end que monitora, detecta e age preventivamente sem intervenção manual.
            </p>
            <a
