...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/software-prevenir-evasao-academia',
  },
  openGraph: {
    title: "Software Para Prevenir Evasão de Alunos em Academia | NeoFitFlow",
    description: "Software com Inteligência Artificial que detecta padrões de evasão, identifica alunos em risco e age preventivamente. Previsão com 85% de precisão.",
    url: 'https://neofitflow.com.br/software-prevenir-evasao-academia',
    type: "website",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <article className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Software de IA que Previne Evasão Identificando Alunos em Risco Antes de Cancelarem</h1>
            <p className="text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Software inteligente que previne evasão através de análise preditiva e ação automática via WhatsApp.
            </p>
            <a
