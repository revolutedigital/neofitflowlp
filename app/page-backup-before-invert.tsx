  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        {/* Urgency Banner */}
        <div className="bg-red-600 text-white py-2 px-4 text-center font-bold text-sm md:text-base border-b-2 border-black" role="banner" aria-label="Oferta especial">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-4">
                <a
                  href="/blog"
                  className="hidden md:inline-block hover:text-gray-300 transition-colors font-bold"
                >
                  Blog
                </a>
                <a
                  href="#form"
                  className="bg-white text-black px-4 md:px-6 py-2 hover:bg-gray-200 transition-colors font-bold border-2 border-white flex items-center gap-2 text-sm md:text-base"
                >
        ...
        <section id="main-content" className="pt-40 pb-24 px-4 border-b-2 border-black" aria-labelledby="hero-heading">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <a
                href="#form"
                className="inline-block bg-black text-white px-10 py-5 hover:bg-gray-800 transition-colors font-bold text-lg md:text-xl border-2 border-black mb-3"
                aria-label="Agendar demonstração gratuita de 15 minutos"
              >
                📊 Ver Demonstração Gratuita (15 min)
              </a>
              <p className="text-sm md:text-base text-gray-400 mb-4 font-normal">
                Veja dashboard com alunos em risco + mensagens automáticas da IA
              </p>

              {/* Trust signals */}
              <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-xs md:text-sm text-gray-400 mt-6 font-normal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <ScrollReveal delay={0.1}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">3 faltas consecutivas é o primeiro sinal de risco - mas você só descobre quando já cancelou</p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.2}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">Ação reativa não funciona - aluno já decidiu e foi para a concorrência</p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.3}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">Sem dados, sem visibilidade, sem prevenção - evasão vira surpresa</p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">Cada aluno que cancela é dinheiro que você perde todo mês</p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.2}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">Com 100+ alunos é impossível monitorar faltas manualmente</p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.3}>
                <div className="border-2 border-black p-6 hover:bg-black hover:text-white transition-all">
                  ...
                  <p className="text-sm md:text-base text-gray-700 hover:text-gray-300 font-normal">Enquanto você não age, outra academia oferece promoção e leva seu aluno</p>
                </div>
              </ScrollReveal>
            </div>
        ...
        {/* Como Funciona */}
        <section id="solucao" className="py-24 border-b-2 border-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="space-y-8">
              {/* Etapa 1 */}
              <div className="border-2 border-white p-8 hover:bg-white hover:text-black transition-all group">
                <div className="flex items-start gap-6">
                  <div className="text-5xl">🔍</div>
                  <div className="flex-1">
                    <h3 className="text-3xl font-bold mb-3">1. IA Detecta Padrões de Risco Automaticamente</h3>
                    <p className="text-lg mb-4 text-gray-300 group-hover:text-gray-800">
                    ...
                    <div className="bg-black text-white border-2 border-white p-4 group-hover:bg-white group-hover:text-black group-hover:border-black">
              ...
              <div className="border-2 border-white p-8 hover:bg-white hover:text-black transition-all group">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white text-black border-2 border-black p-4 group-hover:bg-black group-hover:text-white group-hover:border-white">
        ...
        {/* ROI Calculator */}
        <section className="py-24 border-b-2 border-white">
          <div className="max-w-6xl mx-auto px-4">
            <ROICalculator />
          </div>
        </section>
        ...
        <section className="py-24 border-b-2 border-white">
          <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="border-2 border-white p-8">
                ...
                <div className="space-y-4">
                  <div className="border-b-2 border-gray-700 pb-4">
                    ...
                    <p className="text-gray-400 font-normal">Manual, atrasada, você só vê quando já cancelou</p>
                  </div>
                  <div className="border-b-2 border-gray-700 pb-4">
                    <p className="text-xl font-bold mb-2">Ação</p>
                    <p className="text-gray-400 font-normal">Reativa, depois do cancelamento, tarde demais</p>
                  </div>
                  <div className="border-b-2 border-gray-700 pb-4">
                    <p className="text-xl font-bold mb-2">Visibilidade</p>
                    <p className="text-gray-400 font-normal">Zero - você não sabe quem está em risco agora</p>
                  </div>
                  <div>
                    <p className="text-xl font-bold mb-2">Resultado</p>
                    <p className="text-gray-400 font-normal">Evasão alta, receita instável, surpresas ruins</p>
                  </div>
                </div>
              </div>

              <div className="border-2 border-white p-8 bg-white text-black">
            ...
            <div className="bg-white text-black border-2 border-white p-8 text-center">
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="border-2 border-black p-8 text-center hover:bg-black hover:text-white transition-all">
                ...
                <p className="text-gray-700 hover:text-gray-300 mb-4">
        ...
        <section className="py-24 border-b-2 border-white">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-6">
              <details className="group border-2 border-white p-6 hover:bg-white hover:text-black transition-all">
                <summary className="font-bold cursor-pointer text-xl">
                  💰 Quanto custa o NeoFitFlow?
                </summary>
                <p className="mt-4 text-gray-300 group-hover:text-gray-700">
            ...
            {/* CTA after FAQ */}
            <div className="mt-12 text-center bg-white text-black border-2 border-white p-8">
              ...
              <a
                href="#form"
                className="inline-block bg-black text-white px-8 py-4 font-bold hover:bg-gray-800 transition-colors text-lg border-2 border-black"
              >
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
                <div className="border-2 border-white p-6 md:p-8 hover:bg-white hover:text-black transition-all group">
                  ...
                  <div className="border-t-2 border-white group-hover:border-black pt-4">
                    <p className="font-bold">Ricardo M.</p>
                    <p className="text-sm text-gray-400 group-hover:text-gray-600">Dono - Academia Musculação • SP</p>
                ...
                <div className="border-2 border-white p-6 md:p-8 hover:bg-white hover:text-black transition-all group">
                  ...
                  <div className="border-t-2 border-white group-hover:border-black pt-4">
                    ...
                    <p className="text-sm text-gray-400 group-hover:text-gray-600">Gestor - Box CrossFit • PR</p>
                ...
                <div className="border-2 border-white p-6 md:p-8 hover:bg-white hover:text-black transition-all group">
                  ...
                  <div className="border-t-2 border-white group-hover:border-black pt-4">
                    ...
                    <p className="text-sm text-gray-400 group-hover:text-gray-600">Proprietária - Studio Pilates • RJ</p>
              ...
              <div className="bg-white text-black border-2 border-white p-8">
                <div className="grid md:grid-cols-4 gap-6 text-center">
                  ...
                  <div>
                    <p className="text-4xl md:text-5xl font-bold mb-2">30d</p>
              ...
              {/* Guarantee */}
              <div className="mt-8 bg-green-900 border-2 border-green-500 p-6 max-w-2xl mx-auto">
                <p className="text-2xl font-bold mb-3">✅ Garantia de 30 Dias</p>
                <p className="text-lg">
        ...
        <section className="py-24 border-b-2 border-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              ...
              >
                <div className="text-sm text-gray-400 group-hover:text-gray-600 mb-2">Retenção</div>
              ...
              <a
                ...
                className="border-2 border-white p-6 hover:bg-white hover:text-black transition-all group"
              >
                <div className="text-sm text-gray-400 group-hover:text-gray-600 mb-2">Automação</div>
              ...
              <a
                ...
                className="border-2 border-white p-6 hover:bg-white hover:text-black transition-all group"
              >
                <div className="text-sm text-gray-400 group-hover:text-gray-600 mb-2">Gestão</div>
            ...
            <div className="text-center">
              <a
                href="/blog"
                className="inline-block border-2 border-white px-8 py-4 font-bold hover:bg-white hover:text-black transition-colors text-lg"
              >
        ...
        <section className="py-24 bg-white text-black border-b-2 border-black">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <a
              ...
              className="inline-block bg-black text-white px-12 py-6 hover:bg-gray-800 transition-colors font-bold text-2xl border-2 border-black mb-6"
            >
        ...
        <footer className="bg-black text-white py-12 border-t-2 border-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li><a href="#solucao" className="hover:text-white transition-colors">Como Funciona</a></li>
                  <li><a href="https://wa.me/5531995255982" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Demonstração</a></li>
                  <li><a href="https://wa.me/5531995255982" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Preços</a></li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><a href="/blog/como-reduzir-evasao-alunos-academia" className="hover:text-white transition-colors">Guias de Retenção</a></li>
                  <li><a href="/blog/automatizar-whatsapp-academia-guia-completo" className="hover:text-white transition-colors">IA para Academias</a></li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-4 text-lg">Empresa</h3>
                <ul className="space-y-2 text-gray-400">
                  <li><a href="https://wa.me/5531995255982" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Contato</a></li>
                  <li><a href="https://wa.me/5531995255982" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Suporte</a></li>
                </ul>
              </div>
              <div>
            ...
            <div className="border-t-2 border-white mt-8 pt-8 text-center text-gray-400">
