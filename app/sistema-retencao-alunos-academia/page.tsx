...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/sistema-retencao-alunos-academia',
  },
  openGraph: {
    title: "Sistema de Retenção de Alunos Para Academia Com IA [2025]",
    description: "Sistema completo de retenção de alunos com IA que identifica risco de cancelamento e age automaticamente via WhatsApp. Reduza evasão em até 40%.",
    url: 'https://neofitflow.com.br/sistema-retencao-alunos-academia',
    type: "website",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <article className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Sistema de Retenção de Alunos que Previne Cancelamentos Com Inteligência Artificial</h1>
            <p className="text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Sistema completo de retenção com detecção automática de risco, dashboard em tempo real e ação preventiva via WhatsApp.
            </p>
            <a
