...
export const metadata: Metadata = {
  ...
  description: "Aprenda a calcular churn rate da sua academia corretamente. Benchmarks Brasil: 25-35%/ano é normal. Abaixo de 20% = excelente. Fórmulas e exemplos práticos.",
  ...
  alternates: { canonical: '/blog/taxa-de-cancelamento-em-academia-como-calcular-e-benchmarks-2025' },
  openGraph: {
    title: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025",
    description: "Aprenda a calcular churn rate da sua academia corretamente. Benchmarks Brasil: 25-35%/ano é normal. Abaixo de 20% = excelente. Fórmulas e exemplos práticos.",
    url: 'https://neofitflow.com.br/blog/taxa-de-cancelamento-em-academia-como-calcular-e-benchmarks-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025", item: "https://neofitflow.com.br/blog/taxa-de-cancelamento-em-academia-como-calcular-e-benchmarks-2025" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-26">25 de março de 2025</time>
                <span>•</span>
...
<h1>Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025</h1>
