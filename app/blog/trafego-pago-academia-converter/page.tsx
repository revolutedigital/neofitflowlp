...
export const metadata: Metadata = {
  title: "Tráfego Pago Para Academia: Como Converter Cliques em Matrículas | NeoFitFlow",
  description: "Guia completo sobre tráfego pago para academia: como converter cliques em matrículas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "trafego pago academia converter, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/trafego-pago-academia-converter',
  },
  openGraph: {
    title: "Tráfego Pago Para Academia: Como Converter Cliques em Matrículas",
    description: "Guia completo sobre tráfego pago para academia: como converter cliques em matrículas",
    url: 'https://neofitflow.com.br/blog/trafego-pago-academia-converter',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Tráfego Pago Para Academia: Como Converter",
    description: "Guia completo sobre tráfego pago para academia: como converter cliques em matrículas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Tráfego Pago Para Academia: Como Converter",
                item: "https://neofitflow.com.br/blog/trafego-pago-academia-converter",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Tráfego Pago Para Academia: Como Converter Cliques em Matrículas",
            description: "Guia completo sobre tráfego pago para academia: como converter cliques em matrículas",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Tráfego Pago Para Academia: Como Converter Cliques em Matrículas</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-24">24/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como tráfego pago para academia: como converter cliques em matrículas, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Tráfego Pago Para Academia: Como Converter Cliques em Matrículas não é apenas uma tendência - é uma necessidade para academias que querem
