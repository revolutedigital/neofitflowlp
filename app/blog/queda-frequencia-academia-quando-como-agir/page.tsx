...
export const metadata: Metadata = {
  title: "Queda de Frequência em Academia: Quando e Como Agir | NeoFitFlow",
  description: "Identifique quando a queda na frequência semanal é normal ou indica risco real de cancelamento e como intervir.",
  keywords: "queda frequência, redução check-ins, frequência irregular, monitoramento presença",
  alternates: {
    canonical: '/blog/queda-frequencia-academia-quando-como-agir',
  },
  openGraph: {
    title: "Queda de Frequência em Academia: Quando e Como Agir",
    description: "Identifique quando a queda na frequência semanal é normal ou indica risco real de cancelamento e como intervir.",
    url: 'https://neofitflow.com.br/blog/queda-frequencia-academia-quando-como-agir',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Queda de Frequência em Academia: Quando e Como Agir",
                item: "https://neofitflow.com.br/blog/queda-frequencia-academia-quando-como-agir",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Queda de Frequência em Academia: Quando e Como Agir",
            description: "Identifique quando a queda na frequência semanal é normal ou indica risco real de cancelamento e como intervir.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Queda de Frequência em Academia: Quando e Como Agir</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar queda de frequência em academia: quando e como agir, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Queda de Frequência em Academia: Quando e Como Agir não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
