...
export const metadata: Metadata = {
  title: "Mensagens Automáticas de Renovação: Como Configurar e Exemplos | NeoFitFlow",
  description: "Guia completo sobre mensagens automáticas de renovação: como configurar e exemplos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "mensagens automaticas renovacao academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/mensagens-automaticas-renovacao-academia',
  },
  openGraph: {
    title: "Mensagens Automáticas de Renovação: Como Configurar e Exemplos",
    description: "Guia completo sobre mensagens automáticas de renovação: como configurar e exemplos",
    url: 'https://neofitflow.com.br/blog/mensagens-automaticas-renovacao-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Mensagens Automáticas de Renovação",
    description: "Guia completo sobre mensagens automáticas de renovação: como configurar e exemplos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Mensagens Automáticas de Renovação",
                item: "https://neofitflow.com.br/blog/mensagens-automaticas-renovacao-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Mensagens Automáticas de Renovação: Como Configurar e Exemplos",
            description: "Guia completo sobre mensagens automáticas de renovação: como configurar e exemplos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Mensagens Automáticas de Renovação: Como Configurar e Exemplos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-18">18/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como mensagens automáticas de renovação: como configurar e exemplos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Mensagens Automáticas de Renovação: Como Configurar e Exemplos não é apenas uma tendência - é uma necessidade para academias que querem
