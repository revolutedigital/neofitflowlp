...
export const metadata: Metadata = {
  title: "Fluxo de Automação WhatsApp Para Leads: Do Primeiro Contato à Matrícula | NeoFitFlow",
  description: "Guia completo sobre fluxo de automação whatsapp para leads: do primeiro contato à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "fluxo automacao whatsapp leads, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/fluxo-automacao-whatsapp-leads',
  },
  openGraph: {
    title: "Fluxo de Automação WhatsApp Para Leads: Do Primeiro Contato à Matrícula",
    description: "Guia completo sobre fluxo de automação whatsapp para leads: do primeiro contato à matrícula",
    url: 'https://neofitflow.com.br/blog/fluxo-automacao-whatsapp-leads',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Fluxo de Automação WhatsApp Para Leads",
    description: "Guia completo sobre fluxo de automação whatsapp para leads: do primeiro contato à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Fluxo de Automação WhatsApp Para Leads",
                item: "https://neofitflow.com.br/blog/fluxo-automacao-whatsapp-leads",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Fluxo de Automação WhatsApp Para Leads: Do Primeiro Contato à Matrícula",
            description: "Guia completo sobre fluxo de automação whatsapp para leads: do primeiro contato à matrícula",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Fluxo de Automação WhatsApp Para Leads: Do Primeiro Contato à Matrícula</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-24">24/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como fluxo de automação whatsapp para leads: do primeiro contato à matrícula, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Fluxo de Automação WhatsApp Para Leads: Do Primeiro Contato à Matrícula não é apenas uma tendência - é uma necessidade para academias que querem
