...
export const metadata: Metadata = {
  ...
  description: "5 scripts testados e aprovados para aluno sumido: 1) Sentimos falta 2) Tudo bem? 3) Como podemos ajudar 4) Vamos ajustar algo? 5) Conte conosco. Taxa resposta 40%+.",
  ...
  alternates: { canonical: '/blog/o-que-falar-com-aluno-que-sumiu-scripts-que-funcionam' },
  openGraph: {
    title: "O Que Falar com Aluno que Sumiu: Scripts que Funcionam",
    description: "5 scripts testados e aprovados para aluno sumido: 1) Sentimos falta 2) Tudo bem? 3) Como podemos ajudar 4) Vamos ajustar algo? 5) Conte conosco. Taxa resposta 40%+.",
    url: 'https://neofitflow.com.br/blog/o-que-falar-com-aluno-que-sumiu-scripts-que-funcionam',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "O Que Falar com Aluno que Sumiu: Scripts que Funcionam", item: "https://neofitflow.com.br/blog/o-que-falar-com-aluno-que-sumiu-scripts-que-funcionam" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-27">26 de janeiro de 2025</time>
                <span>•</span>
...
<h1>O Que Falar com Aluno que Sumiu: Scripts que Funcionam</h1>
