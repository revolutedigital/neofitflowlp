...
export const metadata: Metadata = {
  ...
  description: "Aluno sem meta clara tem 2x mais evasão. Desafios 30 dias, metas trimestrais, acompanhamento semanal. Como estruturar sistema de objetivos que engaja.",
  ...
  alternates: { canonical: '/blog/desafios-e-metas-como-manter-frequencia-alta-com-objetivos' },
  openGraph: {
    title: "Desafios e Metas: Como Manter Frequência Alta com Objetivos",
    description: "Aluno sem meta clara tem 2x mais evasão. Desafios 30 dias, metas trimestrais, acompanhamento semanal. Como estruturar sistema de objetivos que engaja.",
    url: 'https://neofitflow.com.br/blog/desafios-e-metas-como-manter-frequencia-alta-com-objetivos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Desafios e Metas: Como Manter Frequência Alta com Objetivos", item: "https://neofitflow.com.br/blog/desafios-e-metas-como-manter-frequencia-alta-com-objetivos" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Desafios e Metas: Como Manter Frequência Alta com Objetivos
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-19">18 de março de 2025</time>
                <span>•</span>
...
<h1>Desafios e Metas: Como Manter Frequência Alta com Objetivos</h1>
