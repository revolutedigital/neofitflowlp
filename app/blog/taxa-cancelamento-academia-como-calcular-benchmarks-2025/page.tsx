...
export const metadata: Metadata = {
  title: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025 | NeoFitFlow",
  description: "Aprenda a fórmula correta para calcular taxa de cancelamento e compare com médias por tipo e tamanho de academia no Brasil.",
  keywords: "calcular cancelamento, taxa churn, fórmula correta, benchmarks brasil",
  alternates: {
    canonical: '/blog/taxa-cancelamento-academia-como-calcular-benchmarks-2025',
  },
  openGraph: {
    title: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025",
    description: "Aprenda a fórmula correta para calcular taxa de cancelamento e compare com médias por tipo e tamanho de academia no Brasil.",
    url: 'https://neofitflow.com.br/blog/taxa-cancelamento-academia-como-calcular-benchmarks-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025",
                item: "https://neofitflow.com.br/blog/taxa-cancelamento-academia-como-calcular-benchmarks-2025",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025",
            description: "Aprenda a fórmula correta para calcular taxa de cancelamento e compare com médias por tipo e tamanho de academia no Brasil.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar taxa de cancelamento em academia: como calcular e benchmarks 2025, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Taxa de Cancelamento em Academia: Como Calcular e Benchmarks 2025 não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
