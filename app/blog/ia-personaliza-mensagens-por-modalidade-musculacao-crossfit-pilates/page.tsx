...
export const metadata: Metadata = {
  title: "IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates | NeoFitFlow",
  description: "Mensagens genéricas não funcionam. Veja como IA personaliza abordagem para musculação, crossfit, dança, pilates, MMA - aumentando taxa de resposta em 3x.",
  ...
  alternates: { canonical: '/blog/ia-personaliza-mensagens-por-modalidade-musculacao-crossfit-pilates' },
  openGraph: {
    title: "IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates",
    description: "Mensagens genéricas não funcionam. Veja como IA personaliza abordagem para musculação, crossfit, dança, pilates, MMA - aumentando taxa de resposta em 3x.",
    url: 'https://neofitflow.com.br/blog/ia-personaliza-mensagens-por-modalidade-musculacao-crossfit-pilates',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates", item: "https://neofitflow.com.br/blog/ia-personaliza-mensagens-por-modalidade-musculacao-crossfit-pilates" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates",
          description: "Mensagens genéricas não funcionam. Veja como IA personaliza abordagem para musculação, crossfit, dança, pilates, MMA - aumentando taxa de resposta em 3x.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-28">27 de janeiro de 2025</time>
                <span>•</span>
...
<h1>IA Personaliza Mensagens por Modalidade: Musculação, CrossFit, Pilates</h1>
