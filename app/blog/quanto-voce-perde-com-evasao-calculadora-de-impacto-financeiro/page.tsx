...
export const metadata: Metadata = {
  ...
  description: "Calculadora interativa: insira alunos, mensalidade, evasão atual. Descubra perda anual, CAC desperdiçado, MRR evaporado. Prepare-se para se assustar.",
  ...
  alternates: { canonical: '/blog/quanto-voce-perde-com-evasao-calculadora-de-impacto-financeiro' },
  openGraph: {
    title: "Quanto Você Perde com Evasão: Calculadora de Impacto Financeiro",
    description: "Calculadora interativa: insira alunos, mensalidade, evasão atual. Descubra perda anual, CAC desperdiçado, MRR evaporado. Prepare-se para se assustar.",
    url: 'https://neofitflow.com.br/blog/quanto-voce-perde-com-evasao-calculadora-de-impacto-financeiro',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Quanto Você Perde com Evasão: Calculadora de Impacto Financeiro", item: "https://neofitflow.com.br/blog/quanto-voce-perde-com-evasao-calculadora-de-impacto-financeiro" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Quanto Você Perde com Evasão: Calculadora de Impacto Financeiro
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-22">21 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Quanto Você Perde com Evasão: Calculadora de Impacto Financeiro</h1>
