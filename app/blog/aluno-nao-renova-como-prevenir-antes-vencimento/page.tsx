...
export const metadata: Metadata = {
  title: "Aluno Que Não Renova: Como Prevenir Antes do Vencimento | NeoFitFlow",
  description: "Estratégias para detectar intenção de não renovação 45-60 dias antes do vencimento e ações preventivas eficazes.",
  keywords: "não renovação, vencimento contrato, prevenir não renova, ação antecipada",
  alternates: {
    canonical: '/blog/aluno-nao-renova-como-prevenir-antes-vencimento',
  },
  openGraph: {
    title: "Aluno Que Não Renova: Como Prevenir Antes do Vencimento",
    description: "Estratégias para detectar intenção de não renovação 45-60 dias antes do vencimento e ações preventivas eficazes.",
    url: 'https://neofitflow.com.br/blog/aluno-nao-renova-como-prevenir-antes-vencimento',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Aluno Que Não Renova: Como Prevenir Antes do Vencimento",
                item: "https://neofitflow.com.br/blog/aluno-nao-renova-como-prevenir-antes-vencimento",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Aluno Que Não Renova: Como Prevenir Antes do Vencimento",
            description: "Estratégias para detectar intenção de não renovação 45-60 dias antes do vencimento e ações preventivas eficazes.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Aluno Que Não Renova: Como Prevenir Antes do Vencimento</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar aluno que não renova: como prevenir antes do vencimento, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Aluno Que Não Renova: Como Prevenir Antes do Vencimento não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
