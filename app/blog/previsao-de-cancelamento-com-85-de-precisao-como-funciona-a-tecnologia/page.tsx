...
export const metadata: Metadata = {
  ...
  description: "Entenda a ciência por trás da previsão de cancelamentos: como IA alcança 85% de precisão analisando comportamento, frequência e padrões de alunos em risco.",
  ...
  alternates: { canonical: '/blog/previsao-de-cancelamento-com-85-de-precisao-como-funciona-a-tecnologia' },
  openGraph: {
    title: "Previsão de Cancelamento com 85% de Precisão: Como Funciona a Tecnologia",
    description: "Entenda a ciência por trás da previsão de cancelamentos: como IA alcança 85% de precisão analisando comportamento, frequência e padrões de alunos em risco.",
    url: 'https://neofitflow.com.br/blog/previsao-de-cancelamento-com-85-de-precisao-como-funciona-a-tecnologia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Previsão de Cancelamento com 85% de Precisão: Como Funciona a Tecnologia", item: "https://neofitflow.com.br/blog/previsao-de-cancelamento-com-85-de-precisao-como-funciona-a-tecnologia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Previsão de Cancelamento com 85% de Precisão: Como Funciona a Tecnologia
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-28">27 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Previsão de Cancelamento com 85% de Precisão: Como Funciona a Tecnologia</h1>
