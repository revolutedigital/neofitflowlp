...
export const metadata: Metadata = {
  title: "Qualificação de Leads no WhatsApp: Perguntas e Fluxos Inteligentes | NeoFitFlow",
  description: "Guia completo sobre qualificação de leads no whatsapp: perguntas e fluxos inteligentes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "qualificacao leads whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/qualificacao-leads-whatsapp',
  },
  openGraph: {
    title: "Qualificação de Leads no WhatsApp: Perguntas e Fluxos Inteligentes",
    description: "Guia completo sobre qualificação de leads no whatsapp: perguntas e fluxos inteligentes",
    url: 'https://neofitflow.com.br/blog/qualificacao-leads-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Qualificação de Leads Pelo WhatsApp",
    description: "Guia completo sobre qualificação de leads no whatsapp: perguntas e fluxos inteligentes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Qualificação de Leads Pelo WhatsApp",
                item: "https://neofitflow.com.br/blog/qualificacao-leads-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Qualificação de Leads no WhatsApp: Perguntas e Fluxos Inteligentes",
            description: "Guia completo sobre qualificação de leads no whatsapp: perguntas e fluxos inteligentes",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Qualificação de Leads no WhatsApp: Perguntas e Fluxos Inteligentes</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-09">09/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como qualificação de leads no whatsapp: perguntas e fluxos inteligentes, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Qualificação de Leads no WhatsApp: Perguntas e Fluxos Inteligentes não é apenas uma tendência - é uma necessidade para academias que querem
