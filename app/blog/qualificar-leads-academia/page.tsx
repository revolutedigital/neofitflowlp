...
export const metadata: Metadata = {
  title: "Como Qualificar Leads de Academia: Perguntas e Critérios | NeoFitFlow",
  description: "Guia completo sobre como qualificar leads de academia: perguntas e critérios. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "qualificar leads academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/qualificar-leads-academia',
  },
  openGraph: {
    title: "Como Qualificar Leads de Academia: Perguntas e Critérios",
    description: "Guia completo sobre como qualificar leads de academia: perguntas e critérios",
    url: 'https://neofitflow.com.br/blog/qualificar-leads-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Como Qualificar Leads de Academia",
    description: "Guia completo sobre como qualificar leads de academia: perguntas e critérios. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Qualificar Leads de Academia",
                item: "https://neofitflow.com.br/blog/qualificar-leads-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Qualificar Leads de Academia: Perguntas e Critérios",
            description: "Guia completo sobre como qualificar leads de academia: perguntas e critérios",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Qualificar Leads de Academia: Perguntas e Critérios</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-29">29/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como qualificar leads de academia: perguntas e critérios, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Qualificar Leads de Academia: Perguntas e Critérios não é apenas uma tendência - é uma necessidade para academias que querem
