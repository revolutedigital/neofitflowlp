...
export const metadata: Metadata = {
  ...
  description: "Horários vazios = oportunidade perdida. Alunos em horário cheio têm experiência ruim = risco evasão. Como rebalancear e melhorar retenção via otimização.",
  ...
  alternates: { canonical: '/blog/horarios-vazios-na-academia-oportunidade-perdida-de-retencao' },
  openGraph: {
    title: "Horários Vazios na Academia: Oportunidade Perdida de Retenção",
    description: "Horários vazios = oportunidade perdida. Alunos em horário cheio têm experiência ruim = risco evasão. Como rebalancear e melhorar retenção via otimização.",
    url: 'https://neofitflow.com.br/blog/horarios-vazios-na-academia-oportunidade-perdida-de-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Horários Vazios na Academia: Oportunidade Perdida de Retenção", item: "https://neofitflow.com.br/blog/horarios-vazios-na-academia-oportunidade-perdida-de-retencao" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Horários Vazios na Academia: Oportunidade Perdida de Retenção
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-14">13 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Horários Vazios na Academia: Oportunidade Perdida de Retenção</h1>
