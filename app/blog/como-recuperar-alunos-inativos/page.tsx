...
export const metadata: Metadata = {
  title: "Como Recuperar Alunos Inativos: Guia Completo de Reativação | NeoFitFlow",
  description: "Guia completo sobre como recuperar alunos inativos: guia completo de reativação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "como recuperar alunos inativos, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/como-recuperar-alunos-inativos',
  },
  openGraph: {
    title: "Como Recuperar Alunos Inativos: Guia Completo de Reativação",
    description: "Guia completo sobre como recuperar alunos inativos: guia completo de reativação",
    url: 'https://neofitflow.com.br/blog/como-recuperar-alunos-inativos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Como Recuperar Alunos Inativos Automaticamente",
    description: "Guia completo sobre como recuperar alunos inativos: guia completo de reativação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Recuperar Alunos Inativos Automaticamente",
                item: "https://neofitflow.com.br/blog/como-recuperar-alunos-inativos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Recuperar Alunos Inativos: Guia Completo de Reativação",
            description: "Guia completo sobre como recuperar alunos inativos: guia completo de reativação",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Recuperar Alunos Inativos: Guia Completo de Reativação</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-11">11/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como recuperar alunos inativos: guia completo de reativação, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Recuperar Alunos Inativos: Guia Completo de Reativação não é apenas uma tendência - é uma necessidade para academias que querem
