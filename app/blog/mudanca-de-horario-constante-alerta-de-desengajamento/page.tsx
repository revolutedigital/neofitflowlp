...
export const metadata: Metadata = {
  ...
  description: "Aluno que troca horário 3-4x no mês = sinal amarelo. Rotina instável precede cancelamento. Entenda por que e como oferecer ajuste antes de perder.",
  ...
  alternates: { canonical: '/blog/mudanca-de-horario-constante-alerta-de-desengajamento' },
  openGraph: {
    title: "Mudança de Horário Constante: Alerta de Desengajamento",
    description: "Aluno que troca horário 3-4x no mês = sinal amarelo. Rotina instável precede cancelamento. Entenda por que e como oferecer ajuste antes de perder.",
    url: 'https://neofitflow.com.br/blog/mudanca-de-horario-constante-alerta-de-desengajamento',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Mudança de Horário Constante: Alerta de Desengajamento", item: "https://neofitflow.com.br/blog/mudanca-de-horario-constante-alerta-de-desengajamento" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Mudança de Horário Constante: Alerta de Desengajamento
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-10">9 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Mudança de Horário Constante: Alerta de Desengajamento</h1>
