...
export const metadata: Metadata = {
  ...
  description: "Zumba: diversão = frequência natural. Mas vida acontece e aluno suma. IA lembra da alegria, convida para música nova, resgata pela emoção positiva.",
  keywords: "retenção zumba ia, frequência zumba alta, ia zumba específica, resgate emocional zumba, manter diversão zumba",
  alternates: { canonical: '/blog/zumba-frequencia-alta-atraves-de-diversao-ia-potencializa' },
  openGraph: {
    title: "Zumba: Frequência Alta através de Diversão - IA Potencializa",
    description: "Zumba: diversão = frequência natural. Mas vida acontece e aluno suma. IA lembra da alegria, convida para música nova, resgata pela emoção positiva.",
    url: 'https://neofitflow.com.br/blog/zumba-frequencia-alta-atraves-de-diversao-ia-potencializa',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Zumba: Frequência Alta através de Diversão - IA Potencializa", item: "https://neofitflow.com.br/blog/zumba-frequencia-alta-atraves-de-diversao-ia-potencializa" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Zumba: Frequência Alta através de Diversão - IA Potencializa
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-25">24 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Zumba: Frequência Alta através de Diversão - IA Potencializa</h1>
