...
export const metadata: Metadata = {
  ...
  description: "Dezembro/janeiro: férias, viagens, festas = frequência cai 40%. Como manter aluno conectado mesmo longe, prevenir 'eu volto ano que vem' virar nunca mais.",
  ...
  alternates: { canonical: '/blog/verao-e-queda-de-frequencia-ferias-viagens-e-retencao' },
  openGraph: {
    title: "Verão e Queda de Frequência: Férias, Viagens e Retenção",
    description: "Dezembro/janeiro: férias, viagens, festas = frequência cai 40%. Como manter aluno conectado mesmo longe, prevenir 'eu volto ano que vem' virar nunca mais.",
    url: 'https://neofitflow.com.br/blog/verao-e-queda-de-frequencia-ferias-viagens-e-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Verão e Queda de Frequência: Férias, Viagens e Retenção", item: "https://neofitflow.com.br/blog/verao-e-queda-de-frequencia-ferias-viagens-e-retencao" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Verão e Queda de Frequência: Férias, Viagens e Retenção
              </h1>
...
<h1>Verão e Queda de Frequência: Férias, Viagens e Retenção</h1>
