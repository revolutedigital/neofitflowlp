...
export const metadata: Metadata = {
  title: "Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez | NeoFitFlow",
  description: "Protocolo de acompanhamento após trazer aluno de volta - como consolidar retorno e evitar segunda evasão.",
  keywords: "pós-retorno, consolidar volta, acompanhamento ativo, evitar recaída",
  alternates: {
    canonical: '/blog/acompanhamento-pos-retorno-aluno-garantir-fica-dessa-vez',
  },
  openGraph: {
    title: "Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez",
    description: "Protocolo de acompanhamento após trazer aluno de volta - como consolidar retorno e evitar segunda evasão.",
    url: 'https://neofitflow.com.br/blog/acompanhamento-pos-retorno-aluno-garantir-fica-dessa-vez',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez",
                item: "https://neofitflow.com.br/blog/acompanhamento-pos-retorno-aluno-garantir-fica-dessa-vez",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez",
            description: "Protocolo de acompanhamento após trazer aluno de volta - como consolidar retorno e evitar segunda evasão.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar acompanhamento pós-retorno do aluno: garantir que fique dessa vez, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Acompanhamento Pós-Retorno do Aluno: Garantir Que Fique Dessa Vez não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
