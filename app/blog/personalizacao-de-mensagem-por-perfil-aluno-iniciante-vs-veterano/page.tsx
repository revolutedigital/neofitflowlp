...
export const metadata: Metadata = {
  ...
  description: "Iniciante precisa apoio técnico. Veterano precisa renovação de objetivos. Mãe precisa flexibilidade. Competidor precisa desafios. Como IA personaliza por perfil.",
  ...
  alternates: { canonical: '/blog/personalizacao-de-mensagem-por-perfil-aluno-iniciante-vs-veterano' },
  openGraph: {
    title: "Personalização de Mensagem por Perfil: Aluno Iniciante vs Veterano",
    description: "Iniciante precisa apoio técnico. Veterano precisa renovação de objetivos. Mãe precisa flexibilidade. Competidor precisa desafios. Como IA personaliza por perfil.",
    url: 'https://neofitflow.com.br/blog/personalizacao-de-mensagem-por-perfil-aluno-iniciante-vs-veterano',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Personalização de Mensagem por Perfil: Aluno Iniciante vs Veterano", item: "https://neofitflow.com.br/blog/personalizacao-de-mensagem-por-perfil-aluno-iniciante-vs-veterano" }
          ]
        })
      }} />
        ...
        <article className="pt-32 pb-20">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="text-sm text-gray-600 mb-8">
              ...
              <span className="mx-2">/</span>
              <span className="text-purple-400">Ação Preventiva</span>
            </div>
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Personalização de Mensagem por Perfil: Aluno Iniciante vs Veterano
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-06">5 de março de 2025</time>
                <span>•</span>
...
<h1>Personalização de Mensagem por Perfil: Aluno Iniciante vs Veterano</h1>
