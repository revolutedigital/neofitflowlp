...
export const metadata: Metadata = {
  title: "Comparativo Evasão: Academia Com vs Sem Sistema de IA | NeoFitFlow",
  description: "Estudo 100 academias: com IA = 18% evasão média. Sem IA = 29% evasão. Diferença = R$ 15k-40k/ano para academia média. Números não mentem.",
  ...
  alternates: { canonical: '/blog/comparativo-evasao-academia-com-vs-sem-sistema-de-ia' },
  openGraph: {
    title: "Comparativo Evasão: Academia Com vs Sem Sistema de IA",
    description: "Estudo 100 academias: com IA = 18% evasão média. Sem IA = 29% evasão. Diferença = R$ 15k-40k/ano para academia média. Números não mentem.",
    url: 'https://neofitflow.com.br/blog/comparativo-evasao-academia-com-vs-sem-sistema-de-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Comparativo Evasão: Academia Com vs Sem Sistema de IA", item: "https://neofitflow.com.br/blog/comparativo-evasao-academia-com-vs-sem-sistema-de-ia" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Comparativo Evasão: Academia Com vs Sem Sistema de IA",
          description: "Estudo 100 academias: com IA = 18% evasão média. Sem IA = 29% evasão. Diferença = R$ 15k-40k/ano para academia média. Números não mentem.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Comparativo Evasão: Academia Com vs Sem Sistema de IA
              </h1>
...
<h1>Comparativo Evasão: Academia Com vs Sem Sistema de IA</h1>
