...
export const metadata: Metadata = {
  title: "Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão | NeoFitFlow",
  description: "Por que alunos que treinam apenas sábado/domingo têm maior taxa de cancelamento e como aumentar frequência.",
  keywords: "treino fim semana, baixa frequência, risco oculto, aluno casual",
  alternates: {
    canonical: '/blog/aluno-treina-so-fim-semana-risco-oculto-evasao',
  },
  openGraph: {
    title: "Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão",
    description: "Por que alunos que treinam apenas sábado/domingo têm maior taxa de cancelamento e como aumentar frequência.",
    url: 'https://neofitflow.com.br/blog/aluno-treina-so-fim-semana-risco-oculto-evasao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão",
                item: "https://neofitflow.com.br/blog/aluno-treina-so-fim-semana-risco-oculto-evasao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão",
            description: "Por que alunos que treinam apenas sábado/domingo têm maior taxa de cancelamento e como aumentar frequência.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar aluno que treina só no fim de semana: risco oculto de evasão, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Aluno Que Treina Só no Fim de Semana: Risco Oculto de Evasão não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
