...
export const metadata: Metadata = {
  title: "Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade | NeoFitFlow",
  description: "Bootcamp: intensidade extrema 30-60 dias. Pós-bootcamp, 50% evadem. Como IA cria continuidade, sugere próximo desafio, mantém aluno no ciclo.",
  ...
  alternates: { canonical: '/blog/bootcamp-e-engajamento-continuo-como-ia-mantem-intensidade' },
  openGraph: {
    title: "Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade",
    description: "Bootcamp: intensidade extrema 30-60 dias. Pós-bootcamp, 50% evadem. Como IA cria continuidade, sugere próximo desafio, mantém aluno no ciclo.",
    url: 'https://neofitflow.com.br/blog/bootcamp-e-engajamento-continuo-como-ia-mantem-intensidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade", item: "https://neofitflow.com.br/blog/bootcamp-e-engajamento-continuo-como-ia-mantem-intensidade" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade",
          description: "Bootcamp: intensidade extrema 30-60 dias. Pós-bootcamp, 50% evadem. Como IA cria continuidade, sugere próximo desafio, mantém aluno no ciclo.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-24">23 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Bootcamp e Engajamento Contínuo: Como IA Mantém Intensidade</h1>
