...
export const metadata: Metadata = {
  ...
  description: "Janeiro: 40% mais matrículas, mas 50% cancelam em 60 dias. Promessa de ano novo vira frustração. Estratégia para converter promessa em hábito real.",
  ...
  alternates: { canonical: '/blog/janeiro-e-evasao-em-academia-como-prevenir-abandono-pos-promessa' },
  openGraph: {
    title: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa",
    description: "Janeiro: 40% mais matrículas, mas 50% cancelam em 60 dias. Promessa de ano novo vira frustração. Estratégia para converter promessa em hábito real.",
    url: 'https://neofitflow.com.br/blog/janeiro-e-evasao-em-academia-como-prevenir-abandono-pos-promessa',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa", item: "https://neofitflow.com.br/blog/janeiro-e-evasao-em-academia-como-prevenir-abandono-pos-promessa" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-21">20 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa</h1>
