...
export const metadata: Metadata = {
  title: "Box de Muay Thai e Jiu-Jitsu: Gestão e Retenção de Alunos | NeoFitFlow",
  description: "Guia completo sobre box de muay thai e jiu-jitsu: gestão e retenção de alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "box muay thai jiu jitsu gestao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/box-muay-thai-jiu-jitsu-gestao',
  },
  openGraph: {
    title: "Box de Muay Thai e Jiu-Jitsu: Gestão e Retenção de Alunos",
    description: "Guia completo sobre box de muay thai e jiu-jitsu: gestão e retenção de alunos",
    url: 'https://neofitflow.com.br/blog/box-muay-thai-jiu-jitsu-gestao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Box Muay Thai e Jiu-Jitsu: Gestão",
    description: "Guia completo sobre box de muay thai e jiu-jitsu: gestão e retenção de alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Box Muay Thai e Jiu-Jitsu: Gestão",
                item: "https://neofitflow.com.br/blog/box-muay-thai-jiu-jitsu-gestao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Box de Muay Thai e Jiu-Jitsu: Gestão e Retenção de Alunos",
            description: "Guia completo sobre box de muay thai e jiu-jitsu: gestão e retenção de alunos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Box de Muay Thai e Jiu-Jitsu: Gestão e Retenção de Alunos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-14">14/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como box de muay thai e jiu-jitsu: gestão e retenção de alunos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Box de Muay Thai e Jiu-Jitsu: Gestão e Retenção de Alunos não é apenas uma tendência - é uma necessidade para academias que querem
