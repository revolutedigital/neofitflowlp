...
export const metadata: Metadata = {
  title: "Pesquisa NPS Automática no WhatsApp: Como Coletar Feedback | NeoFitFlow",
  description: "Guia completo sobre pesquisa nps automática no whatsapp: como coletar feedback. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "pesquisa nps automatica whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/pesquisa-nps-automatica-whatsapp',
  },
  openGraph: {
    title: "Pesquisa NPS Automática no WhatsApp: Como Coletar Feedback",
    description: "Guia completo sobre pesquisa nps automática no whatsapp: como coletar feedback",
    url: 'https://neofitflow.com.br/blog/pesquisa-nps-automatica-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Pesquisa NPS Automática no WhatsApp",
    description: "Guia completo sobre pesquisa nps automática no whatsapp: como coletar feedback. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Pesquisa NPS Automática no WhatsApp",
                item: "https://neofitflow.com.br/blog/pesquisa-nps-automatica-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Pesquisa NPS Automática no WhatsApp: Como Coletar Feedback",
            description: "Guia completo sobre pesquisa nps automática no whatsapp: como coletar feedback",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Pesquisa NPS Automática no WhatsApp: Como Coletar Feedback</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-07">07/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como pesquisa nps automática no whatsapp: como coletar feedback, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Pesquisa NPS Automática no WhatsApp: Como Coletar Feedback não é apenas uma tendência - é uma necessidade para academias que querem
