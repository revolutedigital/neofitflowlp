...
export const metadata: Metadata = {
  title: "Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico | NeoFitFlow",
  description: "Guia técnico: aprenda exatamente como IA monitora check-ins, detecta faltas consecutivas, analisa mudanças de padrão e calcula score de risco de 0-100.",
  ...
  alternates: { canonical: '/blog/como-ia-identifica-aluno-em-risco-de-cancelamento-guia-tecnico' },
  openGraph: {
    title: "Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico",
    description: "Guia técnico: aprenda exatamente como IA monitora check-ins, detecta faltas consecutivas, analisa mudanças de padrão e calcula score de risco de 0-100.",
    url: 'https://neofitflow.com.br/blog/como-ia-identifica-aluno-em-risco-de-cancelamento-guia-tecnico',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico", item: "https://neofitflow.com.br/blog/como-ia-identifica-aluno-em-risco-de-cancelamento-guia-tecnico" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico",
          description: "Guia técnico: aprenda exatamente como IA monitora check-ins, detecta faltas consecutivas, analisa mudanças de padrão e calcula score de risco de 0-100.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico
              </h1>
...
<h1>Como IA Identifica Aluno em Risco de Cancelamento: Guia Técnico</h1>
