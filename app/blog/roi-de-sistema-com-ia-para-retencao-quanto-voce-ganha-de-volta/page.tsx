...
export const metadata: Metadata = {
  ...
  description: "Investimento em IA se paga em 2-3 meses: salve 20 alunos/mês (R$ 3k MRR), economize 20h de trabalho (R$ 1.5k), aumente LTV 30%. Calcule seu ROI.",
  ...
  alternates: { canonical: '/blog/roi-de-sistema-com-ia-para-retencao-quanto-voce-ganha-de-volta' },
  openGraph: {
    title: "ROI de Sistema com IA para Retenção: Quanto Você Ganha de Volta",
    description: "Investimento em IA se paga em 2-3 meses: salve 20 alunos/mês (R$ 3k MRR), economize 20h de trabalho (R$ 1.5k), aumente LTV 30%. Calcule seu ROI.",
    url: 'https://neofitflow.com.br/blog/roi-de-sistema-com-ia-para-retencao-quanto-voce-ganha-de-volta',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "ROI de Sistema com IA para Retenção: Quanto Você Ganha de Volta", item: "https://neofitflow.com.br/blog/roi-de-sistema-com-ia-para-retencao-quanto-voce-ganha-de-volta" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                ROI de Sistema com IA para Retenção: Quanto Você Ganha de Volta
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-19">18 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>ROI de Sistema com IA para Retenção: Quanto Você Ganha de Volta</h1>
