...
export const metadata: Metadata = {
  ...
  description: "O que motiva retorno: progresso visível (35%), senso comunidade (28%), meta renovada (22%), plano ajustado (15%). Como usar cada gatilho na mensagem.",
  ...
  alternates: { canonical: '/blog/motivacao-que-traz-aluno-de-volta-psicologia-da-reativacao' },
  openGraph: {
    title: "Motivação que Traz Aluno de Volta: Psicologia da Reativação",
    description: "O que motiva retorno: progresso visível (35%), senso comunidade (28%), meta renovada (22%), plano ajustado (15%). Como usar cada gatilho na mensagem.",
    url: 'https://neofitflow.com.br/blog/motivacao-que-traz-aluno-de-volta-psicologia-da-reativacao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Motivação que Traz Aluno de Volta: Psicologia da Reativação", item: "https://neofitflow.com.br/blog/motivacao-que-traz-aluno-de-volta-psicologia-da-reativacao" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Motivação que Traz Aluno de Volta: Psicologia da Reativação
              </h1>
...
<h1>Motivação que Traz Aluno de Volta: Psicologia da Reativação</h1>
