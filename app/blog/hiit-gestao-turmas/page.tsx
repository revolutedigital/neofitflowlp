...
export const metadata: Metadata = {
  title: "HIIT: Como Gerenciar Turmas de Alta Intensidade | NeoFitFlow",
  description: "Guia completo sobre hiit: como gerenciar turmas de alta intensidade. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "hiit gestao turmas, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/hiit-gestao-turmas',
  },
  openGraph: {
    title: "HIIT: Como Gerenciar Turmas de Alta Intensidade",
    description: "Guia completo sobre hiit: como gerenciar turmas de alta intensidade",
    url: 'https://neofitflow.com.br/blog/hiit-gestao-turmas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "HIIT: Gestão de Turmas",
    description: "Guia completo sobre hiit: como gerenciar turmas de alta intensidade. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "HIIT: Gestão de Turmas",
                item: "https://neofitflow.com.br/blog/hiit-gestao-turmas",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "HIIT: Como Gerenciar Turmas de Alta Intensidade",
            description: "Guia completo sobre hiit: como gerenciar turmas de alta intensidade",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">HIIT: Como Gerenciar Turmas de Alta Intensidade</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-07">07/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como hiit: como gerenciar turmas de alta intensidade, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                HIIT: Como Gerenciar Turmas de Alta Intensidade não é apenas uma tendência - é uma necessidade para academias que querem
