...
export const metadata: Metadata = {
  ...
  description: "CrossFit tem evasão 30% menor que musculação pela comunidade. Mas quando aluno se distancia, perda é rápida. Como IA detecta sinais únicos de crossfitter em risco.",
  ...
  alternates: { canonical: '/blog/prevenir-evasao-em-box-de-crossfit-comunidade-forte-com-ia' },
  openGraph: {
    title: "Prevenir Evasão em Box de CrossFit: Comunidade Forte com IA",
    description: "CrossFit tem evasão 30% menor que musculação pela comunidade. Mas quando aluno se distancia, perda é rápida. Como IA detecta sinais únicos de crossfitter em risco.",
    url: 'https://neofitflow.com.br/blog/prevenir-evasao-em-box-de-crossfit-comunidade-forte-com-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Prevenir Evasão em Box de CrossFit: Comunidade Forte com IA", item: "https://neofitflow.com.br/blog/prevenir-evasao-em-box-de-crossfit-comunidade-forte-com-ia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Prevenir Evasão em Box de CrossFit: Comunidade Forte com IA
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-23">22 de março de 2025</time>
                <span>•</span>
...
<h1>Prevenir Evasão em Box de CrossFit: Comunidade Forte com IA</h1>
