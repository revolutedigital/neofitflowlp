...
export const metadata: Metadata = {
  title: "Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão | NeoFitFlow",
  description: "Treina só sábado/domingo? Risco 2x maior de cancelar vs aluno de dias úteis. Baixo engajamento + resultados lentos = frustração. Como converter para semana.",
  ...
  alternates: { canonical: '/blog/aluno-que-treina-so-fim-de-semana-risco-oculto-de-evasao' },
  openGraph: {
    title: "Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão",
    description: "Treina só sábado/domingo? Risco 2x maior de cancelar vs aluno de dias úteis. Baixo engajamento + resultados lentos = frustração. Como converter para semana.",
    url: 'https://neofitflow.com.br/blog/aluno-que-treina-so-fim-de-semana-risco-oculto-de-evasao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão", item: "https://neofitflow.com.br/blog/aluno-que-treina-so-fim-de-semana-risco-oculto-de-evasao" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão",
          description: "Treina só sábado/domingo? Risco 2x maior de cancelar vs aluno de dias úteis. Baixo engajamento + resultados lentos = frustração. Como converter para semana.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão
              </h1>
...
<h1>Aluno que Treina Só Fim de Semana: Risco Oculto de Evasão</h1>
