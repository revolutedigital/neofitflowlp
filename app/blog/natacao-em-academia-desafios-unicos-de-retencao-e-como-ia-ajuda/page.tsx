...
export const metadata: Metadata = {
  ...
  description: "Natação: requer mais disciplina (trocar roupa, molhar cabelo), evasão 35% maior. IA identifica alunos que começam a 'adiar' e age antes de virar desistência.",
  ...
  alternates: { canonical: '/blog/natacao-em-academia-desafios-unicos-de-retencao-e-como-ia-ajuda' },
  openGraph: {
    title: "Natação em Academia: Desafios Únicos de Retenção e Como IA Ajuda",
    description: "Natação: requer mais disciplina (trocar roupa, molhar cabelo), evasão 35% maior. IA identifica alunos que começam a 'adiar' e age antes de virar desistência.",
    url: 'https://neofitflow.com.br/blog/natacao-em-academia-desafios-unicos-de-retencao-e-como-ia-ajuda',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Natação em Academia: Desafios Únicos de Retenção e Como IA Ajuda", item: "https://neofitflow.com.br/blog/natacao-em-academia-desafios-unicos-de-retencao-e-como-ia-ajuda" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Natação em Academia: Desafios Únicos de Retenção e Como IA Ajuda
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-21">20 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Natação em Academia: Desafios Únicos de Retenção e Como IA Ajuda</h1>
