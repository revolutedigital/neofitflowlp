...
export const metadata: Metadata = {
  title: "Cross Training: Como Gerenciar Treinos e Engajar Alunos | NeoFitFlow",
  description: "Guia completo sobre cross training: como gerenciar treinos e engajar alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "cross training gestao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/cross-training-gestao',
  },
  openGraph: {
    title: "Cross Training: Como Gerenciar Treinos e Engajar Alunos",
    description: "Guia completo sobre cross training: como gerenciar treinos e engajar alunos",
    url: 'https://neofitflow.com.br/blog/cross-training-gestao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Cross Training: Gestão",
    description: "Guia completo sobre cross training: como gerenciar treinos e engajar alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Cross Training: Gestão",
                item: "https://neofitflow.com.br/blog/cross-training-gestao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Cross Training: Como Gerenciar Treinos e Engajar Alunos",
            description: "Guia completo sobre cross training: como gerenciar treinos e engajar alunos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Cross Training: Como Gerenciar Treinos e Engajar Alunos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-09">09/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como cross training: como gerenciar treinos e engajar alunos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Cross Training: Como Gerenciar Treinos e Engajar Alunos não é apenas uma tendência - é uma necessidade para academias que querem
