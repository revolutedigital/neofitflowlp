...
export const metadata: Metadata = {
  ...
  description: "Spinning: evasão 25% menor que musculação (grupo + música). Mas quando aluno perde horário favorito, risco dispara. IA gerencia preferências de turma.",
  keywords: "retenção spinning ia, evasão aula spinning, sistema spinning específico, preferência turma spinning, ia aulas grupo",
  alternates: { canonical: '/blog/spinning-e-evasao-como-aulas-em-grupo-retem-melhor-com-tecnologia' },
  openGraph: {
    title: "Spinning e Evasão: Como Aulas em Grupo Retêm Melhor com Tecnologia",
    description: "Spinning: evasão 25% menor que musculação (grupo + música). Mas quando aluno perde horário favorito, risco dispara. IA gerencia preferências de turma.",
    url: 'https://neofitflow.com.br/blog/spinning-e-evasao-como-aulas-em-grupo-retem-melhor-com-tecnologia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Spinning e Evasão: Como Aulas em Grupo Retêm Melhor com Tecnologia", item: "https://neofitflow.com.br/blog/spinning-e-evasao-como-aulas-em-grupo-retem-melhor-com-tecnologia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Spinning e Evasão: Como Aulas em Grupo Retêm Melhor com Tecnologia
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-02">1 de março de 2025</time>
                <span>•</span>
...
<h1>Spinning e Evasão: Como Aulas em Grupo Retêm Melhor com Tecnologia</h1>
