...
export const metadata: Metadata = {
  title: "Aluno Fantasma em Academia: Como Identificar e Resgatar | NeoFitFlow",
  description: "Estratégia específica para alunos que pagam mas nunca frequentam - como detectar, abordar e reativar.",
  keywords: "aluno fantasma, nunca frequenta, apenas paga, reativação inativa",
  alternates: {
    canonical: '/blog/aluno-fantasma-academia-como-identificar-resgatar',
  },
  openGraph: {
    title: "Aluno Fantasma em Academia: Como Identificar e Resgatar",
    description: "Estratégia específica para alunos que pagam mas nunca frequentam - como detectar, abordar e reativar.",
    url: 'https://neofitflow.com.br/blog/aluno-fantasma-academia-como-identificar-resgatar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Aluno Fantasma em Academia: Como Identificar e Resgatar",
                item: "https://neofitflow.com.br/blog/aluno-fantasma-academia-como-identificar-resgatar",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Aluno Fantasma em Academia: Como Identificar e Resgatar",
            description: "Estratégia específica para alunos que pagam mas nunca frequentam - como detectar, abordar e reativar.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Aluno Fantasma em Academia: Como Identificar e Resgatar</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar aluno fantasma em academia: como identificar e resgatar, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Aluno Fantasma em Academia: Como Identificar e Resgatar não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
