...
export const metadata: Metadata = {
  ...
  description: "3 faltas consecutivas = probabilidade 70% de cancelamento nos próximos 30 dias. Por que esse número é crítico e o que fazer quando aluno chega nele.",
  ...
  alternates: { canonical: '/blog/3-faltas-consecutivas-o-sinal-vermelho-que-voce-nao-pode-ignorar' },
  openGraph: {
    title: "3 Faltas Consecutivas: O Sinal Vermelho que Você Não Pode Ignorar",
    description: "3 faltas consecutivas = probabilidade 70% de cancelamento nos próximos 30 dias. Por que esse número é crítico e o que fazer quando aluno chega nele.",
    url: 'https://neofitflow.com.br/blog/3-faltas-consecutivas-o-sinal-vermelho-que-voce-nao-pode-ignorar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "3 Faltas Consecutivas: O Sinal Vermelho que Você Não Pode Ignorar", item: "https://neofitflow.com.br/blog/3-faltas-consecutivas-o-sinal-vermelho-que-voce-nao-pode-ignorar" }
          ]
        })
      }} />
        ...
        <article className="pt-32 pb-20">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="text-sm text-gray-600 mb-8">
              ...
              <span className="mx-2">/</span>
              <span className="text-purple-400">Comportamento e Sinais</span>
            </div>
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                3 Faltas Consecutivas: O Sinal Vermelho que Você Não Pode Ignorar
              </h1>
...
<h1>3 Faltas Consecutivas: O Sinal Vermelho que Você Não Pode Ignorar</h1>
