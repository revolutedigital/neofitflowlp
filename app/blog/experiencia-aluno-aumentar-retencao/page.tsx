...
export const metadata: Metadata = {
  title: "Experiência do Aluno: Como Melhorar e Aumentar Retenção | NeoFitFlow",
  description: "Guia completo sobre experiência do aluno: como melhorar e aumentar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "experiencia aluno aumentar retencao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/experiencia-aluno-aumentar-retencao',
  },
  openGraph: {
    title: "Experiência do Aluno: Como Melhorar e Aumentar Retenção",
    description: "Guia completo sobre experiência do aluno: como melhorar e aumentar retenção",
    url: 'https://neofitflow.com.br/blog/experiencia-aluno-aumentar-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Experiência do Aluno Para Aumentar Retenção",
    description: "Guia completo sobre experiência do aluno: como melhorar e aumentar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Experiência do Aluno Para Aumentar Retenção",
                item: "https://neofitflow.com.br/blog/experiencia-aluno-aumentar-retencao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Experiência do Aluno: Como Melhorar e Aumentar Retenção",
            description: "Guia completo sobre experiência do aluno: como melhorar e aumentar retenção",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Experiência do Aluno: Como Melhorar e Aumentar Retenção</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-31">31/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como experiência do aluno: como melhorar e aumentar retenção, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Experiência do Aluno: Como Melhorar e Aumentar Retenção não é apenas uma tendência - é uma necessidade para academias que querem
