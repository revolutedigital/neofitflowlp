...
export const metadata: Metadata = {
  title: "Custo Real da Evasão na Sua Academia: Calculadora Completa | NeoFitFlow",
  description: "Você sabe quanto perde com evasão? Use nossa calculadora: CAC + MRR perdido + custo reposição + LTV não realizado. Número real assusta.",
  ...
  alternates: { canonical: '/blog/custo-real-da-evasao-na-sua-academia-calculadora-completa' },
  openGraph: {
    title: "Custo Real da Evasão na Sua Academia: Calculadora Completa",
    description: "Você sabe quanto perde com evasão? Use nossa calculadora: CAC + MRR perdido + custo reposição + LTV não realizado. Número real assusta.",
    url: 'https://neofitflow.com.br/blog/custo-real-da-evasao-na-sua-academia-calculadora-completa',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Custo Real da Evasão na Sua Academia: Calculadora Completa", item: "https://neofitflow.com.br/blog/custo-real-da-evasao-na-sua-academia-calculadora-completa" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Custo Real da Evasão na Sua Academia: Calculadora Completa",
          description: "Você sabe quanto perde com evasão? Use nossa calculadora: CAC + MRR perdido + custo reposição + LTV não realizado. Número real assusta.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Custo Real da Evasão na Sua Academia: Calculadora Completa
              </h1>
...
<h1>Custo Real da Evasão na Sua Academia: Calculadora Completa</h1>
