...
export const metadata: Metadata = {
  title: "Pós-Carnaval e Retenção: O Período Crítico de Março a Abril | NeoFitFlow",
  description: "Como combater a queda de frequência típica do outono brasileiro quando alunos perdem motivação pós-verão.",
  keywords: "pós-carnaval, março abril, outono fitness, queda motivação",
  alternates: {
    canonical: '/blog/pos-carnaval-retencao-periodo-critico-marco-abril',
  },
  openGraph: {
    title: "Pós-Carnaval e Retenção: O Período Crítico de Março a Abril",
    description: "Como combater a queda de frequência típica do outono brasileiro quando alunos perdem motivação pós-verão.",
    url: 'https://neofitflow.com.br/blog/pos-carnaval-retencao-periodo-critico-marco-abril',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Pós-Carnaval e Retenção: O Período Crítico de Março a Abril",
                item: "https://neofitflow.com.br/blog/pos-carnaval-retencao-periodo-critico-marco-abril",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Pós-Carnaval e Retenção: O Período Crítico de Março a Abril",
            description: "Como combater a queda de frequência típica do outono brasileiro quando alunos perdem motivação pós-verão.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Pós-Carnaval e Retenção: O Período Crítico de Março a Abril</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar pós-carnaval e retenção: o período crítico de março a abril, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Pós-Carnaval e Retenção: O Período Crítico de Março a Abril não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
