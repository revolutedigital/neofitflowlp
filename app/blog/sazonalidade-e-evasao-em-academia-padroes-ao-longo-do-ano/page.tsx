...
export const metadata: Metadata = {
  ...
  description: "Janeiro: pico matrícula + risco evasão. Março: pós-carnaval queda. Junho/julho: frio aumenta faltas. Dezembro: férias. Como antecipar cada fase.",
  ...
  alternates: { canonical: '/blog/sazonalidade-e-evasao-em-academia-padroes-ao-longo-do-ano' },
  openGraph: {
    title: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano",
    description: "Janeiro: pico matrícula + risco evasão. Março: pós-carnaval queda. Junho/julho: frio aumenta faltas. Dezembro: férias. Como antecipar cada fase.",
    url: 'https://neofitflow.com.br/blog/sazonalidade-e-evasao-em-academia-padroes-ao-longo-do-ano',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano", item: "https://neofitflow.com.br/blog/sazonalidade-e-evasao-em-academia-padroes-ao-longo-do-ano" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano
              </h1>
...
<h1>Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano</h1>
