...
export const metadata: Metadata = {
  title: "Motivação Que Traz Aluno de Volta: Psicologia da Reativação | NeoFitFlow",
  description: "Entenda os gatilhos psicológicos que realmente funcionam para trazer aluno de volta: progresso, comunidade, compromisso.",
  keywords: "motivação aluno, psicologia reativação, gatilhos mentais, volta treino",
  alternates: {
    canonical: '/blog/motivacao-traz-aluno-volta-psicologia-reativacao',
  },
  openGraph: {
    title: "Motivação Que Traz Aluno de Volta: Psicologia da Reativação",
    description: "Entenda os gatilhos psicológicos que realmente funcionam para trazer aluno de volta: progresso, comunidade, compromisso.",
    url: 'https://neofitflow.com.br/blog/motivacao-traz-aluno-volta-psicologia-reativacao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Motivação Que Traz Aluno de Volta: Psicologia da Reativação",
                item: "https://neofitflow.com.br/blog/motivacao-traz-aluno-volta-psicologia-reativacao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Motivação Que Traz Aluno de Volta: Psicologia da Reativação",
            description: "Entenda os gatilhos psicológicos que realmente funcionam para trazer aluno de volta: progresso, comunidade, compromisso.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Motivação Que Traz Aluno de Volta: Psicologia da Reativação</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar motivação que traz aluno de volta: psicologia da reativação, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Motivação Que Traz Aluno de Volta: Psicologia da Reativação não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
