...
export const metadata: Metadata = {
  title: "Onboarding de Novos Alunos: Primeiros 30 Dias Que Definem Retenção | NeoFitFlow",
  description: "Guia completo sobre onboarding de novos alunos: primeiros 30 dias que definem retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "onboarding novos alunos academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/onboarding-novos-alunos-academia',
  },
  openGraph: {
    title: "Onboarding de Novos Alunos: Primeiros 30 Dias Que Definem Retenção",
    description: "Guia completo sobre onboarding de novos alunos: primeiros 30 dias que definem retenção",
    url: 'https://neofitflow.com.br/blog/onboarding-novos-alunos-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Onboarding de Novos Alunos em Academia",
    description: "Guia completo sobre onboarding de novos alunos: primeiros 30 dias que definem retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Onboarding de Novos Alunos em Academia",
                item: "https://neofitflow.com.br/blog/onboarding-novos-alunos-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Onboarding de Novos Alunos: Primeiros 30 Dias Que Definem Retenção",
            description: "Guia completo sobre onboarding de novos alunos: primeiros 30 dias que definem retenção",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Onboarding de Novos Alunos: Primeiros 30 Dias Que Definem Retenção</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-30">30/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como onboarding de novos alunos: primeiros 30 dias que definem retenção, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Onboarding de Novos Alunos: Primeiros 30 Dias Que Definem Retenção não é apenas uma tendência - é uma necessidade para academias que querem
