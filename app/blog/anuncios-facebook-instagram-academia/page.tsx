...
export const metadata: Metadata = {
  title: "Anúncios no Facebook e Instagram: Guia Completo Para Academia | NeoFitFlow",
  description: "Guia completo sobre anúncios no facebook e instagram: guia completo para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "anuncios facebook instagram academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/anuncios-facebook-instagram-academia',
  },
  openGraph: {
    title: "Anúncios no Facebook e Instagram: Guia Completo Para Academia",
    description: "Guia completo sobre anúncios no facebook e instagram: guia completo para academia",
    url: 'https://neofitflow.com.br/blog/anuncios-facebook-instagram-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Anúncios Facebook e Instagram Para Academia",
    description: "Guia completo sobre anúncios no facebook e instagram: guia completo para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Anúncios Facebook e Instagram Para Academia",
                item: "https://neofitflow.com.br/blog/anuncios-facebook-instagram-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Anúncios no Facebook e Instagram: Guia Completo Para Academia",
            description: "Guia completo sobre anúncios no facebook e instagram: guia completo para academia",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-600 mb-4">Marketing</div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Anúncios no Facebook e Instagram: Guia Completo Para Academia</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-22">22/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como anúncios no facebook e instagram: guia completo para academia, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Anúncios no Facebook e Instagram: Guia Completo Para Academia não é apenas uma tendência - é uma necessidade para academias que querem
