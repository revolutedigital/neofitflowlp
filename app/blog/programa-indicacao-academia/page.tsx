...
export const metadata: Metadata = {
  title: "Programa de Indicação: Como Criar e Incentivar Alunos | NeoFitFlow",
  description: "Guia completo sobre programa de indicação: como criar e incentivar alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "programa indicacao academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/programa-indicacao-academia',
  },
  openGraph: {
    title: "Programa de Indicação: Como Criar e Incentivar Alunos",
    description: "Guia completo sobre programa de indicação: como criar e incentivar alunos",
    url: 'https://neofitflow.com.br/blog/programa-indicacao-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Programa de Indicação Para Academia",
    description: "Guia completo sobre programa de indicação: como criar e incentivar alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Programa de Indicação Para Academia",
                item: "https://neofitflow.com.br/blog/programa-indicacao-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Programa de Indicação: Como Criar e Incentivar Alunos",
            description: "Guia completo sobre programa de indicação: como criar e incentivar alunos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Programa de Indicação: Como Criar e Incentivar Alunos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-30">30/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como programa de indicação: como criar e incentivar alunos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Programa de Indicação: Como Criar e Incentivar Alunos não é apenas uma tendência - é uma necessidade para academias que querem
