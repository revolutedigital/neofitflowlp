...
export const metadata: Metadata = {
  title: "Reels e TikTok Para Academia: Como Viralizar e Atrair Alunos | NeoFitFlow",
  description: "Guia completo sobre reels e tiktok para academia: como viralizar e atrair alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "reels tiktok academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/reels-tiktok-academia',
  },
  openGraph: {
    title: "Reels e TikTok Para Academia: Como Viralizar e Atrair Alunos",
    description: "Guia completo sobre reels e tiktok para academia: como viralizar e atrair alunos",
    url: 'https://neofitflow.com.br/blog/reels-tiktok-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Reels e TikTok Para Academia",
    description: "Guia completo sobre reels e tiktok para academia: como viralizar e atrair alunos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Reels e TikTok Para Academia",
                item: "https://neofitflow.com.br/blog/reels-tiktok-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Reels e TikTok Para Academia: Como Viralizar e Atrair Alunos",
            description: "Guia completo sobre reels e tiktok para academia: como viralizar e atrair alunos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Reels e TikTok Para Academia: Como Viralizar e Atrair Alunos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-24">24/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como reels e tiktok para academia: como viralizar e atrair alunos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Reels e TikTok Para Academia: Como Viralizar e Atrair Alunos não é apenas uma tendência - é uma necessidade para academias que querem
