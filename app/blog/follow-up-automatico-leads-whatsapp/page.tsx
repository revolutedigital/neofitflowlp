...
export const metadata: Metadata = {
  title: "Follow-up Automático de Leads no WhatsApp: Quando e Como Fazer | NeoFitFlow",
  description: "Guia completo sobre follow-up automático de leads no whatsapp: quando e como fazer. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "follow up automatico leads whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/follow-up-automatico-leads-whatsapp',
  },
  openGraph: {
    title: "Follow-up Automático de Leads no WhatsApp: Quando e Como Fazer",
    description: "Guia completo sobre follow-up automático de leads no whatsapp: quando e como fazer",
    url: 'https://neofitflow.com.br/blog/follow-up-automatico-leads-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Follow-up Automático de Leads no WhatsApp",
    description: "Guia completo sobre follow-up automático de leads no whatsapp: quando e como fazer. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Follow-up Automático de Leads no WhatsApp",
                item: "https://neofitflow.com.br/blog/follow-up-automatico-leads-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Follow-up Automático de Leads no WhatsApp: Quando e Como Fazer",
            description: "Guia completo sobre follow-up automático de leads no whatsapp: quando e como fazer",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Follow-up Automático de Leads no WhatsApp: Quando e Como Fazer</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-10">10/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como follow-up automático de leads no whatsapp: quando e como fazer, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Follow-up Automático de Leads no WhatsApp: Quando e Como Fazer não é apenas uma tendência - é uma necessidade para academias que querem
