...
export const metadata: Metadata = {
  ...
  description: "Ver progresso = motivação. Gráficos frequência, fotos antes/depois, medidas, carga progressão. Progresso invisível = desmotivação = evasão. Como tornar visível.",
  ...
  alternates: { canonical: '/blog/progresso-visivel-por-que-mostrar-evolucao-aumenta-retencao' },
  openGraph: {
    title: "Progresso Visível: Por Que Mostrar Evolução Aumenta Retenção",
    description: "Ver progresso = motivação. Gráficos frequência, fotos antes/depois, medidas, carga progressão. Progresso invisível = desmotivação = evasão. Como tornar visível.",
    url: 'https://neofitflow.com.br/blog/progresso-visivel-por-que-mostrar-evolucao-aumenta-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Progresso Visível: Por Que Mostrar Evolução Aumenta Retenção", item: "https://neofitflow.com.br/blog/progresso-visivel-por-que-mostrar-evolucao-aumenta-retencao" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Progresso Visível: Por Que Mostrar Evolução Aumenta Retenção
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-08">7 de março de 2025</time>
                <span>•</span>
...
<h1>Progresso Visível: Por Que Mostrar Evolução Aumenta Retenção</h1>
