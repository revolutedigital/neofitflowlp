...
export const metadata: Metadata = {
  title: "A Primeira Falta: Momento Crítico Que Define Retenção | NeoFitFlow",
  description: "Por que como você reage à primeira falta do aluno determina se ele volta ou inicia sequência de ausências.",
  keywords: "primeira falta, momento crítico, ação preventiva, ponto virada",
  alternates: {
    canonical: '/blog/primeira-falta-momento-critico-define-retencao',
  },
  openGraph: {
    title: "A Primeira Falta: Momento Crítico Que Define Retenção",
    description: "Por que como você reage à primeira falta do aluno determina se ele volta ou inicia sequência de ausências.",
    url: 'https://neofitflow.com.br/blog/primeira-falta-momento-critico-define-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "A Primeira Falta: Momento Crítico Que Define Retenção",
                item: "https://neofitflow.com.br/blog/primeira-falta-momento-critico-define-retencao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "A Primeira Falta: Momento Crítico Que Define Retenção",
            description: "Por que como você reage à primeira falta do aluno determina se ele volta ou inicia sequência de ausências.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">A Primeira Falta: Momento Crítico Que Define Retenção</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar a primeira falta: momento crítico que define retenção, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                A Primeira Falta: Momento Crítico Que Define Retenção não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
