...
export const metadata: Metadata = {
  ...
  description: "Pilates: aulas agendadas, grupos pequenos. Falta = vaga perdida = receita perdida. IA monitora agendamentos, faltas, remarca automaticamente, previne desistência.",
  ...
  alternates: { canonical: '/blog/retencao-em-studio-de-pilates-com-ia-aulas-agendadas-e-faltas' },
  openGraph: {
    title: "Retenção em Studio de Pilates com IA: Aulas Agendadas e Faltas",
    description: "Pilates: aulas agendadas, grupos pequenos. Falta = vaga perdida = receita perdida. IA monitora agendamentos, faltas, remarca automaticamente, previne desistência.",
    url: 'https://neofitflow.com.br/blog/retencao-em-studio-de-pilates-com-ia-aulas-agendadas-e-faltas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Retenção em Studio de Pilates com IA: Aulas Agendadas e Faltas", item: "https://neofitflow.com.br/blog/retencao-em-studio-de-pilates-com-ia-aulas-agendadas-e-faltas" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Retenção em Studio de Pilates com IA: Aulas Agendadas e Faltas
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-16">15 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Retenção em Studio de Pilates com IA: Aulas Agendadas e Faltas</h1>
