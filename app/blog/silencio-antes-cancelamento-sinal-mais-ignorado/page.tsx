...
export const metadata: Metadata = {
  title: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado | NeoFitFlow",
  description: "Como falta de interação e engajamento é um indicador silencioso mas poderoso de evasão iminente.",
  keywords: "silêncio aluno, falta engajamento, sinal silencioso, desconexão",
  alternates: {
    canonical: '/blog/silencio-antes-cancelamento-sinal-mais-ignorado',
  },
  openGraph: {
    title: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado",
    description: "Como falta de interação e engajamento é um indicador silencioso mas poderoso de evasão iminente.",
    url: 'https://neofitflow.com.br/blog/silencio-antes-cancelamento-sinal-mais-ignorado',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado",
                item: "https://neofitflow.com.br/blog/silencio-antes-cancelamento-sinal-mais-ignorado",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado",
            description: "Como falta de interação e engajamento é um indicador silencioso mas poderoso de evasão iminente.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Silêncio Antes do Cancelamento: O Sinal Mais Ignorado</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar silêncio antes do cancelamento: o sinal mais ignorado, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Silêncio Antes do Cancelamento: O Sinal Mais Ignorado não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
