...
export const metadata: Metadata = {
  ...
  description: "Aluno que tem amigos na academia tem 70% menos chance de cancelar. Como criar comunidade: eventos, grupos, desafios coletivos, reconhecimento social.",
  ...
  alternates: { canonical: '/blog/senso-de-comunidade-previne-evasao-como-criar-pertencimento' },
  openGraph: {
    title: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento",
    description: "Aluno que tem amigos na academia tem 70% menos chance de cancelar. Como criar comunidade: eventos, grupos, desafios coletivos, reconhecimento social.",
    url: 'https://neofitflow.com.br/blog/senso-de-comunidade-previne-evasao-como-criar-pertencimento',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento", item: "https://neofitflow.com.br/blog/senso-de-comunidade-previne-evasao-como-criar-pertencimento" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Senso de Comunidade Previne Evasão: Como Criar Pertencimento
              </h1>
...
<h1>Senso de Comunidade Previne Evasão: Como Criar Pertencimento</h1>
