...
export const metadata: Metadata = {
  ...
  description: "Cases reais: academia em SP reduziu evasão de 30% para 18% em 6 meses com IA. Box de CrossFit salvou R$ 8k/mês em MRR. Veja resultados comprovados.",
  ...
  alternates: { canonical: '/blog/ia-reduz-evasao-em-ate-40-cases-reais-de-academias-brasileiras' },
  openGraph: {
    title: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras",
    description: "Cases reais: academia em SP reduziu evasão de 30% para 18% em 6 meses com IA. Box de CrossFit salvou R$ 8k/mês em MRR. Veja resultados comprovados.",
    url: 'https://neofitflow.com.br/blog/ia-reduz-evasao-em-ate-40-cases-reais-de-academias-brasileiras',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras", item: "https://neofitflow.com.br/blog/ia-reduz-evasao-em-ate-40-cases-reais-de-academias-brasileiras" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras
              </h1>
...
<h1>IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras</h1>
