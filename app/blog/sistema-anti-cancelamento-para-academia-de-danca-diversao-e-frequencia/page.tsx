...
export const metadata: Metadata = {
  ...
  description: "Dança: motivação por diversão + social. Quando vira obrigação ou aluno se sente perdido, evasão dispara. Como IA detecta perda de encantamento e reengaja.",
  ...
  alternates: { canonical: '/blog/sistema-anti-cancelamento-para-academia-de-danca-diversao-e-frequencia' },
  openGraph: {
    title: "Sistema Anti-Cancelamento para Academia de Dança: Diversão e Frequência",
    description: "Dança: motivação por diversão + social. Quando vira obrigação ou aluno se sente perdido, evasão dispara. Como IA detecta perda de encantamento e reengaja.",
    url: 'https://neofitflow.com.br/blog/sistema-anti-cancelamento-para-academia-de-danca-diversao-e-frequencia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Sistema Anti-Cancelamento para Academia de Dança: Diversão e Frequência", item: "https://neofitflow.com.br/blog/sistema-anti-cancelamento-para-academia-de-danca-diversao-e-frequencia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Sistema Anti-Cancelamento para Academia de Dança: Diversão e Frequência
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-12">11 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Sistema Anti-Cancelamento para Academia de Dança: Diversão e Frequência</h1>
