...
export const metadata: Metadata = {
  title: "Gestão de Box CrossFit: Diferenças e Estratégias Específicas | NeoFitFlow",
  description: "Guia completo sobre gestão de box crossfit: diferenças e estratégias específicas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "crossfit box gestao diferencas, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/crossfit-box-gestao-diferencas',
  },
  openGraph: {
    title: "Gestão de Box CrossFit: Diferenças e Estratégias Específicas",
    description: "Guia completo sobre gestão de box crossfit: diferenças e estratégias específicas",
    url: 'https://neofitflow.com.br/blog/crossfit-box-gestao-diferencas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "CrossFit Box: Gestão e Diferenças",
    description: "Guia completo sobre gestão de box crossfit: diferenças e estratégias específicas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "CrossFit Box: Gestão e Diferenças",
                item: "https://neofitflow.com.br/blog/crossfit-box-gestao-diferencas",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Gestão de Box CrossFit: Diferenças e Estratégias Específicas",
            description: "Guia completo sobre gestão de box crossfit: diferenças e estratégias específicas",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Gestão de Box CrossFit: Diferenças e Estratégias Específicas</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-21">21/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como gestão de box crossfit: diferenças e estratégias específicas, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Gestão de Box CrossFit: Diferenças e Estratégias Específicas não é apenas uma tendência - é uma necessidade para academias que querem
