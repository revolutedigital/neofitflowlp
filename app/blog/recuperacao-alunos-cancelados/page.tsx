...
export const metadata: Metadata = {
  title: "Recuperação de Alunos Cancelados: Estratégias de Reconquista Que Funcionam | NeoFitFlow",
  description: "Guia completo sobre recuperação de alunos cancelados: estratégias de reconquista que funcionam. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "recuperacao alunos cancelados, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/recuperacao-alunos-cancelados',
  },
  openGraph: {
    title: "Recuperação de Alunos Cancelados: Estratégias de Reconquista Que Funcionam",
    description: "Guia completo sobre recuperação de alunos cancelados: estratégias de reconquista que funcionam",
    url: 'https://neofitflow.com.br/blog/recuperacao-alunos-cancelados',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Recuperação de Alunos Cancelados",
    description: "Guia completo sobre recuperação de alunos cancelados: estratégias de reconquista que funcionam. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Recuperação de Alunos Cancelados",
                item: "https://neofitflow.com.br/blog/recuperacao-alunos-cancelados",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Recuperação de Alunos Cancelados: Estratégias de Reconquista Que Funcionam",
            description: "Guia completo sobre recuperação de alunos cancelados: estratégias de reconquista que funcionam",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Recuperação de Alunos Cancelados: Estratégias de Reconquista Que Funcionam</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-03">03/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como recuperação de alunos cancelados: estratégias de reconquista que funcionam, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Recuperação de Alunos Cancelados: Estratégias de Reconquista Que Funcionam não é apenas uma tendência - é uma necessidade para academias que querem
