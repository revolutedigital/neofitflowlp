...
export const metadata: Metadata = {
  title: "Flow Builder WhatsApp Sem Código: Como Criar Automações Visuais | NeoFitFlow",
  description: "Guia completo sobre flow builder whatsapp sem código: como criar automações visuais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "flow builder whatsapp sem codigo, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/flow-builder-whatsapp-sem-codigo',
  },
  openGraph: {
    title: "Flow Builder WhatsApp Sem Código: Como Criar Automações Visuais",
    description: "Guia completo sobre flow builder whatsapp sem código: como criar automações visuais",
    url: 'https://neofitflow.com.br/blog/flow-builder-whatsapp-sem-codigo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Flow Builder WhatsApp Sem Código",
    description: "Guia completo sobre flow builder whatsapp sem código: como criar automações visuais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Flow Builder WhatsApp Sem Código",
                item: "https://neofitflow.com.br/blog/flow-builder-whatsapp-sem-codigo",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Flow Builder WhatsApp Sem Código: Como Criar Automações Visuais",
            description: "Guia completo sobre flow builder whatsapp sem código: como criar automações visuais",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Flow Builder WhatsApp Sem Código: Como Criar Automações Visuais</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-20">20/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como flow builder whatsapp sem código: como criar automações visuais, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Flow Builder WhatsApp Sem Código: Como Criar Automações Visuais não é apenas uma tendência - é uma necessidade para academias que querem
