...
export const metadata: Metadata = {
  title: "SEO Local Para Academia: Como Aparecer no Google Maps | NeoFitFlow",
  description: "Guia completo sobre seo local para academia: como aparecer no google maps. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "seo local academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/seo-local-academia',
  },
  openGraph: {
    title: "SEO Local Para Academia: Como Aparecer no Google Maps",
    description: "Guia completo sobre seo local para academia: como aparecer no google maps",
    url: 'https://neofitflow.com.br/blog/seo-local-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "SEO Local Para Academia",
    description: "Guia completo sobre seo local para academia: como aparecer no google maps. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "SEO Local Para Academia",
                item: "https://neofitflow.com.br/blog/seo-local-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "SEO Local Para Academia: Como Aparecer no Google Maps",
            description: "Guia completo sobre seo local para academia: como aparecer no google maps",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">SEO Local Para Academia: Como Aparecer no Google Maps</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-23">23/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como seo local para academia: como aparecer no google maps, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                SEO Local Para Academia: Como Aparecer no Google Maps não é apenas uma tendência - é uma necessidade para academias que querem
