...
export const metadata: Metadata = {
  ...
  description: "Linha tênue entre 'queremos ajudar' e 'por que não vem?'. Técnicas de comunicação não-violenta aplicadas à retenção. Ofereça saída, não pressão.",
  ...
  alternates: { canonical: '/blog/oferecer-ajuda-sem-parecer-cobranca-arte-da-abordagem-preventiva' },
  openGraph: {
    title: "Oferecer Ajuda Sem Parecer Cobrança: Arte da Abordagem Preventiva",
    description: "Linha tênue entre 'queremos ajudar' e 'por que não vem?'. Técnicas de comunicação não-violenta aplicadas à retenção. Ofereça saída, não pressão.",
    url: 'https://neofitflow.com.br/blog/oferecer-ajuda-sem-parecer-cobranca-arte-da-abordagem-preventiva',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Oferecer Ajuda Sem Parecer Cobrança: Arte da Abordagem Preventiva", item: "https://neofitflow.com.br/blog/oferecer-ajuda-sem-parecer-cobranca-arte-da-abordagem-preventiva" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Oferecer Ajuda Sem Parecer Cobrança: Arte da Abordagem Preventiva
              </h1>
...
<h1>Oferecer Ajuda Sem Parecer Cobrança: Arte da Abordagem Preventiva</h1>
