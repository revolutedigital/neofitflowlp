...
export const metadata: Metadata = {
  ...
  description: "Yoga: baixa intensidade = fácil de 'pular'. Aluno adia, adia, some. IA cria urgência positiva, lembra benefícios, convida para aulas especiais.",
  keywords: "retenção yoga ia, manter frequência yoga, prevenir evasão yoga, sistema yoga específico, engajamento yoga academia",
  alternates: { canonical: '/blog/yoga-e-retencao-como-manter-frequencia-em-pratica-de-baixa-intensidade' },
  openGraph: {
    title: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade",
    description: "Yoga: baixa intensidade = fácil de 'pular'. Aluno adia, adia, some. IA cria urgência positiva, lembra benefícios, convida para aulas especiais.",
    url: 'https://neofitflow.com.br/blog/yoga-e-retencao-como-manter-frequencia-em-pratica-de-baixa-intensidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade", item: "https://neofitflow.com.br/blog/yoga-e-retencao-como-manter-frequencia-em-pratica-de-baixa-intensidade" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-17">16 de março de 2025</time>
                <span>•</span>
...
<h1>Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade</h1>
