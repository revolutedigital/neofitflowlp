...
export const metadata: Metadata = {
  ...
  description: "Cálculo detalhado: investimento R$ 300-500/mês. Salvando 8-12 alunos/mês = breakeven em 2-3 meses. ROI 400-600% no primeiro ano.",
  ...
  alternates: { canonical: '/blog/breakeven-de-sistema-anti-evasao-em-quanto-tempo-se-paga' },
  openGraph: {
    title: "Breakeven de Sistema Anti-Evasão: Em Quanto Tempo Se Paga",
    description: "Cálculo detalhado: investimento R$ 300-500/mês. Salvando 8-12 alunos/mês = breakeven em 2-3 meses. ROI 400-600% no primeiro ano.",
    url: 'https://neofitflow.com.br/blog/breakeven-de-sistema-anti-evasao-em-quanto-tempo-se-paga',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Breakeven de Sistema Anti-Evasão: Em Quanto Tempo Se Paga", item: "https://neofitflow.com.br/blog/breakeven-de-sistema-anti-evasao-em-quanto-tempo-se-paga" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Breakeven de Sistema Anti-Evasão: Em Quanto Tempo Se Paga
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-20">19 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Breakeven de Sistema Anti-Evasão: Em Quanto Tempo Se Paga</h1>
