...
export const metadata: Metadata = {
  ...
  description: "Evasão mensal de 3% = 36% anual? NÃO! Entenda a diferença entre churn mensal e anual, como calcular cada um e por que confundir os dois é perigoso.",
  ...
  alternates: { canonical: '/blog/evasao-mensal-vs-anual-em-academia-analise-e-diferencas-criticas' },
  openGraph: {
    title: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas",
    description: "Evasão mensal de 3% = 36% anual? NÃO! Entenda a diferença entre churn mensal e anual, como calcular cada um e por que confundir os dois é perigoso.",
    url: 'https://neofitflow.com.br/blog/evasao-mensal-vs-anual-em-academia-analise-e-diferencas-criticas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas", item: "https://neofitflow.com.br/blog/evasao-mensal-vs-anual-em-academia-analise-e-diferencas-criticas" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas
              </h1>
...
<h1>Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas</h1>
