...
export const metadata: Metadata = {
  title: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa | NeoFitFlow",
  description: "Estratégias específicas para reter os alunos de janeiro que entram motivados mas abandonam em fevereiro/março.",
  keywords: "evasão janeiro, promessa ano novo, retenção verão, aluno sazonal",
  alternates: {
    canonical: '/blog/janeiro-evasao-academia-como-prevenir-abandono-pos-promessa',
  },
  openGraph: {
    title: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa",
    description: "Estratégias específicas para reter os alunos de janeiro que entram motivados mas abandonam em fevereiro/março.",
    url: 'https://neofitflow.com.br/blog/janeiro-evasao-academia-como-prevenir-abandono-pos-promessa',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa",
                item: "https://neofitflow.com.br/blog/janeiro-evasao-academia-como-prevenir-abandono-pos-promessa",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa",
            description: "Estratégias específicas para reter os alunos de janeiro que entram motivados mas abandonam em fevereiro/março.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar janeiro e evasão em academia: como prevenir abandono pós-promessa, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Janeiro e Evasão em Academia: Como Prevenir Abandono Pós-Promessa não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
