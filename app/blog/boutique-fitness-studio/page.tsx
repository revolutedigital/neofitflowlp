...
export const metadata: Metadata = {
  title: "Boutique Fitness Studio: Como Posicionar e Precificar | NeoFitFlow",
  description: "Guia completo sobre boutique fitness studio: como posicionar e precificar. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "boutique fitness studio, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/boutique-fitness-studio',
  },
  openGraph: {
    title: "Boutique Fitness Studio: Como Posicionar e Precificar",
    description: "Guia completo sobre boutique fitness studio: como posicionar e precificar",
    url: 'https://neofitflow.com.br/blog/boutique-fitness-studio',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: "https://neofitflow.com.br/blog/boutique-fitness-studio",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Boutique Fitness Studio: Como Posicionar e Precificar",
            description: "Guia completo sobre boutique fitness studio: como posicionar e precificar",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Boutique Fitness Studio: Como Posicionar e Precificar</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-15">15/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como boutique fitness studio: como posicionar e precificar, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Boutique Fitness Studio: Como Posicionar e Precificar não é apenas uma tendência - é uma necessidade para academias que querem
