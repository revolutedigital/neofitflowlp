...
export const metadata: Metadata = {
  title: "Eventos e Desafios em Academia: Como Organizar e Divulgar | NeoFitFlow",
  description: "Guia completo sobre eventos e desafios em academia: como organizar e divulgar. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "eventos desafios academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/eventos-desafios-academia',
  },
  openGraph: {
    title: "Eventos e Desafios em Academia: Como Organizar e Divulgar",
    description: "Guia completo sobre eventos e desafios em academia: como organizar e divulgar",
    url: 'https://neofitflow.com.br/blog/eventos-desafios-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Eventos e Desafios na Academia",
    description: "Guia completo sobre eventos e desafios em academia: como organizar e divulgar. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Eventos e Desafios na Academia",
                item: "https://neofitflow.com.br/blog/eventos-desafios-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Eventos e Desafios em Academia: Como Organizar e Divulgar",
            description: "Guia completo sobre eventos e desafios em academia: como organizar e divulgar",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Eventos e Desafios em Academia: Como Organizar e Divulgar</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-28">28/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como eventos e desafios em academia: como organizar e divulgar, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Eventos e Desafios em Academia: Como Organizar e Divulgar não é apenas uma tendência - é uma necessidade para academias que querem
