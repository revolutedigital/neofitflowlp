...
export const metadata: Metadata = {
  title: "Funil de Vendas no WhatsApp: Do Lead à Matrícula | NeoFitFlow",
  description: "Guia completo sobre funil de vendas no whatsapp: do lead à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "funil vendas whatsapp academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/funil-vendas-whatsapp-academia',
  },
  openGraph: {
    title: "Funil de Vendas no WhatsApp: Do Lead à Matrícula",
    description: "Guia completo sobre funil de vendas no whatsapp: do lead à matrícula",
    url: 'https://neofitflow.com.br/blog/funil-vendas-whatsapp-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Funil de Vendas no WhatsApp Para Academia",
    description: "Guia completo sobre funil de vendas no whatsapp: do lead à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Funil de Vendas no WhatsApp Para Academia",
                item: "https://neofitflow.com.br/blog/funil-vendas-whatsapp-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Funil de Vendas no WhatsApp: Do Lead à Matrícula",
            description: "Guia completo sobre funil de vendas no whatsapp: do lead à matrícula",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Funil de Vendas no WhatsApp: Do Lead à Matrícula</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-11">11/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como funil de vendas no whatsapp: do lead à matrícula, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Funil de Vendas no WhatsApp: Do Lead à Matrícula não é apenas uma tendência - é uma necessidade para academias que querem
