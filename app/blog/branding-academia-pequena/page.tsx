...
export const metadata: Metadata = {
  title: "Branding Para Academia Pequena: Como Criar Marca Forte | NeoFitFlow",
  description: "Guia completo sobre branding para academia pequena: como criar marca forte. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "branding academia pequena, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/branding-academia-pequena',
  },
  openGraph: {
    title: "Branding Para Academia Pequena: Como Criar Marca Forte",
    description: "Guia completo sobre branding para academia pequena: como criar marca forte",
    url: 'https://neofitflow.com.br/blog/branding-academia-pequena',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Branding Para Academia Pequena",
    description: "Guia completo sobre branding para academia pequena: como criar marca forte. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Branding Para Academia Pequena",
                item: "https://neofitflow.com.br/blog/branding-academia-pequena",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Branding Para Academia Pequena: Como Criar Marca Forte",
            description: "Guia completo sobre branding para academia pequena: como criar marca forte",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Branding Para Academia Pequena: Como Criar Marca Forte</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-27">27/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como branding para academia pequena: como criar marca forte, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Branding Para Academia Pequena: Como Criar Marca Forte não é apenas uma tendência - é uma necessidade para academias que querem
