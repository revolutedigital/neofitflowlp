...
export const metadata: Metadata = {
  title: "Copywriting Para Vendas em Academia: Fórmulas e Exemplos | NeoFitFlow",
  description: "Guia completo sobre copywriting para vendas em academia: fórmulas e exemplos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "copywriting vendas academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/copywriting-vendas-academia',
  },
  openGraph: {
    title: "Copywriting Para Vendas em Academia: Fórmulas e Exemplos",
    description: "Guia completo sobre copywriting para vendas em academia: fórmulas e exemplos",
    url: 'https://neofitflow.com.br/blog/copywriting-vendas-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Copywriting Para Vendas em Academia",
    description: "Guia completo sobre copywriting para vendas em academia: fórmulas e exemplos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Copywriting Para Vendas em Academia",
                item: "https://neofitflow.com.br/blog/copywriting-vendas-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Copywriting Para Vendas em Academia: Fórmulas e Exemplos",
            description: "Guia completo sobre copywriting para vendas em academia: fórmulas e exemplos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Copywriting Para Vendas em Academia: Fórmulas e Exemplos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-26">26/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como copywriting para vendas em academia: fórmulas e exemplos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Copywriting Para Vendas em Academia: Fórmulas e Exemplos não é apenas uma tendência - é uma necessidade para academias que querem
