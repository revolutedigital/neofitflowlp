...
export const metadata: Metadata = {
  title: "Timing Perfeito para Mensagem de Retenção: Ciência do Quando | NeoFitFlow",
  description: "Estudo 50k mensagens: 9-10h manhã = 42% resposta. 14-15h = 31%. 20-21h = 25%. Noite/madrugada = 8%. IA envia no momento ideal para CADA aluno.",
  ...
  alternates: { canonical: '/blog/timing-perfeito-para-mensagem-de-retencao-ciencia-do-quando' },
  openGraph: {
    title: "Timing Perfeito para Mensagem de Retenção: Ciência do Quando",
    description: "Estudo 50k mensagens: 9-10h manhã = 42% resposta. 14-15h = 31%. 20-21h = 25%. Noite/madrugada = 8%. IA envia no momento ideal para CADA aluno.",
    url: 'https://neofitflow.com.br/blog/timing-perfeito-para-mensagem-de-retencao-ciencia-do-quando',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Timing Perfeito para Mensagem de Retenção: Ciência do Quando", item: "https://neofitflow.com.br/blog/timing-perfeito-para-mensagem-de-retencao-ciencia-do-quando" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Timing Perfeito para Mensagem de Retenção: Ciência do Quando",
          description: "Estudo 50k mensagens: 9-10h manhã = 42% resposta. 14-15h = 31%. 20-21h = 25%. Noite/madrugada = 8%. IA envia no momento ideal para CADA aluno.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Timing Perfeito para Mensagem de Retenção: Ciência do Quando
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-13">12 de março de 2025</time>
                <span>•</span>
...
<h1>Timing Perfeito para Mensagem de Retenção: Ciência do Quando</h1>
