...
export const metadata: Metadata = {
  title: "Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar | NeoFitFlow",
  description: "Quando aluno sente academia como segunda casa, evasão cai 70%. Como criar: ambiente acolhedor, staff que conhece cada um, rituais, tradições, pertencimento real.",
  ...
  alternates: { canonical: '/blog/academia-como-segunda-casa-ambiente-que-ninguem-quer-deixar' },
  openGraph: {
    title: "Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar",
    description: "Quando aluno sente academia como segunda casa, evasão cai 70%. Como criar: ambiente acolhedor, staff que conhece cada um, rituais, tradições, pertencimento real.",
    url: 'https://neofitflow.com.br/blog/academia-como-segunda-casa-ambiente-que-ninguem-quer-deixar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar", item: "https://neofitflow.com.br/blog/academia-como-segunda-casa-ambiente-que-ninguem-quer-deixar" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar",
          description: "Quando aluno sente academia como segunda casa, evasão cai 70%. Como criar: ambiente acolhedor, staff que conhece cada um, rituais, tradições, pertencimento real.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-03">2 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Academia Como Segunda Casa: Ambiente que Ninguém Quer Deixar</h1>
