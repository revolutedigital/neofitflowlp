...
export const metadata: Metadata = {
  title: "Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro | NeoFitFlow",
  description: "Use nossa calculadora para descobrir o impacto real da evasão no faturamento anual da sua academia considerando LTV e CAC.",
  keywords: "calculadora evasão, perda financeira, impacto receita, simulação prejuízo",
  alternates: {
    canonical: '/blog/quanto-voce-perde-evasao-calculadora-impacto-financeiro',
  },
  openGraph: {
    title: "Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro",
    description: "Use nossa calculadora para descobrir o impacto real da evasão no faturamento anual da sua academia considerando LTV e CAC.",
    url: 'https://neofitflow.com.br/blog/quanto-voce-perde-evasao-calculadora-impacto-financeiro',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro",
                item: "https://neofitflow.com.br/blog/quanto-voce-perde-evasao-calculadora-impacto-financeiro",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro",
            description: "Use nossa calculadora para descobrir o impacto real da evasão no faturamento anual da sua academia considerando LTV e CAC.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar quanto você perde com evasão: calculadora de impacto financeiro, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Quanto Você Perde Com Evasão: Calculadora de Impacto Financeiro não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
