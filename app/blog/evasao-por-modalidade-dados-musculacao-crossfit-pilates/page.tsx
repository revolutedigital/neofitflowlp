...
export const metadata: Metadata = {
  ...
  description: "Compare taxas de evasão entre diferentes modalidades e entenda por que algumas retêm melhor que outras.",
  keywords: "evasão modalidade, comparativo treinos, retenção por tipo, estatísticas fitness",
  alternates: {
    canonical: '/blog/evasao-por-modalidade-dados-musculacao-crossfit-pilates',
  },
  openGraph: {
    title: "Evasão Por Modalidade: Dados de Musculação, CrossFit, Pilates e Mais",
    description: "Compare taxas de evasão entre diferentes modalidades e entenda por que algumas retêm melhor que outras.",
    url: 'https://neofitflow.com.br/blog/evasao-por-modalidade-dados-musculacao-crossfit-pilates',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Evasão Por Modalidade: Dados de Musculação, CrossFit, Pilates e Mais",
                item: "https://neofitflow.com.br/blog/evasao-por-modalidade-dados-musculacao-crossfit-pilates",
              },
            ],
          }),
        }}
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Evasão Por Modalidade: Dados de Musculação, CrossFit, Pilates e Mais</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar evasão por modalidade: dados de musculação, crossfit, pilates e mais, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Evasão Por Modalidade: Dados de Musculação, CrossFit, Pilates e Mais não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
