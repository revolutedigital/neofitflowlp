...
export const metadata: Metadata = {
  title: "Automação de Cobrança: Como Reduzir Inadimplência em 50% | NeoFitFlow",
  description: "Guia completo sobre automação de cobrança: como reduzir inadimplência em 50%. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "automacao cobranca academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/automacao-cobranca-academia',
  },
  openGraph: {
    title: "Automação de Cobrança: Como Reduzir Inadimplência em 50%",
    description: "Guia completo sobre automação de cobrança: como reduzir inadimplência em 50%",
    url: 'https://neofitflow.com.br/blog/automacao-cobranca-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Automação de Cobrança em Academia",
    description: "Guia completo sobre automação de cobrança: como reduzir inadimplência em 50%. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Automação de Cobrança em Academia",
                item: "https://neofitflow.com.br/blog/automacao-cobranca-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Automação de Cobrança: Como Reduzir Inadimplência em 50%",
            description: "Guia completo sobre automação de cobrança: como reduzir inadimplência em 50%",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Automação de Cobrança: Como Reduzir Inadimplência em 50%</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-12">12/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como automação de cobrança: como reduzir inadimplência em 50%, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Automação de Cobrança: Como Reduzir Inadimplência em 50% não é apenas uma tendência - é uma necessidade para academias que querem
