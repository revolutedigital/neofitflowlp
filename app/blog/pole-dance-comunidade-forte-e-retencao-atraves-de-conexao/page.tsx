...
export const metadata: Metadata = {
  ...
  description: "Pole dance: comunidade incrivelmente forte, evasão baixa. Mas quando aluno se sente 'pra trás', desiste. IA detecta comparação negativa e reengaja.",
  ...
  alternates: { canonical: '/blog/pole-dance-comunidade-forte-e-retencao-atraves-de-conexao' },
  openGraph: {
    title: "Pole Dance: Comunidade Forte e Retenção através de Conexão",
    description: "Pole dance: comunidade incrivelmente forte, evasão baixa. Mas quando aluno se sente 'pra trás', desiste. IA detecta comparação negativa e reengaja.",
    url: 'https://neofitflow.com.br/blog/pole-dance-comunidade-forte-e-retencao-atraves-de-conexao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Pole Dance: Comunidade Forte e Retenção através de Conexão", item: "https://neofitflow.com.br/blog/pole-dance-comunidade-forte-e-retencao-atraves-de-conexao" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Pole Dance: Comunidade Forte e Retenção através de Conexão
              </h1>
...
<h1>Pole Dance: Comunidade Forte e Retenção através de Conexão</h1>
