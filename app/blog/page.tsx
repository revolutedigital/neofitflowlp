...
// Import dos posts (será gerado automaticamente)
const blogPosts = [
  {
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      {/* Navigation */}
      <nav className="border-b-2 border-black fixed w-full z-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link
              href="/"
              className="text-white px-4 md:px-6 py-2 hover:bg-gray-800 transition-colors font-bold border-2 border-black text-sm md:text-base"
      ...
      {/* Hero - Enhanced */}
      <section className="pt-32 pb-12 px-4 border-b-2 border-black bg-white relative overflow-hidden">
        {/* Background pattern */}
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 mb-8">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold" style={{ color: '#818CF8' }}>301</p>
              <p className="text-sm text-gray-600 font-normal">Artigos Publicados</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold" style={{ color: '#FCD34D' }}>50k+</p>
              <p className="text-sm text-gray-600 font-normal">Leituras Mensais</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold flex items-center gap-2 justify-center" style={{ color: '#34D399' }}>
                <span>⭐</span>4.8
              </p>
              <p className="text-sm text-gray-600 font-normal">Avaliação Média</p>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-normal max-w-3xl mx-auto text-center mb-8">
            Guias práticos sobre IA, retenção de alunos e automação para academias
          </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-14 pr-12 py-4 bg-white text-black border-4 focus:outline-none focus:ring-4 text-lg rounded-lg font-normal transition-all"
                style={{ borderColor: '#818CF8', '--tw-ring-color': 'rgba(129, 140, 248, 0.5)' } as React.CSSProperties}
              />
              {searchTerm && (
                <button
                  onClick={() => setSearchTerm('')}
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-black text-2xl font-bold transition-colors"
                >
                  ✕
                </button>
              )}
              {searchTerm && (
                <div className="absolute -bottom-7 left-0 text-sm font-bold" style={{ color: '#818CF8' }}>
            ...
            <div className="flex flex-wrap gap-3 justify-center mt-10">
              {categories.map((category) => {
                const config = categoryConfig[category] || { color: 'bg-gray-700', textColor: 'text-black', icon: '📁' };
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 font-bold border-2 transition-all rounded-lg flex items-center gap-2 ${
                      isActive
                        ? 'text-white shadow-brutal-sm scale-105'
                        : 'bg-white text-black border-black hover:bg-gray-100'
                    }`}
                    style={isActive ? { backgroundColor: '#818CF8', borderColor: '#818CF8' } : {}}
                  >
                    {category !== 'Todos' && <span className="text-lg">{config.icon}</span>}
                    <span>{category}</span>
                    <span className={`text-xs px-2 py-0.5 rounded-full ${isActive ? 'bg-white/20 text-white' : 'bg-gray-200 text-black'}`}>
                      {count}
                    </span>
                  </button>
                );
      ...
      {!searchTerm && selectedCategory === 'Todos' && (
        <section className="py-12 px-4 border-b-2 border-black bg-white">
            ...
            <div className="bg-gradient-to-r from-primary to-secondary p-1 rounded-lg animate-fade-in">
              <div className="bg-gray-50 p-6 md:p-8 rounded-lg">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="bg-danger text-black px-4 py-2 font-bold text-sm rounded-full">
                    🔥 POPULAR
                  </span>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-700 font-normal mb-6 line-clamp-3">{featuredPost.excerpt}</p>

                    <div className="flex items-center gap-4 text-sm text-gray-600 font-normal mb-6">
                      <span className="flex items-center gap-1">
                        ⏱️ {getReadingTime(featuredPost.excerpt)} min
                      </span>
                      <span className="flex items-center gap-1">
                    ...
                    <Link
                      ...
                      className="text-white px-8 py-4 font-bold hover:scale-105 hover:shadow-brutal transition-all inline-block text-center rounded-lg"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8 text-center">
            <p className="text-xl text-gray-600 font-normal">
              ...
              {searchTerm && <span style={{ color: '#818CF8' }}> para "{searchTerm}"</span>}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {visiblePosts.map((post, index) => {
              const config = categoryConfig[post.category] || categoryConfig['Retenção'];
              ...
              return (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                  className="border-2 border-black hover:border-primary hover:shadow-brutal transition-all group rounded-lg overflow-hidden bg-white animate-slide-up"
                ...
                >
                  ...
                  <div className={`h-48 bg-gradient-to-br ${config.gradient} flex items-center justify-center relative overflow-hidden group-hover:scale-105 transition-transform`}>
                    ...
                    <div className="absolute top-3 left-3 flex flex-col gap-2">
                      ...
                      {index < 5 && (
                        <span className="bg-danger text-black px-3 py-1 font-bold text-xs rounded-full shadow-lg">
                          🔥 POPULAR
                        </span>
                      )}
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 font-normal group-hover:text-gray-900 mb-4 line-clamp-3">
                      {post.excerpt}
                    </p>

                    {/* Metadata */}
                    <div className="flex items-center gap-3 text-xs text-gray-600 font-normal mb-4">
                      <span className="flex items-center gap-1">
                        ⏱️ {getReadingTime(post.excerpt)} min
                      </span>
                      <span>•</span>
                      <span className="flex items-center gap-1">
                    ...
                    <span className="font-bold group-hover:translate-x-2 inline-block transition-transform" style={{ color: '#818CF8' }}>
                      Ler mais →
                    </span>
                  </div>
                </Link>
          ...
          {hasMore && (
            <div className="mt-12 text-center">
              <button
                ...
                className="text-white px-8 py-4 font-bold hover:scale-105 hover:shadow-brutal transition-all border-2 rounded-lg"
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-20">
              ...
              <p className="text-2xl text-gray-600 font-normal mb-4">Nenhum artigo encontrado</p>
              ...
              <button
                ...
                className="border-2 border-black px-6 py-3 font-bold hover:bg-gray-100 transition-all rounded-lg"
              >
                Limpar Filtros
              </button>
            </div>
      ...
      {/* CTA */}
      <section className="py-20 border-t-2 border-black bg-gradient-to-br from-primary via-secondary to-accent">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-black">
            Pronto Para Reduzir Evasão Com IA?
          </h2>
          <p className="text-xl text-black/90 font-normal mb-8">
            Sistema que identifica alunos em risco e age automaticamente via WhatsApp
          </p>
          <Link
            href="/"
            className="inline-block text-white px-8 py-4 font-bold hover:scale-105 transition-all text-lg border-2 rounded-lg shadow-brutal"
      ...
      <footer className="bg-gray-50 text-black py-12 border-t-2 border-black">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-600 font-normal">© 2025 NeoFitFlow. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
