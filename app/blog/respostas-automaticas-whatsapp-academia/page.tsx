...
export const metadata: Metadata = {
  title: "Respostas Automáticas no WhatsApp: 50 Mensagens Prontas Para Academia | NeoFitFlow",
  description: "Guia completo sobre respostas automáticas no whatsapp: 50 mensagens prontas para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "respostas automaticas whatsapp academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/respostas-automaticas-whatsapp-academia',
  },
  openGraph: {
    title: "Respostas Automáticas no WhatsApp: 50 Mensagens Prontas Para Academia",
    description: "Guia completo sobre respostas automáticas no whatsapp: 50 mensagens prontas para academia",
    url: 'https://neofitflow.com.br/blog/respostas-automaticas-whatsapp-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Respostas Automáticas no WhatsApp da Academia",
    description: "Guia completo sobre respostas automáticas no whatsapp: 50 mensagens prontas para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Respostas Automáticas no WhatsApp da Academia",
                item: "https://neofitflow.com.br/blog/respostas-automaticas-whatsapp-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Respostas Automáticas no WhatsApp: 50 Mensagens Prontas Para Academia",
            description: "Guia completo sobre respostas automáticas no whatsapp: 50 mensagens prontas para academia",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Respostas Automáticas no WhatsApp: 50 Mensagens Prontas Para Academia</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-21">21/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como respostas automáticas no whatsapp: 50 mensagens prontas para academia, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Respostas Automáticas no WhatsApp: 50 Mensagens Prontas Para Academia não é apenas uma tendência - é uma necessidade para academias que querem
