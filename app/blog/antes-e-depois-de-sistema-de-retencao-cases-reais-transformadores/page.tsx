...
export const metadata: Metadata = {
  ...
  description: "Case 1: academia SP, antes 32% evasão, depois 19%. Case 2: box CrossFit, antes R$ 12k MRR perdido/mês, depois R$ 4k. Transformações reais.",
  ...
  alternates: { canonical: '/blog/antes-e-depois-de-sistema-de-retencao-cases-reais-transformadores' },
  openGraph: {
    title: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores",
    description: "Case 1: academia SP, antes 32% evasão, depois 19%. Case 2: box CrossFit, antes R$ 12k MRR perdido/mês, depois R$ 4k. Transformações reais.",
    url: 'https://neofitflow.com.br/blog/antes-e-depois-de-sistema-de-retencao-cases-reais-transformadores',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores", item: "https://neofitflow.com.br/blog/antes-e-depois-de-sistema-de-retencao-cases-reais-transformadores" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Antes e Depois de Sistema de Retenção: Cases Reais Transformadores
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-19">18 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Antes e Depois de Sistema de Retenção: Cases Reais Transformadores</h1>
