...
export const metadata: Metadata = {
  title: "Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança | NeoFitFlow",
  description: "Como equilibrar preocupação genuína com profissionalismo na abordagem de alunos em risco sem parecer cobrança.",
  keywords: "tom correto, empatia comunicação, abordagem humana, sem cobrança",
  alternates: {
    canonical: '/blog/tom-certo-abordar-aluno-risco-empatia-vs-cobranca',
  },
  openGraph: {
    title: "Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança",
    description: "Como equilibrar preocupação genuína com profissionalismo na abordagem de alunos em risco sem parecer cobrança.",
    url: 'https://neofitflow.com.br/blog/tom-certo-abordar-aluno-risco-empatia-vs-cobranca',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança",
                item: "https://neofitflow.com.br/blog/tom-certo-abordar-aluno-risco-empatia-vs-cobranca",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança",
            description: "Como equilibrar preocupação genuína com profissionalismo na abordagem de alunos em risco sem parecer cobrança.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar tom certo para abordar aluno em risco: empatia vs cobrança, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Tom Certo Para Abordar Aluno em Risco: Empatia vs Cobrança não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
