...
export const metadata: Metadata = {
  ...
  description: "Mude de reativo para preventivo: aprenda a usar IA para agir 30 dias ANTES do cancelamento, quando taxa de salvamento é 7x maior que após pedido.",
  ...
  alternates: { canonical: '/blog/prevenir-evasao-antes-que-aconteca-estrategia-preventiva-com-ia' },
  openGraph: {
    title: "Prevenir Evasão Antes Que Aconteça: Estratégia Preventiva com IA",
    description: "Mude de reativo para preventivo: aprenda a usar IA para agir 30 dias ANTES do cancelamento, quando taxa de salvamento é 7x maior que após pedido.",
    url: 'https://neofitflow.com.br/blog/prevenir-evasao-antes-que-aconteca-estrategia-preventiva-com-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Prevenir Evasão Antes Que Aconteça: Estratégia Preventiva com IA", item: "https://neofitflow.com.br/blog/prevenir-evasao-antes-que-aconteca-estrategia-preventiva-com-ia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Prevenir Evasão Antes Que Aconteça: Estratégia Preventiva com IA
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-29">28 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Prevenir Evasão Antes Que Aconteça: Estratégia Preventiva com IA</h1>
