...
export const metadata: Metadata = {
  title: "Marketing de Conteúdo Para Academia: Como Criar e Distribuir | NeoFitFlow",
  description: "Guia completo sobre marketing de conteúdo para academia: como criar e distribuir. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "marketing conteudo academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/marketing-conteudo-academia',
  },
  openGraph: {
    title: "Marketing de Conteúdo Para Academia: Como Criar e Distribuir",
    description: "Guia completo sobre marketing de conteúdo para academia: como criar e distribuir",
    url: 'https://neofitflow.com.br/blog/marketing-conteudo-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Marketing de Conteúdo Para Academia",
    description: "Guia completo sobre marketing de conteúdo para academia: como criar e distribuir. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Marketing de Conteúdo Para Academia",
                item: "https://neofitflow.com.br/blog/marketing-conteudo-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Marketing de Conteúdo Para Academia: Como Criar e Distribuir",
            description: "Guia completo sobre marketing de conteúdo para academia: como criar e distribuir",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Marketing de Conteúdo Para Academia: Como Criar e Distribuir</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-01">01/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como marketing de conteúdo para academia: como criar e distribuir, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Marketing de Conteúdo Para Academia: Como Criar e Distribuir não é apenas uma tendência - é uma necessidade para academias que querem
