...
export const metadata: Metadata = {
  title: "Automação de Reserva de Turmas no WhatsApp: Passo a Passo | NeoFitFlow",
  description: "Guia completo sobre automação de reserva de turmas no whatsapp: passo a passo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "automacao reserva turmas whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/automacao-reserva-turmas-whatsapp',
  },
  openGraph: {
    title: "Automação de Reserva de Turmas no WhatsApp: Passo a Passo",
    description: "Guia completo sobre automação de reserva de turmas no whatsapp: passo a passo",
    url: 'https://neofitflow.com.br/blog/automacao-reserva-turmas-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Automação de Reserva de Turmas no WhatsApp",
    description: "Guia completo sobre automação de reserva de turmas no whatsapp: passo a passo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Automação de Reserva de Turmas no WhatsApp",
                item: "https://neofitflow.com.br/blog/automacao-reserva-turmas-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Automação de Reserva de Turmas no WhatsApp: Passo a Passo",
            description: "Guia completo sobre automação de reserva de turmas no whatsapp: passo a passo",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Automação de Reserva de Turmas no WhatsApp: Passo a Passo</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-08">08/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como automação de reserva de turmas no whatsapp: passo a passo, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Automação de Reserva de Turmas no WhatsApp: Passo a Passo não é apenas uma tendência - é uma necessidade para academias que querem
