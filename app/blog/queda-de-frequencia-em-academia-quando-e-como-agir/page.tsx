...
export const metadata: Metadata = {
  ...
  description: "Aluno que ia 4x/semana agora vai 2x: queda de 50% = risco alto. Aprenda a detectar quedas graduais, quando alertar e como reverter antes do cancelamento.",
  ...
  alternates: { canonical: '/blog/queda-de-frequencia-em-academia-quando-e-como-agir' },
  openGraph: {
    title: "Queda de Frequência em Academia: Quando e Como Agir",
    description: "Aluno que ia 4x/semana agora vai 2x: queda de 50% = risco alto. Aprenda a detectar quedas graduais, quando alertar e como reverter antes do cancelamento.",
    url: 'https://neofitflow.com.br/blog/queda-de-frequencia-em-academia-quando-e-como-agir',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Queda de Frequência em Academia: Quando e Como Agir", item: "https://neofitflow.com.br/blog/queda-de-frequencia-em-academia-quando-e-como-agir" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Queda de Frequência em Academia: Quando e Como Agir
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-08">7 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Queda de Frequência em Academia: Quando e Como Agir</h1>
