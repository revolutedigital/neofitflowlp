...
export const metadata: Metadata = {
  title: "Pós-Carnaval e Retenção: Período Crítico de Março a Abril | NeoFitFlow",
  description: "Pós-carnaval: projeto verão acabou, motivação cai 60%, frequência desaba. Março-abril = crítico. Como manter aluno engajado no 'meio do ano fitness'.",
  ...
  alternates: { canonical: '/blog/pos-carnaval-e-retencao-periodo-critico-de-marco-a-abril' },
  openGraph: {
    title: "Pós-Carnaval e Retenção: Período Crítico de Março a Abril",
    description: "Pós-carnaval: projeto verão acabou, motivação cai 60%, frequência desaba. Março-abril = crítico. Como manter aluno engajado no 'meio do ano fitness'.",
    url: 'https://neofitflow.com.br/blog/pos-carnaval-e-retencao-periodo-critico-de-marco-a-abril',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Pós-Carnaval e Retenção: Período Crítico de Março a Abril", item: "https://neofitflow.com.br/blog/pos-carnaval-e-retencao-periodo-critico-de-marco-a-abril" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Pós-Carnaval e Retenção: Período Crítico de Março a Abril",
          description: "Pós-carnaval: projeto verão acabou, motivação cai 60%, frequência desaba. Março-abril = crítico. Como manter aluno engajado no 'meio do ano fitness'.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Pós-Carnaval e Retenção: Período Crítico de Março a Abril
              </h1>
...
<h1>Pós-Carnaval e Retenção: Período Crítico de Março a Abril</h1>
