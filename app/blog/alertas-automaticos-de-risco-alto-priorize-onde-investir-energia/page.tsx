...
export const metadata: Metadata = {
  ...
  description: "Não gaste energia igual em todos alunos. IA prioriza: verde = tranquilo, amarelo = observar, laranja = agir, vermelho = urgente. Otimize seu tempo.",
  ...
  alternates: { canonical: '/blog/alertas-automaticos-de-risco-alto-priorize-onde-investir-energia' },
  openGraph: {
    title: "Alertas Automáticos de Risco Alto: Priorize Onde Investir Energia",
    description: "Não gaste energia igual em todos alunos. IA prioriza: verde = tranquilo, amarelo = observar, laranja = agir, vermelho = urgente. Otimize seu tempo.",
    url: 'https://neofitflow.com.br/blog/alertas-automaticos-de-risco-alto-priorize-onde-investir-energia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Alertas Automáticos de Risco Alto: Priorize Onde Investir Energia", item: "https://neofitflow.com.br/blog/alertas-automaticos-de-risco-alto-priorize-onde-investir-energia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Alertas Automáticos de Risco Alto: Priorize Onde Investir Energia
              </h1>
...
<h1>Alertas Automáticos de Risco Alto: Priorize Onde Investir Energia</h1>
