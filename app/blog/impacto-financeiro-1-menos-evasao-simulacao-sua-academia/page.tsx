...
export const metadata: Metadata = {
  title: "Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia | NeoFitFlow",
  description: "Veja como reduzir evasão em apenas 1% pode representar milhares de reais extras por ano na sua academia.",
  keywords: "simulação financeira, impacto 1%, receita adicional, ganho retenção",
  alternates: {
    canonical: '/blog/impacto-financeiro-1-menos-evasao-simulacao-sua-academia',
  },
  openGraph: {
    title: "Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia",
    description: "Veja como reduzir evasão em apenas 1% pode representar milhares de reais extras por ano na sua academia.",
    url: 'https://neofitflow.com.br/blog/impacto-financeiro-1-menos-evasao-simulacao-sua-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia",
                item: "https://neofitflow.com.br/blog/impacto-financeiro-1-menos-evasao-simulacao-sua-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia",
            description: "Veja como reduzir evasão em apenas 1% pode representar milhares de reais extras por ano na sua academia.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar impacto financeiro de 1% a menos de evasão: simulação para sua academia, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Impacto Financeiro de 1% a Menos de Evasão: Simulação Para Sua Academia não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
