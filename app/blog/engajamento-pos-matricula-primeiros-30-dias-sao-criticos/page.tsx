...
export const metadata: Metadata = {
  title: "Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos | NeoFitFlow",
  description: "Primeiros 30 dias definem tudo: 60% dos cancelamentos de alunos novos ocorrem aqui. Onboarding intensivo + acompanhamento IA = retenção 3x maior.",
  ...
  alternates: { canonical: '/blog/engajamento-pos-matricula-primeiros-30-dias-sao-criticos' },
  openGraph: {
    title: "Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos",
    description: "Primeiros 30 dias definem tudo: 60% dos cancelamentos de alunos novos ocorrem aqui. Onboarding intensivo + acompanhamento IA = retenção 3x maior.",
    url: 'https://neofitflow.com.br/blog/engajamento-pos-matricula-primeiros-30-dias-sao-criticos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos", item: "https://neofitflow.com.br/blog/engajamento-pos-matricula-primeiros-30-dias-sao-criticos" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos",
          description: "Primeiros 30 dias definem tudo: 60% dos cancelamentos de alunos novos ocorrem aqui. Onboarding intensivo + acompanhamento IA = retenção 3x maior.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos
              </h1>
...
<h1>Engajamento Pós-Matrícula: Primeiros 30 Dias São Críticos</h1>
