...
export const metadata: Metadata = {
  ...
  description: "Boutique: alto ticket, expectativa premium. IA permite: experiência hiper-personalizada, atenção individual em escala, justificando investimento alto.",
  ...
  alternates: { canonical: '/blog/boutique-fitness-retencao-premium-com-experiencia-personalizada-por-ia' },
  openGraph: {
    title: "Boutique Fitness: Retenção Premium com Experiência Personalizada por IA",
    description: "Boutique: alto ticket, expectativa premium. IA permite: experiência hiper-personalizada, atenção individual em escala, justificando investimento alto.",
    url: 'https://neofitflow.com.br/blog/boutique-fitness-retencao-premium-com-experiencia-personalizada-por-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Boutique Fitness: Retenção Premium com Experiência Personalizada por IA", item: "https://neofitflow.com.br/blog/boutique-fitness-retencao-premium-com-experiencia-personalizada-por-ia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Boutique Fitness: Retenção Premium com Experiência Personalizada por IA
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-07">6 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Boutique Fitness: Retenção Premium com Experiência Personalizada por IA</h1>
