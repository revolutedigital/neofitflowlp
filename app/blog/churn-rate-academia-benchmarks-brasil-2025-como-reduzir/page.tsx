...
export const metadata: Metadata = {
  title: "Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir | NeoFitFlow",
  description: "Compare sua taxa de churn com médias do mercado fitness brasileiro e aprenda estratégias comprovadas para reduzir.",
  keywords: "churn rate, taxa cancelamento, benchmark fitness, média mercado",
  alternates: {
    canonical: '/blog/churn-rate-academia-benchmarks-brasil-2025-como-reduzir',
  },
  openGraph: {
    title: "Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir",
    description: "Compare sua taxa de churn com médias do mercado fitness brasileiro e aprenda estratégias comprovadas para reduzir.",
    url: 'https://neofitflow.com.br/blog/churn-rate-academia-benchmarks-brasil-2025-como-reduzir',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir",
                item: "https://neofitflow.com.br/blog/churn-rate-academia-benchmarks-brasil-2025-como-reduzir",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir",
            description: "Compare sua taxa de churn com médias do mercado fitness brasileiro e aprenda estratégias comprovadas para reduzir.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar churn rate em academia: benchmarks brasil 2025 e como reduzir, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Churn Rate em Academia: Benchmarks Brasil 2025 e Como Reduzir não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
