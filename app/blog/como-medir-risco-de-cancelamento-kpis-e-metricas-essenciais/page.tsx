...
export const metadata: Metadata = {
  ...
  description: "7 KPIs essenciais para medir risco: taxa de frequência, faltas consecutivas, NPS, tempo de permanência, engajamento. Aprenda a trackear e agir.",
  ...
  alternates: { canonical: '/blog/como-medir-risco-de-cancelamento-kpis-e-metricas-essenciais' },
  openGraph: {
    title: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais",
    description: "7 KPIs essenciais para medir risco: taxa de frequência, faltas consecutivas, NPS, tempo de permanência, engajamento. Aprenda a trackear e agir.",
    url: 'https://neofitflow.com.br/blog/como-medir-risco-de-cancelamento-kpis-e-metricas-essenciais',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais", item: "https://neofitflow.com.br/blog/como-medir-risco-de-cancelamento-kpis-e-metricas-essenciais" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais
              </h1>
...
<h1>Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais</h1>
