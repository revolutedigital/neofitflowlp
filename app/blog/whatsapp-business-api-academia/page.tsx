...
export const metadata: Metadata = {
  title: "WhatsApp Business API Para Academia: Como Funciona e Quanto Custa | NeoFitFlow",
  description: "Guia completo sobre whatsapp business api para academia: como funciona e quanto custa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "whatsapp business api academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/whatsapp-business-api-academia',
  },
  openGraph: {
    title: "WhatsApp Business API Para Academia: Como Funciona e Quanto Custa",
    description: "Guia completo sobre whatsapp business api para academia: como funciona e quanto custa",
    url: 'https://neofitflow.com.br/blog/whatsapp-business-api-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "WhatsApp Business API Para Academia",
    description: "Guia completo sobre whatsapp business api para academia: como funciona e quanto custa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "WhatsApp Business API Para Academia",
                item: "https://neofitflow.com.br/blog/whatsapp-business-api-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "WhatsApp Business API Para Academia: Como Funciona e Quanto Custa",
            description: "Guia completo sobre whatsapp business api para academia: como funciona e quanto custa",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">WhatsApp Business API Para Academia: Como Funciona e Quanto Custa</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-22">22/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como whatsapp business api para academia: como funciona e quanto custa, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                WhatsApp Business API Para Academia: Como Funciona e Quanto Custa não é apenas uma tendência - é uma necessidade para academias que querem
