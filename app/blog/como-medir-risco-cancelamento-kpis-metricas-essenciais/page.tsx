...
export const metadata: Metadata = {
  title: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais | NeoFitFlow",
  description: "Descubra quais métricas realmente indicam risco de cancelamento e como criar seu próprio sistema de scoring de risco.",
  keywords: "medir risco, scoring aluno, métricas preditivas, indicadores evasão",
  alternates: {
    canonical: '/blog/como-medir-risco-cancelamento-kpis-metricas-essenciais',
  },
  openGraph: {
    title: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais",
    description: "Descubra quais métricas realmente indicam risco de cancelamento e como criar seu próprio sistema de scoring de risco.",
    url: 'https://neofitflow.com.br/blog/como-medir-risco-cancelamento-kpis-metricas-essenciais',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais",
                item: "https://neofitflow.com.br/blog/como-medir-risco-cancelamento-kpis-metricas-essenciais",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais",
            description: "Descubra quais métricas realmente indicam risco de cancelamento e como criar seu próprio sistema de scoring de risco.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar como medir risco de cancelamento: kpis e métricas essenciais, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Medir Risco de Cancelamento: KPIs e Métricas Essenciais não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
