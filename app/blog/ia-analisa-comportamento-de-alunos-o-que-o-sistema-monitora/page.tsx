...
export const metadata: Metadata = {
  ...
  description: "Descubra as 50+ variáveis que IA analisa: frequência, horários, faltas, mudanças de rotina, engajamento, renovações e como isso prevê cancelamentos.",
  ...
  alternates: { canonical: '/blog/ia-analisa-comportamento-de-alunos-o-que-o-sistema-monitora' },
  openGraph: {
    title: "IA Analisa Comportamento de Alunos: O Que o Sistema Monitora",
    description: "Descubra as 50+ variáveis que IA analisa: frequência, horários, faltas, mudanças de rotina, engajamento, renovações e como isso prevê cancelamentos.",
    url: 'https://neofitflow.com.br/blog/ia-analisa-comportamento-de-alunos-o-que-o-sistema-monitora',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "IA Analisa Comportamento de Alunos: O Que o Sistema Monitora", item: "https://neofitflow.com.br/blog/ia-analisa-comportamento-de-alunos-o-que-o-sistema-monitora" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-07">6 de março de 2025</time>
                <span>•</span>
...
<h1>IA Analisa Comportamento de Alunos: O Que o Sistema Monitora</h1>
