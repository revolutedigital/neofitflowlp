...
export const metadata: Metadata = {
  title: "Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10% | NeoFitFlow",
  description: "Taxa de evasão primeiros 30 dias: média 35-40%. Melhores academias: 8-12%. Diferença está no onboarding + acompanhamento IA. Roadmap completo.",
  ...
  alternates: { canonical: '/blog/taxa-de-evasao-primeiros-30-dias-como-reduzir-de-40-para-10' },
  openGraph: {
    title: "Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10%",
    description: "Taxa de evasão primeiros 30 dias: média 35-40%. Melhores academias: 8-12%. Diferença está no onboarding + acompanhamento IA. Roadmap completo.",
    url: 'https://neofitflow.com.br/blog/taxa-de-evasao-primeiros-30-dias-como-reduzir-de-40-para-10',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10%", item: "https://neofitflow.com.br/blog/taxa-de-evasao-primeiros-30-dias-como-reduzir-de-40-para-10" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10%",
          description: "Taxa de evasão primeiros 30 dias: média 35-40%. Melhores academias: 8-12%. Diferença está no onboarding + acompanhamento IA. Roadmap completo.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10%
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-12">11 de março de 2025</time>
                <span>•</span>
...
<h1>Taxa de Evasão Primeiros 30 Dias: Como Reduzir de 40% para 10%</h1>
