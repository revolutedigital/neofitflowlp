...
export const metadata: Metadata = {
  ...
  description: "MMA/Jiu-Jitsu: alto compromisso inicial, mas lesões e intensidade causam afastamentos. Como IA diferencia lesão temporária de desistência iminente.",
  keywords: "retenção mma jiu-jitsu, ia artes marciais, prevenir evasão mma, sistema retenção luta, detectar desistência lutador",
  alternates: { canonical: '/blog/retencao-em-academia-de-mma-e-jiu-jitsu-lesoes-e-compromisso' },
  openGraph: {
    title: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso",
    description: "MMA/Jiu-Jitsu: alto compromisso inicial, mas lesões e intensidade causam afastamentos. Como IA diferencia lesão temporária de desistência iminente.",
    url: 'https://neofitflow.com.br/blog/retencao-em-academia-de-mma-e-jiu-jitsu-lesoes-e-compromisso',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso", item: "https://neofitflow.com.br/blog/retencao-em-academia-de-mma-e-jiu-jitsu-lesoes-e-compromisso" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-06">5 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso</h1>
