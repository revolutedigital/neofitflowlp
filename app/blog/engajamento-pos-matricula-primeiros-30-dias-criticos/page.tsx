...
export const metadata: Metadata = {
  title: "Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos | NeoFitFlow",
  description: "Guia completo sobre a janela mais importante da jornada do aluno - como garantir frequência alta nos primeiros 30 dias.",
  keywords: "primeiros 30 dias, onboarding fitness, engajamento inicial, período crítico",
  alternates: {
    canonical: '/blog/engajamento-pos-matricula-primeiros-30-dias-criticos',
  },
  openGraph: {
    title: "Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos",
    description: "Guia completo sobre a janela mais importante da jornada do aluno - como garantir frequência alta nos primeiros 30 dias.",
    url: 'https://neofitflow.com.br/blog/engajamento-pos-matricula-primeiros-30-dias-criticos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos",
                item: "https://neofitflow.com.br/blog/engajamento-pos-matricula-primeiros-30-dias-criticos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos",
            description: "Guia completo sobre a janela mais importante da jornada do aluno - como garantir frequência alta nos primeiros 30 dias.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar engajamento pós-matrícula: os primeiros 30 dias são críticos, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Engajamento Pós-Matrícula: Os Primeiros 30 Dias São Críticos não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
