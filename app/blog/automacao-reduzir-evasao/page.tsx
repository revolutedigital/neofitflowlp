...
export const metadata: Metadata = {
  title: "Como Usar Automação Para Reduzir Evasão em 30% | NeoFitFlow",
  description: "Guia completo sobre como usar automação para reduzir evasão em 30%. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "automacao reduzir evasao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/automacao-reduzir-evasao',
  },
  openGraph: {
    title: "Como Usar Automação Para Reduzir Evasão em 30%",
    description: "Guia completo sobre como usar automação para reduzir evasão em 30%",
    url: 'https://neofitflow.com.br/blog/automacao-reduzir-evasao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Como Usar Automação Para Reduzir Evasão",
    description: "Guia completo sobre como usar automação para reduzir evasão em 30%. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Usar Automação Para Reduzir Evasão",
                item: "https://neofitflow.com.br/blog/automacao-reduzir-evasao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Usar Automação Para Reduzir Evasão em 30%",
            description: "Guia completo sobre como usar automação para reduzir evasão em 30%",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Usar Automação Para Reduzir Evasão em 30%</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-06">06/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como usar automação para reduzir evasão em 30%, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Usar Automação Para Reduzir Evasão em 30% não é apenas uma tendência - é uma necessidade para academias que querem
