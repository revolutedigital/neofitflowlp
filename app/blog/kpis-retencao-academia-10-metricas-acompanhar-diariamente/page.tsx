...
export const metadata: Metadata = {
  title: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente | NeoFitFlow",
  description: "Lista completa dos indicadores mais importantes para monitorar saúde da retenção e agir preventivamente.",
  keywords: "kpis retenção, métricas academia, indicadores críticos, monitoramento diário",
  alternates: {
    canonical: '/blog/kpis-retencao-academia-10-metricas-acompanhar-diariamente',
  },
  openGraph: {
    title: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente",
    description: "Lista completa dos indicadores mais importantes para monitorar saúde da retenção e agir preventivamente.",
    url: 'https://neofitflow.com.br/blog/kpis-retencao-academia-10-metricas-acompanhar-diariamente',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente",
                item: "https://neofitflow.com.br/blog/kpis-retencao-academia-10-metricas-acompanhar-diariamente",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente",
            description: "Lista completa dos indicadores mais importantes para monitorar saúde da retenção e agir preventivamente.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar kpis de retenção em academia: 10 métricas para acompanhar diariamente, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
