...
export const metadata: Metadata = {
  title: "Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia | NeoFitFlow",
  description: "Simulação real: academia com 500 alunos, R$ 150 mensalidade. Reduzir evasão de 28% para 27% = R$ 90k a mais no ano. Cada 1% vale MUITO.",
  ...
  alternates: { canonical: '/blog/impacto-financeiro-de-1-menos-evasao-simulacao-para-sua-academia' },
  openGraph: {
    title: "Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia",
    description: "Simulação real: academia com 500 alunos, R$ 150 mensalidade. Reduzir evasão de 28% para 27% = R$ 90k a mais no ano. Cada 1% vale MUITO.",
    url: 'https://neofitflow.com.br/blog/impacto-financeiro-de-1-menos-evasao-simulacao-para-sua-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia", item: "https://neofitflow.com.br/blog/impacto-financeiro-de-1-menos-evasao-simulacao-para-sua-academia" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia",
          description: "Simulação real: academia com 500 alunos, R$ 150 mensalidade. Reduzir evasão de 28% para 27% = R$ 90k a mais no ano. Cada 1% vale MUITO.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-04">3 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Impacto Financeiro de 1% Menos Evasão: Simulação para Sua Academia</h1>
