...
export const metadata: Metadata = {
  title: "Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA | NeoFitFlow",
  description: "Estratégia específica para CrossFit aproveitando força da comunidade e intensidade dos treinos com apoio de IA.",
  keywords: "crossfit retenção, box crossfit, comunidade crossfit, ia funcional",
  alternates: {
    canonical: '/blog/prevenir-evasao-box-crossfit-comunidade-forte-ia',
  },
  openGraph: {
    title: "Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA",
    description: "Estratégia específica para CrossFit aproveitando força da comunidade e intensidade dos treinos com apoio de IA.",
    url: 'https://neofitflow.com.br/blog/prevenir-evasao-box-crossfit-comunidade-forte-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA",
                item: "https://neofitflow.com.br/blog/prevenir-evasao-box-crossfit-comunidade-forte-ia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA",
            description: "Estratégia específica para CrossFit aproveitando força da comunidade e intensidade dos treinos com apoio de IA.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar prevenir evasão em box de crossfit: comunidade forte com ia, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Prevenir Evasão em Box de CrossFit: Comunidade Forte Com IA não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
