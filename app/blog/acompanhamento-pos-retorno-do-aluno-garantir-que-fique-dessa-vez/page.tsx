...
export const metadata: Metadata = {
  ...
  description: "Aluno voltou? Fase crítica começa agora. 40% re-evadem em 30 dias se não houver acompanhamento. Protocolo de follow-up pós-retorno que garante permanência.",
  ...
  alternates: { canonical: '/blog/acompanhamento-pos-retorno-do-aluno-garantir-que-fique-dessa-vez' },
  openGraph: {
    title: "Acompanhamento Pós-Retorno do Aluno: Garantir que Fique Dessa Vez",
    description: "Aluno voltou? Fase crítica começa agora. 40% re-evadem em 30 dias se não houver acompanhamento. Protocolo de follow-up pós-retorno que garante permanência.",
    url: 'https://neofitflow.com.br/blog/acompanhamento-pos-retorno-do-aluno-garantir-que-fique-dessa-vez',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Acompanhamento Pós-Retorno do Aluno: Garantir que Fique Dessa Vez", item: "https://neofitflow.com.br/blog/acompanhamento-pos-retorno-do-aluno-garantir-que-fique-dessa-vez" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Acompanhamento Pós-Retorno do Aluno: Garantir que Fique Dessa Vez
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-01">28 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Acompanhamento Pós-Retorno do Aluno: Garantir que Fique Dessa Vez</h1>
