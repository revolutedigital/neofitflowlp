...
export const metadata: Metadata = {
  title: "Studio de Pilates: Como Automatizar Gestão e Agendamentos | NeoFitFlow",
  description: "Guia completo sobre studio de pilates: como automatizar gestão e agendamentos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "studio pilates automacao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/studio-pilates-automacao',
  },
  openGraph: {
    title: "Studio de Pilates: Como Automatizar Gestão e Agendamentos",
    description: "Guia completo sobre studio de pilates: como automatizar gestão e agendamentos",
    url: 'https://neofitflow.com.br/blog/studio-pilates-automacao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Studio de Pilates: Automação",
    description: "Guia completo sobre studio de pilates: como automatizar gestão e agendamentos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Studio de Pilates: Automação",
                item: "https://neofitflow.com.br/blog/studio-pilates-automacao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Studio de Pilates: Como Automatizar Gestão e Agendamentos",
            description: "Guia completo sobre studio de pilates: como automatizar gestão e agendamentos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Studio de Pilates: Como Automatizar Gestão e Agendamentos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-20">20/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como studio de pilates: como automatizar gestão e agendamentos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Studio de Pilates: Como Automatizar Gestão e Agendamentos não é apenas uma tendência - é uma necessidade para academias que querem
