...
export const metadata: Metadata = {
  title: "Follow-up de Leads Para Academia: Timing e Mensagens Que Funcionam | NeoFitFlow",
  description: "Guia completo sobre follow-up de leads para academia: timing e mensagens que funcionam. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "follow up leads academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/follow-up-leads-academia',
  },
  openGraph: {
    title: "Follow-up de Leads Para Academia: Timing e Mensagens Que Funcionam",
    description: "Guia completo sobre follow-up de leads para academia: timing e mensagens que funcionam",
    url: 'https://neofitflow.com.br/blog/follow-up-leads-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Follow-up de Leads em Academia",
    description: "Guia completo sobre follow-up de leads para academia: timing e mensagens que funcionam. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Follow-up de Leads em Academia",
                item: "https://neofitflow.com.br/blog/follow-up-leads-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Follow-up de Leads Para Academia: Timing e Mensagens Que Funcionam",
            description: "Guia completo sobre follow-up de leads para academia: timing e mensagens que funcionam",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Follow-up de Leads Para Academia: Timing e Mensagens Que Funcionam</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-01">01/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como follow-up de leads para academia: timing e mensagens que funcionam, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Follow-up de Leads Para Academia: Timing e Mensagens Que Funcionam não é apenas uma tendência - é uma necessidade para academias que querem
