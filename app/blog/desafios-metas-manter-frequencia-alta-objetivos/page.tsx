...
export const metadata: Metadata = {
  title: "Desafios e Metas: Como Manter Frequência Alta Com Objetivos | NeoFitFlow",
  description: "Use mecânica de gamificação com desafios de frequência (treinar 3x/semana por 30 dias) para engajar alunos.",
  keywords: "desafios fitness, metas frequência, gamificação treino, objetivos claros",
  alternates: {
    canonical: '/blog/desafios-metas-manter-frequencia-alta-objetivos',
  },
  openGraph: {
    title: "Desafios e Metas: Como Manter Frequência Alta Com Objetivos",
    description: "Use mecânica de gamificação com desafios de frequência (treinar 3x/semana por 30 dias) para engajar alunos.",
    url: 'https://neofitflow.com.br/blog/desafios-metas-manter-frequencia-alta-objetivos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Desafios e Metas: Como Manter Frequência Alta Com Objetivos",
                item: "https://neofitflow.com.br/blog/desafios-metas-manter-frequencia-alta-objetivos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Desafios e Metas: Como Manter Frequência Alta Com Objetivos",
            description: "Use mecânica de gamificação com desafios de frequência (treinar 3x/semana por 30 dias) para engajar alunos.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Desafios e Metas: Como Manter Frequência Alta Com Objetivos</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar desafios e metas: como manter frequência alta com objetivos, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Desafios e Metas: Como Manter Frequência Alta Com Objetivos não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
