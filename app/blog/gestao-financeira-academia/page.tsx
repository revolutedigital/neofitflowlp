...
export const metadata: Metadata = {
  title: "Gestão Financeira de Academia: Como Organizar e Lucrar Mais | NeoFitFlow",
  description: "Guia completo sobre gestão financeira de academia: como organizar e lucrar mais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "gestao financeira academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/gestao-financeira-academia',
  },
  openGraph: {
    title: "Gestão Financeira de Academia: Como Organizar e Lucrar Mais",
    description: "Guia completo sobre gestão financeira de academia: como organizar e lucrar mais",
    url: 'https://neofitflow.com.br/blog/gestao-financeira-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Gestão Financeira de Academia",
    description: "Guia completo sobre gestão financeira de academia: como organizar e lucrar mais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Gestão Financeira de Academia",
                item: "https://neofitflow.com.br/blog/gestao-financeira-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Gestão Financeira de Academia: Como Organizar e Lucrar Mais",
            description: "Guia completo sobre gestão financeira de academia: como organizar e lucrar mais",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Gestão Financeira de Academia: Como Organizar e Lucrar Mais</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-16">16/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como gestão financeira de academia: como organizar e lucrar mais, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Gestão Financeira de Academia: Como Organizar e Lucrar Mais não é apenas uma tendência - é uma necessidade para academias que querem
