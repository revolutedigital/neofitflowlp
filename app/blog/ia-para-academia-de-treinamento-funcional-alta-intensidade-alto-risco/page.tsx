...
export const metadata: Metadata = {
  ...
  description: "Funcional: alta intensidade, lesões frequentes, burnout rápido. IA detecta sinais de overtraining, sugere descanso, previne abandono por exaustão.",
  ...
  alternates: { canonical: '/blog/ia-para-academia-de-treinamento-funcional-alta-intensidade-alto-risco' },
  openGraph: {
    title: "IA para Academia de Treinamento Funcional: Alta Intensidade, Alto Risco",
    description: "Funcional: alta intensidade, lesões frequentes, burnout rápido. IA detecta sinais de overtraining, sugere descanso, previne abandono por exaustão.",
    url: 'https://neofitflow.com.br/blog/ia-para-academia-de-treinamento-funcional-alta-intensidade-alto-risco',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "IA para Academia de Treinamento Funcional: Alta Intensidade, Alto Risco", item: "https://neofitflow.com.br/blog/ia-para-academia-de-treinamento-funcional-alta-intensidade-alto-risco" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-22">21 de janeiro de 2025</time>
                <span>•</span>
...
<h1>IA para Academia de Treinamento Funcional: Alta Intensidade, Alto Risco</h1>
