...
export const metadata: Metadata = {
  title: "Retenção de Alunos em Academia Pequena: Estratégias de Baixo Custo | NeoFitFlow",
  description: "Guia completo sobre retenção de alunos em academia pequena: estratégias de baixo custo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "retencao alunos academia pequena, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/retencao-alunos-academia-pequena',
  },
  openGraph: {
    title: "Retenção de Alunos em Academia Pequena: Estratégias de Baixo Custo",
    description: "Guia completo sobre retenção de alunos em academia pequena: estratégias de baixo custo",
    url: 'https://neofitflow.com.br/blog/retencao-alunos-academia-pequena',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Retenção de Alunos em Academia Pequena",
    description: "Guia completo sobre retenção de alunos em academia pequena: estratégias de baixo custo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Retenção de Alunos em Academia Pequena",
                item: "https://neofitflow.com.br/blog/retencao-alunos-academia-pequena",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Retenção de Alunos em Academia Pequena: Estratégias de Baixo Custo",
            description: "Guia completo sobre retenção de alunos em academia pequena: estratégias de baixo custo",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Retenção de Alunos em Academia Pequena: Estratégias de Baixo Custo</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-07">07/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como retenção de alunos em academia pequena: estratégias de baixo custo, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Retenção de Alunos em Academia Pequena: Estratégias de Baixo Custo não é apenas uma tendência - é uma necessidade para academias que querem
