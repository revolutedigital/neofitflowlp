...
export const metadata: Metadata = {
  title: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano | NeoFitFlow",
  description: "Análise mês a mês de quando evasão aumenta (março, julho, dezembro) e estratégias preventivas para cada período crítico.",
  keywords: "sazonalidade fitness, padrão anual, meses críticos, evasão sazonal",
  alternates: {
    canonical: '/blog/sazonalidade-evasao-academia-padroes-ao-longo-ano',
  },
  openGraph: {
    title: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano",
    description: "Análise mês a mês de quando evasão aumenta (março, julho, dezembro) e estratégias preventivas para cada período crítico.",
    url: 'https://neofitflow.com.br/blog/sazonalidade-evasao-academia-padroes-ao-longo-ano',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano",
                item: "https://neofitflow.com.br/blog/sazonalidade-evasao-academia-padroes-ao-longo-ano",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano",
            description: "Análise mês a mês de quando evasão aumenta (março, julho, dezembro) e estratégias preventivas para cada período crítico.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar sazonalidade e evasão em academia: padrões ao longo do ano, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Sazonalidade e Evasão em Academia: Padrões ao Longo do Ano não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
