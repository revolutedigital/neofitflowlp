...
export const metadata: Metadata = {
  title: "Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo | NeoFitFlow",
  description: "IA não é genérica: ela aprende padrões específicos da SUA academia, adaptando-se ao seu público, modalidades e sazonalidades para previsões cada vez mais precisas.",
  ...
  alternates: { canonical: '/blog/como-ia-aprende-padroes-da-sua-academia-machine-learning-adaptativo' },
  openGraph: {
    title: "Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo",
    description: "IA não é genérica: ela aprende padrões específicos da SUA academia, adaptando-se ao seu público, modalidades e sazonalidades para previsões cada vez mais precisas.",
    url: 'https://neofitflow.com.br/blog/como-ia-aprende-padroes-da-sua-academia-machine-learning-adaptativo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo", item: "https://neofitflow.com.br/blog/como-ia-aprende-padroes-da-sua-academia-machine-learning-adaptativo" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo",
          description: "IA não é genérica: ela aprende padrões específicos da SUA academia, adaptando-se ao seu público, modalidades e sazonalidades para previsões cada vez mais precisas.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-18">17 de março de 2025</time>
                <span>•</span>
...
<h1>Como IA Aprende Padrões da Sua Academia: Machine Learning Adaptativo</h1>
