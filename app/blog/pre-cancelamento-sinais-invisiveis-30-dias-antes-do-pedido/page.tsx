...
export const metadata: Metadata = {
  ...
  description: "30 dias antes do pedido, sinais invisíveis aparecem: micro-quedas frequência, check-in tarde, sair mais cedo, evitar horário cheio. Como IA detecta.",
  ...
  alternates: { canonical: '/blog/pre-cancelamento-sinais-invisiveis-30-dias-antes-do-pedido' },
  openGraph: {
    title: "Pré-Cancelamento: Sinais Invisíveis 30 Dias Antes do Pedido",
    description: "30 dias antes do pedido, sinais invisíveis aparecem: micro-quedas frequência, check-in tarde, sair mais cedo, evitar horário cheio. Como IA detecta.",
    url: 'https://neofitflow.com.br/blog/pre-cancelamento-sinais-invisiveis-30-dias-antes-do-pedido',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Pré-Cancelamento: Sinais Invisíveis 30 Dias Antes do Pedido", item: "https://neofitflow.com.br/blog/pre-cancelamento-sinais-invisiveis-30-dias-antes-do-pedido" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Pré-Cancelamento: Sinais Invisíveis 30 Dias Antes do Pedido
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-25">24 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Pré-Cancelamento: Sinais Invisíveis 30 Dias Antes do Pedido</h1>
