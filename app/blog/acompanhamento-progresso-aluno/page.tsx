...
export const metadata: Metadata = {
  title: "Acompanhamento de Progresso do Aluno: Ferramentas e Estratégias | NeoFitFlow",
  description: "Guia completo sobre acompanhamento de progresso do aluno: ferramentas e estratégias. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "acompanhamento progresso aluno, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/acompanhamento-progresso-aluno',
  },
  openGraph: {
    title: "Acompanhamento de Progresso do Aluno: Ferramentas e Estratégias",
    description: "Guia completo sobre acompanhamento de progresso do aluno: ferramentas e estratégias",
    url: 'https://neofitflow.com.br/blog/acompanhamento-progresso-aluno',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Acompanhamento de Progresso do Aluno",
                item: "https://neofitflow.com.br/blog/acompanhamento-progresso-aluno",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Acompanhamento de Progresso do Aluno: Ferramentas e Estratégias",
            description: "Guia completo sobre acompanhamento de progresso do aluno: ferramentas e estratégias",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Acompanhamento de Progresso do Aluno: Ferramentas e Estratégias</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-29">29/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como acompanhamento de progresso do aluno: ferramentas e estratégias, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Acompanhamento de Progresso do Aluno: Ferramentas e Estratégias não é apenas uma tendência - é uma necessidade para academias que querem
