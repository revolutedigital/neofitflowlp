...
export const metadata: Metadata = {
  title: "Bike Indoor/Spinning: Gestão de Turmas e Retenção | NeoFitFlow",
  description: "Guia completo sobre bike indoor/spinning: gestão de turmas e retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "bike indoor gestao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/bike-indoor-gestao',
  },
  openGraph: {
    title: "Bike Indoor/Spinning: Gestão de Turmas e Retenção",
    description: "Guia completo sobre bike indoor/spinning: gestão de turmas e retenção",
    url: 'https://neofitflow.com.br/blog/bike-indoor-gestao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Bike Indoor: Gestão",
    description: "Guia completo sobre bike indoor/spinning: gestão de turmas e retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Bike Indoor: Gestão",
                item: "https://neofitflow.com.br/blog/bike-indoor-gestao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Bike Indoor/Spinning: Gestão de Turmas e Retenção",
            description: "Guia completo sobre bike indoor/spinning: gestão de turmas e retenção",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Bike Indoor/Spinning: Gestão de Turmas e Retenção</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-08">08/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como bike indoor/spinning: gestão de turmas e retenção, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Bike Indoor/Spinning: Gestão de Turmas e Retenção não é apenas uma tendência - é uma necessidade para academias que querem
