...
export const metadata: Metadata = {
  title: "Google Meu Negócio Para Academia: Otimização Completa | NeoFitFlow",
  description: "Guia completo sobre google meu negócio para academia: otimização completa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "google meu negocio academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/google-meu-negocio-academia',
  },
  openGraph: {
    title: "Google Meu Negócio Para Academia: Otimização Completa",
    description: "Guia completo sobre google meu negócio para academia: otimização completa",
    url: 'https://neofitflow.com.br/blog/google-meu-negocio-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Google Meu Negócio Para Academia",
    description: "Guia completo sobre google meu negócio para academia: otimização completa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Google Meu Negócio Para Academia",
                item: "https://neofitflow.com.br/blog/google-meu-negocio-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Google Meu Negócio Para Academia: Otimização Completa",
            description: "Guia completo sobre google meu negócio para academia: otimização completa",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Google Meu Negócio Para Academia: Otimização Completa</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-03">03/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como google meu negócio para academia: otimização completa, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Google Meu Negócio Para Academia: Otimização Completa não é apenas uma tendência - é uma necessidade para academias que querem
