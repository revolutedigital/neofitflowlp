...
export const metadata: Metadata = {
  title: "Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo | NeoFitFlow",
  description: "Descubra como algoritmos de machine learning identificam padrões invisíveis de evasão em academias, analisando 50+ variáveis simultaneamente para prever cancelamentos.",
  ...
  alternates: { canonical: '/blog/machine-learning-detecta-padroes-de-evasao-que-voce-nao-ve-guia-completo' },
  openGraph: {
    title: "Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo",
    description: "Descubra como algoritmos de machine learning identificam padrões invisíveis de evasão em academias, analisando 50+ variáveis simultaneamente para prever cancelamentos.",
    url: 'https://neofitflow.com.br/blog/machine-learning-detecta-padroes-de-evasao-que-voce-nao-ve-guia-completo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo", item: "https://neofitflow.com.br/blog/machine-learning-detecta-padroes-de-evasao-que-voce-nao-ve-guia-completo" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo",
          description: "Descubra como algoritmos de machine learning identificam padrões invisíveis de evasão em academias, analisando 50+ variáveis simultaneamente para prever cancelamentos.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-25">24 de março de 2025</time>
                <span>•</span>
...
<h1>Machine Learning Detecta Padrões de Evasão que Você Não Vê: Guia Completo</h1>
