...
export const metadata: Metadata = {
  ...
  description: "Híbrido: aluno faz musculação E funcional. IA monitora frequência em AMBAS, detecta se está abandonando uma, sugere rebalanceamento antes de evadir total.",
  ...
  alternates: { canonical: '/blog/academia-hibrida-musculacao-funcional-como-ia-gerencia-modalidades-multiplas' },
  openGraph: {
    title: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas",
    description: "Híbrido: aluno faz musculação E funcional. IA monitora frequência em AMBAS, detecta se está abandonando uma, sugere rebalanceamento antes de evadir total.",
    url: 'https://neofitflow.com.br/blog/academia-hibrida-musculacao-funcional-como-ia-gerencia-modalidades-multiplas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas", item: "https://neofitflow.com.br/blog/academia-hibrida-musculacao-funcional-como-ia-gerencia-modalidades-multiplas" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-09">8 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas</h1>
