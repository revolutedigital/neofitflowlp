...
export const metadata: Metadata = {
  ...
  description: "Guia completo: aprenda a usar tecnologia e IA para reduzir evasão em academias. Estratégias, ferramentas e cases reais que cortaram churn em 30-40%.",
  ...
  alternates: { canonical: '/blog/reduzir-evasao-em-academia-com-tecnologia-guia-definitivo-2025' },
  openGraph: {
    title: "Reduzir Evasão em Academia com Tecnologia: Guia Definitivo 2025",
    description: "Guia completo: aprenda a usar tecnologia e IA para reduzir evasão em academias. Estratégias, ferramentas e cases reais que cortaram churn em 30-40%.",
    url: 'https://neofitflow.com.br/blog/reduzir-evasao-em-academia-com-tecnologia-guia-definitivo-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Reduzir Evasão em Academia com Tecnologia: Guia Definitivo 2025", item: "https://neofitflow.com.br/blog/reduzir-evasao-em-academia-com-tecnologia-guia-definitivo-2025" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Reduzir Evasão em Academia com Tecnologia: Guia Definitivo 2025
              </h1>
...
<h1>Reduzir Evasão em Academia com Tecnologia: Guia Definitivo 2025</h1>
