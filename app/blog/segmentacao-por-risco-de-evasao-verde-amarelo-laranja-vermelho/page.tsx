...
export const metadata: Metadata = {
  ...
  description: "Sistema semáforo de risco: verde (0-30) = ok, amarelo (31-60) = observar, laranja (61-80) = agir, vermelho (81-100) = urgente. Como segmentar e priorizar.",
  ...
  alternates: { canonical: '/blog/segmentacao-por-risco-de-evasao-verde-amarelo-laranja-vermelho' },
  openGraph: {
    title: "Segmentação por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho",
    description: "Sistema semáforo de risco: verde (0-30) = ok, amarelo (31-60) = observar, laranja (61-80) = agir, vermelho (81-100) = urgente. Como segmentar e priorizar.",
    url: 'https://neofitflow.com.br/blog/segmentacao-por-risco-de-evasao-verde-amarelo-laranja-vermelho',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Segmentação por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho", item: "https://neofitflow.com.br/blog/segmentacao-por-risco-de-evasao-verde-amarelo-laranja-vermelho" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Segmentação por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-27">26 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Segmentação por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho</h1>
