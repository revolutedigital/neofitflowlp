...
export const metadata: Metadata = {
  ...
  description: "Roadmap completo: reduza churn em 30-40% em 6 meses. Mês 1: diagnóstico. Mês 2: implementação IA. Mês 3-6: otimização. Plano detalhado.",
  ...
  alternates: { canonical: '/blog/reducao-de-churn-em-6-meses-roadmap-passo-a-passo' },
  openGraph: {
    title: "Redução de Churn em 6 Meses: Roadmap Passo a Passo",
    description: "Roadmap completo: reduza churn em 30-40% em 6 meses. Mês 1: diagnóstico. Mês 2: implementação IA. Mês 3-6: otimização. Plano detalhado.",
    url: 'https://neofitflow.com.br/blog/reducao-de-churn-em-6-meses-roadmap-passo-a-passo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Redução de Churn em 6 Meses: Roadmap Passo a Passo", item: "https://neofitflow.com.br/blog/reducao-de-churn-em-6-meses-roadmap-passo-a-passo" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Redução de Churn em 6 Meses: Roadmap Passo a Passo
              </h1>
...
<h1>Redução de Churn em 6 Meses: Roadmap Passo a Passo</h1>
