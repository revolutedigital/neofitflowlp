...
export const metadata: Metadata = {
  title: "Landing Page Para Academia Que Converte: Elementos Essenciais | NeoFitFlow",
  description: "Guia completo sobre landing page para academia que converte: elementos essenciais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "landing page academia converter, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/landing-page-academia-converter',
  },
  openGraph: {
    title: "Landing Page Para Academia Que Converte: Elementos Essenciais",
    description: "Guia completo sobre landing page para academia que converte: elementos essenciais",
    url: 'https://neofitflow.com.br/blog/landing-page-academia-converter',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Landing Page Para Academia Que Converte",
    description: "Guia completo sobre landing page para academia que converte: elementos essenciais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Landing Page Para Academia Que Converte",
                item: "https://neofitflow.com.br/blog/landing-page-academia-converter",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Landing Page Para Academia Que Converte: Elementos Essenciais",
            description: "Guia completo sobre landing page para academia que converte: elementos essenciais",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Landing Page Para Academia Que Converte: Elementos Essenciais</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-25">25/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como landing page para academia que converte: elementos essenciais, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Landing Page Para Academia Que Converte: Elementos Essenciais não é apenas uma tendência - é uma necessidade para academias que querem
