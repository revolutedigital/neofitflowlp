...
export const metadata: Metadata = {
  title: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas | NeoFitFlow",
  description: "Estratégia para academias que oferecem múltiplas modalidades: como IA rastreia engajamento por tipo de treino.",
  keywords: "academia híbrida, múltiplas modalidades, mix treinos, ia multimodal",
  alternates: {
    canonical: '/blog/academia-hibrida-musculacao-funcional-ia-gerencia-modalidades-multiplas',
  },
  openGraph: {
    title: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas",
    description: "Estratégia para academias que oferecem múltiplas modalidades: como IA rastreia engajamento por tipo de treino.",
    url: 'https://neofitflow.com.br/blog/academia-hibrida-musculacao-funcional-ia-gerencia-modalidades-multiplas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas",
                item: "https://neofitflow.com.br/blog/academia-hibrida-musculacao-funcional-ia-gerencia-modalidades-multiplas",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas",
            description: "Estratégia para academias que oferecem múltiplas modalidades: como IA rastreia engajamento por tipo de treino.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-600 mb-4">Casos Por Modalidade</div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                Cada modalidade fitness tem características únicas de retenção. Entenda as especificidades e estratégias adaptadas para seu tipo de academia. Este guia completo vai te mostrar exatamente
                como dominar academia híbrida (musculação + funcional): como ia gerencia modalidades múltiplas, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Academia Híbrida (Musculação + Funcional): Como IA Gerencia Modalidades Múltiplas não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
