...
export const metadata: Metadata = {
  title: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras | NeoFitFlow",
  description: "Estude casos reais de academias que reduziram evasão significativamente usando sistemas de IA e retenção automatizada.",
  keywords: "cases sucesso, resultados ia, redução evasão, provas reais",
  alternates: {
    canonical: '/blog/ia-reduz-evasao-ate-40-cases-reais-academias-brasileiras',
  },
  openGraph: {
    title: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras",
    description: "Estude casos reais de academias que reduziram evasão significativamente usando sistemas de IA e retenção automatizada.",
    url: 'https://neofitflow.com.br/blog/ia-reduz-evasao-ate-40-cases-reais-academias-brasileiras',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras",
                item: "https://neofitflow.com.br/blog/ia-reduz-evasao-ate-40-cases-reais-academias-brasileiras",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras",
            description: "Estude casos reais de academias que reduziram evasão significativamente usando sistemas de IA e retenção automatizada.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar ia reduz evasão em até 40%: cases reais de academias brasileiras, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                IA Reduz Evasão em Até 40%: Cases Reais de Academias Brasileiras não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
