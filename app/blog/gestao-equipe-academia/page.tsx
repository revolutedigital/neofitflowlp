...
export const metadata: Metadata = {
  title: "Gestão de Equipe em Academia: Como Treinar e Motivar Professores | NeoFitFlow",
  description: "Guia completo sobre gestão de equipe em academia: como treinar e motivar professores. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "gestao equipe academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/gestao-equipe-academia',
  },
  openGraph: {
    title: "Gestão de Equipe em Academia: Como Treinar e Motivar Professores",
    description: "Guia completo sobre gestão de equipe em academia: como treinar e motivar professores",
    url: 'https://neofitflow.com.br/blog/gestao-equipe-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Gestão de Equipe em Academia",
    description: "Guia completo sobre gestão de equipe em academia: como treinar e motivar professores. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Gestão de Equipe em Academia",
                item: "https://neofitflow.com.br/blog/gestao-equipe-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Gestão de Equipe em Academia: Como Treinar e Motivar Professores",
            description: "Guia completo sobre gestão de equipe em academia: como treinar e motivar professores",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Gestão de Equipe em Academia: Como Treinar e Motivar Professores</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-11">11/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como gestão de equipe em academia: como treinar e motivar professores, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Gestão de Equipe em Academia: Como Treinar e Motivar Professores não é apenas uma tendência - é uma necessidade para academias que querem
