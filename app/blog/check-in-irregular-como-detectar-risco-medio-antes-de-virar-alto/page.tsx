...
export const metadata: Metadata = {
  ...
  description: "Check-in irregular (padrão inconsistente semana a semana) = risco médio (50%). Detecte antes de virar risco alto. Aprenda a calcular 'score de consistência'.",
  ...
  alternates: { canonical: '/blog/check-in-irregular-como-detectar-risco-medio-antes-de-virar-alto' },
  openGraph: {
    title: "Check-in Irregular: Como Detectar Risco Médio Antes de Virar Alto",
    description: "Check-in irregular (padrão inconsistente semana a semana) = risco médio (50%). Detecte antes de virar risco alto. Aprenda a calcular 'score de consistência'.",
    url: 'https://neofitflow.com.br/blog/check-in-irregular-como-detectar-risco-medio-antes-de-virar-alto',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Check-in Irregular: Como Detectar Risco Médio Antes de Virar Alto", item: "https://neofitflow.com.br/blog/check-in-irregular-como-detectar-risco-medio-antes-de-virar-alto" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Check-in Irregular: Como Detectar Risco Médio Antes de Virar Alto
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-14">13 de março de 2025</time>
                <span>•</span>
...
<h1>Check-in Irregular: Como Detectar Risco Médio Antes de Virar Alto</h1>
