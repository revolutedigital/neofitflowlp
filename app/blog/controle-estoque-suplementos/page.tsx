...
export const metadata: Metadata = {
  title: "Controle de Estoque de Suplementos: Sistema e Melhores Práticas | NeoFitFlow",
  description: "Guia completo sobre controle de estoque de suplementos: sistema e melhores práticas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "controle estoque suplementos, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/controle-estoque-suplementos',
  },
  openGraph: {
    title: "Controle de Estoque de Suplementos: Sistema e Melhores Práticas",
    description: "Guia completo sobre controle de estoque de suplementos: sistema e melhores práticas",
    url: 'https://neofitflow.com.br/blog/controle-estoque-suplementos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Controle de Estoque de Suplementos",
    description: "Guia completo sobre controle de estoque de suplementos: sistema e melhores práticas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Controle de Estoque de Suplementos",
                item: "https://neofitflow.com.br/blog/controle-estoque-suplementos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Controle de Estoque de Suplementos: Sistema e Melhores Práticas",
            description: "Guia completo sobre controle de estoque de suplementos: sistema e melhores práticas",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Controle de Estoque de Suplementos: Sistema e Melhores Práticas</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-09">09/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como controle de estoque de suplementos: sistema e melhores práticas, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Controle de Estoque de Suplementos: Sistema e Melhores Práticas não é apenas uma tendência - é uma necessidade para academias que querem
