...
export const metadata: Metadata = {
  title: "Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo | NeoFitFlow",
  description: "Anatomia de uma mensagem WhatsApp eficaz para recuperar aluno em risco: linguagem, momento e call-to-action.",
  keywords: "mensagem preventiva, comunicação eficaz, whatsapp retenção, abordagem correta",
  alternates: {
    canonical: '/blog/mensagem-preventiva-funciona-tom-timing-conteudo',
  },
  openGraph: {
    title: "Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo",
    description: "Anatomia de uma mensagem WhatsApp eficaz para recuperar aluno em risco: linguagem, momento e call-to-action.",
    url: 'https://neofitflow.com.br/blog/mensagem-preventiva-funciona-tom-timing-conteudo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo",
                item: "https://neofitflow.com.br/blog/mensagem-preventiva-funciona-tom-timing-conteudo",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo",
            description: "Anatomia de uma mensagem WhatsApp eficaz para recuperar aluno em risco: linguagem, momento e call-to-action.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar mensagem preventiva que funciona: tom, timing e conteúdo, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Mensagem Preventiva Que Funciona: Tom, Timing e Conteúdo não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
