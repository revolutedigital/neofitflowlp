...
export const metadata: Metadata = {
  title: "Indicadores de Evasão em Academia: Quais Métricas Acompanhar | NeoFitFlow",
  description: "Guia completo sobre indicadores de evasão em academia: quais métricas acompanhar. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "indicadores evasao academia acompanhar, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/indicadores-evasao-academia-acompanhar',
  },
  openGraph: {
    title: "Indicadores de Evasão em Academia: Quais Métricas Acompanhar",
    description: "Guia completo sobre indicadores de evasão em academia: quais métricas acompanhar",
    url: 'https://neofitflow.com.br/blog/indicadores-evasao-academia-acompanhar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Indicadores de Evasão Para Acompanhar na Academia",
    description: "Guia completo sobre indicadores de evasão em academia: quais métricas acompanhar. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Indicadores de Evasão Para Acompanhar na Academia",
                item: "https://neofitflow.com.br/blog/indicadores-evasao-academia-acompanhar",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Indicadores de Evasão em Academia: Quais Métricas Acompanhar",
            description: "Guia completo sobre indicadores de evasão em academia: quais métricas acompanhar",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Indicadores de Evasão em Academia: Quais Métricas Acompanhar</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-08">08/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como indicadores de evasão em academia: quais métricas acompanhar, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Indicadores de Evasão em Academia: Quais Métricas Acompanhar não é apenas uma tendência - é uma necessidade para academias que querem
