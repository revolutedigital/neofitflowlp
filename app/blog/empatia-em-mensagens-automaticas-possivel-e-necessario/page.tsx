...
export const metadata: Metadata = {
  ...
  description: "Automação ≠ frieza. IA pode ser empática usando: nome, histórico, contexto, pergunta aberta, oferta específica. Exemplos práticos de automação humanizada.",
  ...
  alternates: { canonical: '/blog/empatia-em-mensagens-automaticas-possivel-e-necessario' },
  openGraph: {
    title: "Empatia em Mensagens Automáticas: Possível e Necessário",
    description: "Automação ≠ frieza. IA pode ser empática usando: nome, histórico, contexto, pergunta aberta, oferta específica. Exemplos práticos de automação humanizada.",
    url: 'https://neofitflow.com.br/blog/empatia-em-mensagens-automaticas-possivel-e-necessario',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Empatia em Mensagens Automáticas: Possível e Necessário", item: "https://neofitflow.com.br/blog/empatia-em-mensagens-automaticas-possivel-e-necessario" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Empatia em Mensagens Automáticas: Possível e Necessário
              </h1>
...
<h1>Empatia em Mensagens Automáticas: Possível e Necessário</h1>
