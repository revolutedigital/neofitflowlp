...
export const metadata: Metadata = {
  title: "Stories do Instagram Que Engajam: Ideias Para Academia | NeoFitFlow",
  description: "Guia completo sobre stories do instagram que engajam: ideias para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "stories instagram engajar, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/stories-instagram-engajar',
  },
  openGraph: {
    title: "Stories do Instagram Que Engajam: Ideias Para Academia",
    description: "Guia completo sobre stories do instagram que engajam: ideias para academia",
    url: 'https://neofitflow.com.br/blog/stories-instagram-engajar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Stories do Instagram Para Engajar",
    description: "Guia completo sobre stories do instagram que engajam: ideias para academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Stories do Instagram Para Engajar",
                item: "https://neofitflow.com.br/blog/stories-instagram-engajar",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Stories do Instagram Que Engajam: Ideias Para Academia",
            description: "Guia completo sobre stories do instagram que engajam: ideias para academia",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Stories do Instagram Que Engajam: Ideias Para Academia</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-25">25/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como stories do instagram que engajam: ideias para academia, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Stories do Instagram Que Engajam: Ideias Para Academia não é apenas uma tendência - é uma necessidade para academias que querem
