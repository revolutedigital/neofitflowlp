...
export const metadata: Metadata = {
  title: "Como Criar Oferta Irresistível Para Fechar Matrícula | NeoFitFlow",
  description: "Guia completo sobre como criar oferta irresistível para fechar matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "oferta irresistivel fechar matricula, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/oferta-irresistivel-fechar-matricula',
  },
  openGraph: {
    title: "Como Criar Oferta Irresistível Para Fechar Matrícula",
    description: "Guia completo sobre como criar oferta irresistível para fechar matrícula",
    url: 'https://neofitflow.com.br/blog/oferta-irresistivel-fechar-matricula',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Oferta Irresistível Para Fechar Matrícula",
    description: "Guia completo sobre como criar oferta irresistível para fechar matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Oferta Irresistível Para Fechar Matrícula",
                item: "https://neofitflow.com.br/blog/oferta-irresistivel-fechar-matricula",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Criar Oferta Irresistível Para Fechar Matrícula",
            description: "Guia completo sobre como criar oferta irresistível para fechar matrícula",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Criar Oferta Irresistível Para Fechar Matrícula</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-28">28/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como criar oferta irresistível para fechar matrícula, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Criar Oferta Irresistível Para Fechar Matrícula não é apenas uma tendência - é uma necessidade para academias que querem
