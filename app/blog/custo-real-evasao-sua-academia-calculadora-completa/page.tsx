...
export const metadata: Metadata = {
  title: "Custo Real da Evasão na Sua Academia: Calculadora Completa [2025] | NeoFitFlow",
  description: "Calcule exatamente quanto você está perdendo com evasão mensal: CAC perdido, MRR não realizado e oportunidade de upsell.",
  keywords: "custo evasão, cálculo perda, impacto financeiro, prejuízo cancelamento",
  alternates: {
    canonical: '/blog/custo-real-evasao-sua-academia-calculadora-completa',
  },
  openGraph: {
    title: "Custo Real da Evasão na Sua Academia: Calculadora Completa [2025]",
    description: "Calcule exatamente quanto você está perdendo com evasão mensal: CAC perdido, MRR não realizado e oportunidade de upsell.",
    url: 'https://neofitflow.com.br/blog/custo-real-evasao-sua-academia-calculadora-completa',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Custo Real da Evasão na Sua Academia: Calculadora Completa [2025]",
                item: "https://neofitflow.com.br/blog/custo-real-evasao-sua-academia-calculadora-completa",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Custo Real da Evasão na Sua Academia: Calculadora Completa [2025]",
            description: "Calcule exatamente quanto você está perdendo com evasão mensal: CAC perdido, MRR não realizado e oportunidade de upsell.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Custo Real da Evasão na Sua Academia: Calculadora Completa [2025]</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar custo real da evasão na sua academia: calculadora completa [2025], com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Custo Real da Evasão na Sua Academia: Calculadora Completa [2025] não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
