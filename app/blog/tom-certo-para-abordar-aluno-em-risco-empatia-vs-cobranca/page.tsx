...
export const metadata: Metadata = {
  ...
  description: "'Cadê você?' vs 'Sentimos sua falta, tudo bem?'. A diferença de tom multiplica resposta por 4x. Guia completo de comunicação empática para retenção.",
  ...
  alternates: { canonical: '/blog/tom-certo-para-abordar-aluno-em-risco-empatia-vs-cobranca' },
  openGraph: {
    title: "Tom Certo para Abordar Aluno em Risco: Empatia vs Cobrança",
    description: "'Cadê você?' vs 'Sentimos sua falta, tudo bem?'. A diferença de tom multiplica resposta por 4x. Guia completo de comunicação empática para retenção.",
    url: 'https://neofitflow.com.br/blog/tom-certo-para-abordar-aluno-em-risco-empatia-vs-cobranca',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Tom Certo para Abordar Aluno em Risco: Empatia vs Cobrança", item: "https://neofitflow.com.br/blog/tom-certo-para-abordar-aluno-em-risco-empatia-vs-cobranca" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Tom Certo para Abordar Aluno em Risco: Empatia vs Cobrança
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-11">10 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Tom Certo para Abordar Aluno em Risco: Empatia vs Cobrança</h1>
