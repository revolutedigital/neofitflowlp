...
export const metadata: Metadata = {
  ...
  description: "Dashboard inteligente mostra alunos em risco verde/amarelo/vermelho em tempo real. Monitore 24/7, receba alertas e aja antes de perder MRR.",
  ...
  alternates: { canonical: '/blog/dashboard-de-risco-em-tempo-real-monitore-cancelamentos-24-7-com-ia' },
  openGraph: {
    title: "Dashboard de Risco em Tempo Real: Monitore Cancelamentos 24/7 com IA",
    description: "Dashboard inteligente mostra alunos em risco verde/amarelo/vermelho em tempo real. Monitore 24/7, receba alertas e aja antes de perder MRR.",
    url: 'https://neofitflow.com.br/blog/dashboard-de-risco-em-tempo-real-monitore-cancelamentos-24-7-com-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Dashboard de Risco em Tempo Real: Monitore Cancelamentos 24/7 com IA", item: "https://neofitflow.com.br/blog/dashboard-de-risco-em-tempo-real-monitore-cancelamentos-24-7-com-ia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-05">4 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Dashboard de Risco em Tempo Real: Monitore Cancelamentos 24/7 com IA</h1>
