...
export const metadata: Metadata = {
  title: "Script de Vendas Para Academia: Modelo Pronto e Personalizável | NeoFitFlow",
  description: "Guia completo sobre script de vendas para academia: modelo pronto e personalizável. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "script vendas academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/script-vendas-academia',
  },
  openGraph: {
    title: "Script de Vendas Para Academia: Modelo Pronto e Personalizável",
    description: "Guia completo sobre script de vendas para academia: modelo pronto e personalizável",
    url: 'https://neofitflow.com.br/blog/script-vendas-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Script de Vendas Para Academia",
    description: "Guia completo sobre script de vendas para academia: modelo pronto e personalizável. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Script de Vendas Para Academia",
                item: "https://neofitflow.com.br/blog/script-vendas-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Script de Vendas Para Academia: Modelo Pronto e Personalizável",
            description: "Guia completo sobre script de vendas para academia: modelo pronto e personalizável",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Script de Vendas Para Academia: Modelo Pronto e Personalizável</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-22">22/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como script de vendas para academia: modelo pronto e personalizável, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Script de Vendas Para Academia: Modelo Pronto e Personalizável não é apenas uma tendência - é uma necessidade para academias que querem
