...
export const metadata: Metadata = {
  title: "Feedback de Alunos: Como Coletar e Usar Para Melhorar Retenção | NeoFitFlow",
  description: "Guia completo sobre feedback de alunos: como coletar e usar para melhorar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "feedback alunos melhorar retencao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/feedback-alunos-melhorar-retencao',
  },
  openGraph: {
    title: "Feedback de Alunos: Como Coletar e Usar Para Melhorar Retenção",
    description: "Guia completo sobre feedback de alunos: como coletar e usar para melhorar retenção",
    url: 'https://neofitflow.com.br/blog/feedback-alunos-melhorar-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Feedback de Alunos Para Melhorar Retenção",
    description: "Guia completo sobre feedback de alunos: como coletar e usar para melhorar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Feedback de Alunos Para Melhorar Retenção",
                item: "https://neofitflow.com.br/blog/feedback-alunos-melhorar-retencao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Feedback de Alunos: Como Coletar e Usar Para Melhorar Retenção",
            description: "Guia completo sobre feedback de alunos: como coletar e usar para melhorar retenção",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Feedback de Alunos: Como Coletar e Usar Para Melhorar Retenção</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-28">28/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como feedback de alunos: como coletar e usar para melhorar retenção, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Feedback de Alunos: Como Coletar e Usar Para Melhorar Retenção não é apenas uma tendência - é uma necessidade para academias que querem
