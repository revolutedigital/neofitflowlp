...
export const metadata: Metadata = {
  title: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento | NeoFitFlow",
  description: "Estratégias práticas para transformar academia em comunidade onde alunos criam vínculos e não querem sair.",
  keywords: "comunidade academia, senso pertencimento, conexão social, laços grupo",
  alternates: {
    canonical: '/blog/senso-comunidade-previne-evasao-criar-pertencimento',
  },
  openGraph: {
    title: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento",
    description: "Estratégias práticas para transformar academia em comunidade onde alunos criam vínculos e não querem sair.",
    url: 'https://neofitflow.com.br/blog/senso-comunidade-previne-evasao-criar-pertencimento',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento",
                item: "https://neofitflow.com.br/blog/senso-comunidade-previne-evasao-criar-pertencimento",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Senso de Comunidade Previne Evasão: Como Criar Pertencimento",
            description: "Estratégias práticas para transformar academia em comunidade onde alunos criam vínculos e não querem sair.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Senso de Comunidade Previne Evasão: Como Criar Pertencimento</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar senso de comunidade previne evasão: como criar pertencimento, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Senso de Comunidade Previne Evasão: Como Criar Pertencimento não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
