...
export const metadata: Metadata = {
  ...
  description: "Anatomia da mensagem preventiva perfeita: tom empático (não cobrança), timing certo (manhã 9-10h), conteúdo relevante (oferta ajuda). Taxa resposta 45% vs 12% genérica.",
  ...
  alternates: { canonical: '/blog/mensagem-preventiva-que-funciona-tom-timing-e-conteudo' },
  openGraph: {
    title: "Mensagem Preventiva que Funciona: Tom, Timing e Conteúdo",
    description: "Anatomia da mensagem preventiva perfeita: tom empático (não cobrança), timing certo (manhã 9-10h), conteúdo relevante (oferta ajuda). Taxa resposta 45% vs 12% genérica.",
    url: 'https://neofitflow.com.br/blog/mensagem-preventiva-que-funciona-tom-timing-e-conteudo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Mensagem Preventiva que Funciona: Tom, Timing e Conteúdo", item: "https://neofitflow.com.br/blog/mensagem-preventiva-que-funciona-tom-timing-e-conteudo" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Mensagem Preventiva que Funciona: Tom, Timing e Conteúdo
              </h1>
...
<h1>Mensagem Preventiva que Funciona: Tom, Timing e Conteúdo</h1>
