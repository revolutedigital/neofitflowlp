...
export const metadata: Metadata = {
  title: "Como Aumentar Taxa de Conversão de Leads em 40%: Guia Fitness | NeoFitFlow",
  description: "Guia completo sobre como aumentar taxa de conversão de leads em 40%: guia fitness. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "aumentar taxa conversao leads fitness, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/aumentar-taxa-conversao-leads-fitness',
  },
  openGraph: {
    title: "Como Aumentar Taxa de Conversão de Leads em 40%: Guia Fitness",
    description: "Guia completo sobre como aumentar taxa de conversão de leads em 40%: guia fitness",
    url: 'https://neofitflow.com.br/blog/aumentar-taxa-conversao-leads-fitness',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Aumentar Taxa de Conversão de Leads Fitness",
    description: "Guia completo sobre como aumentar taxa de conversão de leads em 40%: guia fitness. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Aumentar Taxa de Conversão de Leads Fitness",
                item: "https://neofitflow.com.br/blog/aumentar-taxa-conversao-leads-fitness",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Aumentar Taxa de Conversão de Leads em 40%: Guia Fitness",
            description: "Guia completo sobre como aumentar taxa de conversão de leads em 40%: guia fitness",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-600 mb-4">Vendas</div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Aumentar Taxa de Conversão de Leads em 40%: Guia Fitness</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-04">04/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como aumentar taxa de conversão de leads em 40%: guia fitness, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                Cada lead que não converte representa investimento desperdiçado em marketing e aquisição.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Aumentar Taxa de Conversão de Leads em 40%: Guia Fitness não é apenas uma tendência - é uma necessidade para academias que querem
