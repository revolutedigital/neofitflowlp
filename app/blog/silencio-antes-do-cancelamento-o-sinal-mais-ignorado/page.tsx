...
export const metadata: Metadata = {
  ...
  description: "Aluno que para de responder mensagens, evita contato visual, não interage = sinal crítico ignorado. Silêncio precede 70% dos cancelamentos. Como quebrar o gelo.",
  ...
  alternates: { canonical: '/blog/silencio-antes-do-cancelamento-o-sinal-mais-ignorado' },
  openGraph: {
    title: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado",
    description: "Aluno que para de responder mensagens, evita contato visual, não interage = sinal crítico ignorado. Silêncio precede 70% dos cancelamentos. Como quebrar o gelo.",
    url: 'https://neofitflow.com.br/blog/silencio-antes-do-cancelamento-o-sinal-mais-ignorado',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Silêncio Antes do Cancelamento: O Sinal Mais Ignorado", item: "https://neofitflow.com.br/blog/silencio-antes-do-cancelamento-o-sinal-mais-ignorado" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Silêncio Antes do Cancelamento: O Sinal Mais Ignorado
              </h1>
...
<h1>Silêncio Antes do Cancelamento: O Sinal Mais Ignorado</h1>
