...
export const metadata: Metadata = {
  title: "Relacionamento Além do Treino: Conexão que Retém | NeoFitFlow",
  description: "Academia não é só treino. É relacionamento, apoio, comunidade. Como criar conexões além treino: eventos sociais, grupos WhatsApp, café pós-treino, aniversários.",
  ...
  alternates: { canonical: '/blog/relacionamento-alem-do-treino-conexao-que-retem' },
  openGraph: {
    title: "Relacionamento Além do Treino: Conexão que Retém",
    description: "Academia não é só treino. É relacionamento, apoio, comunidade. Como criar conexões além treino: eventos sociais, grupos WhatsApp, café pós-treino, aniversários.",
    url: 'https://neofitflow.com.br/blog/relacionamento-alem-do-treino-conexao-que-retem',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Relacionamento Além do Treino: Conexão que Retém", item: "https://neofitflow.com.br/blog/relacionamento-alem-do-treino-conexao-que-retem" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Relacionamento Além do Treino: Conexão que Retém",
          description: "Academia não é só treino. É relacionamento, apoio, comunidade. Como criar conexões além treino: eventos sociais, grupos WhatsApp, café pós-treino, aniversários.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Relacionamento Além do Treino: Conexão que Retém
              </h1>
...
<h1>Relacionamento Além do Treino: Conexão que Retém</h1>
