...
export const metadata: Metadata = {
  title: "Como Converter Mais Leads em Academia: 10 Táticas Comprovadas | NeoFitFlow",
  description: "Guia completo sobre como converter mais leads em academia: 10 táticas comprovadas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "como converter mais leads academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/como-converter-mais-leads-academia',
  },
  openGraph: {
    title: "Como Converter Mais Leads em Academia: 10 Táticas Comprovadas",
    description: "Guia completo sobre como converter mais leads em academia: 10 táticas comprovadas",
    url: 'https://neofitflow.com.br/blog/como-converter-mais-leads-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Como Converter Mais Leads na Academia",
    description: "Guia completo sobre como converter mais leads em academia: 10 táticas comprovadas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Converter Mais Leads na Academia",
                item: "https://neofitflow.com.br/blog/como-converter-mais-leads-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Converter Mais Leads em Academia: 10 Táticas Comprovadas",
            description: "Guia completo sobre como converter mais leads em academia: 10 táticas comprovadas",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Converter Mais Leads em Academia: 10 Táticas Comprovadas</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-05">05/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como converter mais leads em academia: 10 táticas comprovadas, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Converter Mais Leads em Academia: 10 Táticas Comprovadas não é apenas uma tendência - é uma necessidade para academias que querem
