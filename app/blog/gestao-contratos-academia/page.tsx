...
export const metadata: Metadata = {
  title: "Gestão de Contratos de Academia: Templates e Automação | NeoFitFlow",
  description: "Guia completo sobre gestão de contratos de academia: templates e automação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "gestao contratos academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/gestao-contratos-academia',
  },
  openGraph: {
    title: "Gestão de Contratos de Academia: Templates e Automação",
    description: "Guia completo sobre gestão de contratos de academia: templates e automação",
    url: 'https://neofitflow.com.br/blog/gestao-contratos-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Gestão de Contratos em Academia",
    description: "Guia completo sobre gestão de contratos de academia: templates e automação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Gestão de Contratos em Academia",
                item: "https://neofitflow.com.br/blog/gestao-contratos-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Gestão de Contratos de Academia: Templates e Automação",
            description: "Guia completo sobre gestão de contratos de academia: templates e automação",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Gestão de Contratos de Academia: Templates e Automação</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-07">07/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como gestão de contratos de academia: templates e automação, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Gestão de Contratos de Academia: Templates e Automação não é apenas uma tendência - é uma necessidade para academias que querem
