...
export const metadata: Metadata = {
  ...
  description: "10 KPIs que gestor top acompanha: churn rate, CAC/LTV ratio, frequência média, taxa salvamento, MRR, NPS, ticket médio, lifetime, renovação, engajamento.",
  ...
  alternates: { canonical: '/blog/kpis-de-retencao-em-academia-10-metricas-para-acompanhar-diariamente' },
  openGraph: {
    title: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente",
    description: "10 KPIs que gestor top acompanha: churn rate, CAC/LTV ratio, frequência média, taxa salvamento, MRR, NPS, ticket médio, lifetime, renovação, engajamento.",
    url: 'https://neofitflow.com.br/blog/kpis-de-retencao-em-academia-10-metricas-para-acompanhar-diariamente',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente", item: "https://neofitflow.com.br/blog/kpis-de-retencao-em-academia-10-metricas-para-acompanhar-diariamente" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente
              </h1>
...
<h1>KPIs de Retenção em Academia: 10 Métricas Para Acompanhar Diariamente</h1>
