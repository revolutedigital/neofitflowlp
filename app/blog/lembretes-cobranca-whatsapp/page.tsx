...
export const metadata: Metadata = {
  title: "Lembretes de Cobrança no WhatsApp: Como Fazer Sem Ser Chato | NeoFitFlow",
  description: "Guia completo sobre lembretes de cobrança no whatsapp: como fazer sem ser chato. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "lembretes cobranca whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/lembretes-cobranca-whatsapp',
  },
  openGraph: {
    title: "Lembretes de Cobrança no WhatsApp: Como Fazer Sem Ser Chato",
    description: "Guia completo sobre lembretes de cobrança no whatsapp: como fazer sem ser chato",
    url: 'https://neofitflow.com.br/blog/lembretes-cobranca-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Lembretes de Cobrança Pelo WhatsApp",
    description: "Guia completo sobre lembretes de cobrança no whatsapp: como fazer sem ser chato. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Lembretes de Cobrança Pelo WhatsApp",
                item: "https://neofitflow.com.br/blog/lembretes-cobranca-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Lembretes de Cobrança no WhatsApp: Como Fazer Sem Ser Chato",
            description: "Guia completo sobre lembretes de cobrança no whatsapp: como fazer sem ser chato",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Lembretes de Cobrança no WhatsApp: Como Fazer Sem Ser Chato</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-14">14/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como lembretes de cobrança no whatsapp: como fazer sem ser chato, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Lembretes de Cobrança no WhatsApp: Como Fazer Sem Ser Chato não é apenas uma tendência - é uma necessidade para academias que querem
