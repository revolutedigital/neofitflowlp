...
export const metadata: Metadata = {
  title: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas | NeoFitFlow",
  description: "Entenda a diferença entre medir evasão mensal vs anual, como calcular corretamente e qual usar para tomar decisões.",
  keywords: "evasão mensal, evasão anual, cálculo correto, métrica adequada",
  alternates: {
    canonical: '/blog/evasao-mensal-vs-anual-academia-analise-diferencas-criticas',
  },
  openGraph: {
    title: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas",
    description: "Entenda a diferença entre medir evasão mensal vs anual, como calcular corretamente e qual usar para tomar decisões.",
    url: 'https://neofitflow.com.br/blog/evasao-mensal-vs-anual-academia-analise-diferencas-criticas',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas",
                item: "https://neofitflow.com.br/blog/evasao-mensal-vs-anual-academia-analise-diferencas-criticas",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas",
            description: "Entenda a diferença entre medir evasão mensal vs anual, como calcular corretamente e qual usar para tomar decisões.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar evasão mensal vs anual em academia: análise e diferenças críticas, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Evasão Mensal vs Anual em Academia: Análise e Diferenças Críticas não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
