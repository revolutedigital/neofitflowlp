...
export const metadata: Metadata = {
  ...
  description: "Personal: investimento alto, mas ghost é comum (não aparecem, não desmarcam). IA alerta personal 24h antes, sugere remarcação, previne perda de horário.",
  ...
  alternates: { canonical: '/blog/personal-training-como-evitar-ghost-de-alunos-particulares-com-ia' },
  openGraph: {
    title: "Personal Training: Como Evitar 'Ghost' de Alunos Particulares com IA",
    description: "Personal: investimento alto, mas ghost é comum (não aparecem, não desmarcam). IA alerta personal 24h antes, sugere remarcação, previne perda de horário.",
    url: 'https://neofitflow.com.br/blog/personal-training-como-evitar-ghost-de-alunos-particulares-com-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Personal Training: Como Evitar 'Ghost' de Alunos Particulares com IA", item: "https://neofitflow.com.br/blog/personal-training-como-evitar-ghost-de-alunos-particulares-com-ia" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-13">12 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Personal Training: Como Evitar 'Ghost' de Alunos Particulares com IA</h1>
