...
export const metadata: Metadata = {
  title: "CAC (Custo de Aquisição): Como Calcular e Reduzir na Academia | NeoFitFlow",
  description: "Guia completo sobre cac (custo de aquisição): como calcular e reduzir na academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "cac custo aquisicao cliente academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/cac-custo-aquisicao-cliente-academia',
  },
  openGraph: {
    title: "CAC (Custo de Aquisição): Como Calcular e Reduzir na Academia",
    description: "Guia completo sobre cac (custo de aquisição): como calcular e reduzir na academia",
    url: 'https://neofitflow.com.br/blog/cac-custo-aquisicao-cliente-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "CAC: Custo de Aquisição de Cliente em Academia",
    description: "Guia completo sobre cac (custo de aquisição): como calcular e reduzir na academia. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "CAC: Custo de Aquisição de Cliente em Academia",
                item: "https://neofitflow.com.br/blog/cac-custo-aquisicao-cliente-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "CAC (Custo de Aquisição): Como Calcular e Reduzir na Academia",
            description: "Guia completo sobre cac (custo de aquisição): como calcular e reduzir na academia",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">CAC (Custo de Aquisição): Como Calcular e Reduzir na Academia</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-26">26/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como cac (custo de aquisição): como calcular e reduzir na academia, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                CAC (Custo de Aquisição): Como Calcular e Reduzir na Academia não é apenas uma tendência - é uma necessidade para academias que querem
