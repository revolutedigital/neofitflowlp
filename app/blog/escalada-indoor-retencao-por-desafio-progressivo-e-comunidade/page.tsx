...
export const metadata: Metadata = {
  ...
  description: "Escalada: retenção por desafio + comunidade. Quando aluno estagna em nível, desiste. IA detecta platô, sugere nova rota, previne frustração.",
  ...
  alternates: { canonical: '/blog/escalada-indoor-retencao-por-desafio-progressivo-e-comunidade' },
  openGraph: {
    title: "Escalada Indoor: Retenção por Desafio Progressivo e Comunidade",
    description: "Escalada: retenção por desafio + comunidade. Quando aluno estagna em nível, desiste. IA detecta platô, sugere nova rota, previne frustração.",
    url: 'https://neofitflow.com.br/blog/escalada-indoor-retencao-por-desafio-progressivo-e-comunidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Escalada Indoor: Retenção por Desafio Progressivo e Comunidade", item: "https://neofitflow.com.br/blog/escalada-indoor-retencao-por-desafio-progressivo-e-comunidade" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Escalada Indoor: Retenção por Desafio Progressivo e Comunidade
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-18">17 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Escalada Indoor: Retenção por Desafio Progressivo e Comunidade</h1>
