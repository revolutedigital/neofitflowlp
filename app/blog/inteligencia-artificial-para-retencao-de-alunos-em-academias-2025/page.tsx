...
export const metadata: Metadata = {
  ...
  description: "IA revoluciona retenção de alunos: aprenda como sistemas inteligentes monitoram frequência, detectam riscos e agem automaticamente via WhatsApp para evitar cancelamentos.",
  ...
  alternates: { canonical: '/blog/inteligencia-artificial-para-retencao-de-alunos-em-academias-2025' },
  openGraph: {
    title: "Inteligência Artificial para Retenção de Alunos em Academias 2025",
    description: "IA revoluciona retenção de alunos: aprenda como sistemas inteligentes monitoram frequência, detectam riscos e agem automaticamente via WhatsApp para evitar cancelamentos.",
    url: 'https://neofitflow.com.br/blog/inteligencia-artificial-para-retencao-de-alunos-em-academias-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Inteligência Artificial para Retenção de Alunos em Academias 2025", item: "https://neofitflow.com.br/blog/inteligencia-artificial-para-retencao-de-alunos-em-academias-2025" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Inteligência Artificial para Retenção de Alunos em Academias 2025
              </h1>
...
<h1>Inteligência Artificial para Retenção de Alunos em Academias 2025</h1>
