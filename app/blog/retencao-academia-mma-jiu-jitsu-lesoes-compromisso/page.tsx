...
export const metadata: Metadata = {
  title: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso | NeoFitFlow",
  description: "Como lidar com evasão por lesão (comum em artes marciais) e manter engajamento durante recuperação.",
  keywords: "mma retenção, jiu-jitsu, artes marciais, lesão treino",
  alternates: {
    canonical: '/blog/retencao-academia-mma-jiu-jitsu-lesoes-compromisso',
  },
  openGraph: {
    title: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso",
    description: "Como lidar com evasão por lesão (comum em artes marciais) e manter engajamento durante recuperação.",
    url: 'https://neofitflow.com.br/blog/retencao-academia-mma-jiu-jitsu-lesoes-compromisso',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso",
                item: "https://neofitflow.com.br/blog/retencao-academia-mma-jiu-jitsu-lesoes-compromisso",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso",
            description: "Como lidar com evasão por lesão (comum em artes marciais) e manter engajamento durante recuperação.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar retenção em academia de mma e jiu-jitsu: lesões e compromisso, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Retenção em Academia de MMA e Jiu-Jitsu: Lesões e Compromisso não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
