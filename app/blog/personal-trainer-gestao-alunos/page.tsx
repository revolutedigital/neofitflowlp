...
export const metadata: Metadata = {
  title: "Personal Trainer: Como Gerenciar Alunos e Escalar Negócio | NeoFitFlow",
  description: "Guia completo sobre personal trainer: como gerenciar alunos e escalar negócio. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "personal trainer gestao alunos, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/personal-trainer-gestao-alunos',
  },
  openGraph: {
    title: "Personal Trainer: Como Gerenciar Alunos e Escalar Negócio",
    description: "Guia completo sobre personal trainer: como gerenciar alunos e escalar negócio",
    url: 'https://neofitflow.com.br/blog/personal-trainer-gestao-alunos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Personal Trainer: Gestão de Alunos",
    description: "Guia completo sobre personal trainer: como gerenciar alunos e escalar negócio. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Personal Trainer: Gestão de Alunos",
                item: "https://neofitflow.com.br/blog/personal-trainer-gestao-alunos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Personal Trainer: Como Gerenciar Alunos e Escalar Negócio",
            description: "Guia completo sobre personal trainer: como gerenciar alunos e escalar negócio",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Personal Trainer: Como Gerenciar Alunos e Escalar Negócio</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-18">18/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como personal trainer: como gerenciar alunos e escalar negócio, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Personal Trainer: Como Gerenciar Alunos e Escalar Negócio não é apenas uma tendência - é uma necessidade para academias que querem
