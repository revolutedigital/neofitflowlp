...
export const metadata: Metadata = {
  title: "Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade | NeoFitFlow",
  description: "Retenção em bootcamps outdoor: como IA ajuda manter engajamento mesmo sem estrutura física da academia.",
  keywords: "bootcamp retenção, treino outdoor, ia outdoor, grupo intenso",
  alternates: {
    canonical: '/blog/bootcamp-engajamento-continuo-ia-mantem-intensidade',
  },
  openGraph: {
    title: "Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade",
    description: "Retenção em bootcamps outdoor: como IA ajuda manter engajamento mesmo sem estrutura física da academia.",
    url: 'https://neofitflow.com.br/blog/bootcamp-engajamento-continuo-ia-mantem-intensidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade",
                item: "https://neofitflow.com.br/blog/bootcamp-engajamento-continuo-ia-mantem-intensidade",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade",
            description: "Retenção em bootcamps outdoor: como IA ajuda manter engajamento mesmo sem estrutura física da academia.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar bootcamp e engajamento contínuo: como ia mantém a intensidade, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Bootcamp e Engajamento Contínuo: Como IA Mantém a Intensidade não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
