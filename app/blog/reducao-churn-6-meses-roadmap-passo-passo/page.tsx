...
export const metadata: Metadata = {
  title: "Redução de Churn em 6 Meses: Roadmap Passo a Passo | NeoFitFlow",
  description: "Plano detalhado de 6 meses para reduzir evasão progressivamente usando IA, automação e processos estruturados.",
  keywords: "redução churn, plano 6 meses, roadmap retenção, estratégia gradual",
  alternates: {
    canonical: '/blog/reducao-churn-6-meses-roadmap-passo-passo',
  },
  openGraph: {
    title: "Redução de Churn em 6 Meses: Roadmap Passo a Passo",
    description: "Plano detalhado de 6 meses para reduzir evasão progressivamente usando IA, automação e processos estruturados.",
    url: 'https://neofitflow.com.br/blog/reducao-churn-6-meses-roadmap-passo-passo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Redução de Churn em 6 Meses: Roadmap Passo a Passo",
                item: "https://neofitflow.com.br/blog/reducao-churn-6-meses-roadmap-passo-passo",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Redução de Churn em 6 Meses: Roadmap Passo a Passo",
            description: "Plano detalhado de 6 meses para reduzir evasão progressivamente usando IA, automação e processos estruturados.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Redução de Churn em 6 Meses: Roadmap Passo a Passo</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar redução de churn em 6 meses: roadmap passo a passo, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Redução de Churn em 6 Meses: Roadmap Passo a Passo não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
