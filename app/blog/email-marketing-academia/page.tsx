...
export const metadata: Metadata = {
  title: "Email Marketing Para Academia: Estratégias e Templates | NeoFitFlow",
  description: "Guia completo sobre email marketing para academia: estratégias e templates. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "email marketing academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/email-marketing-academia',
  },
  openGraph: {
    title: "Email Marketing Para Academia: Estratégias e Templates",
    description: "Guia completo sobre email marketing para academia: estratégias e templates",
    url: 'https://neofitflow.com.br/blog/email-marketing-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Email Marketing Para Academia",
    description: "Guia completo sobre email marketing para academia: estratégias e templates. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Email Marketing Para Academia",
                item: "https://neofitflow.com.br/blog/email-marketing-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Email Marketing Para Academia: Estratégias e Templates",
            description: "Guia completo sobre email marketing para academia: estratégias e templates",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Email Marketing Para Academia: Estratégias e Templates</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-31">31/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como email marketing para academia: estratégias e templates, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Email Marketing Para Academia: Estratégias e Templates não é apenas uma tendência - é uma necessidade para academias que querem
