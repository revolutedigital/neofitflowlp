...
export const metadata: Metadata = {
  title: "Broadcast no WhatsApp: Como Enviar Mensagens em Massa Sem Ser Bloqueado | NeoFitFlow",
  description: "Guia completo sobre broadcast no whatsapp: como enviar mensagens em massa sem ser bloqueado. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "broadcast whatsapp academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/broadcast-whatsapp-academia',
  },
  openGraph: {
    title: "Broadcast no WhatsApp: Como Enviar Mensagens em Massa Sem Ser Bloqueado",
    description: "Guia completo sobre broadcast no whatsapp: como enviar mensagens em massa sem ser bloqueado",
    url: 'https://neofitflow.com.br/blog/broadcast-whatsapp-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Broadcast WhatsApp Para Academia",
    description: "Guia completo sobre broadcast no whatsapp: como enviar mensagens em massa sem ser bloqueado. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Broadcast WhatsApp Para Academia",
                item: "https://neofitflow.com.br/blog/broadcast-whatsapp-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Broadcast no WhatsApp: Como Enviar Mensagens em Massa Sem Ser Bloqueado",
            description: "Guia completo sobre broadcast no whatsapp: como enviar mensagens em massa sem ser bloqueado",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Broadcast no WhatsApp: Como Enviar Mensagens em Massa Sem Ser Bloqueado</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-12">12/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como broadcast no whatsapp: como enviar mensagens em massa sem ser bloqueado, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Broadcast no WhatsApp: Como Enviar Mensagens em Massa Sem Ser Bloqueado não é apenas uma tendência - é uma necessidade para academias que querem
