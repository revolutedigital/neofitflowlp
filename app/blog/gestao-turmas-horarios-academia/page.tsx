...
export const metadata: Metadata = {
  title: "Gestão de Turmas e Horários: Como Otimizar Ocupação | NeoFitFlow",
  description: "Guia completo sobre gestão de turmas e horários: como otimizar ocupação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "gestao turmas horarios academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/gestao-turmas-horarios-academia',
  },
  openGraph: {
    title: "Gestão de Turmas e Horários: Como Otimizar Ocupação",
    description: "Guia completo sobre gestão de turmas e horários: como otimizar ocupação",
    url: 'https://neofitflow.com.br/blog/gestao-turmas-horarios-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Gestão de Turmas e Horários em Academia",
    description: "Guia completo sobre gestão de turmas e horários: como otimizar ocupação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Gestão de Turmas e Horários em Academia",
                item: "https://neofitflow.com.br/blog/gestao-turmas-horarios-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Gestão de Turmas e Horários: Como Otimizar Ocupação",
            description: "Guia completo sobre gestão de turmas e horários: como otimizar ocupação",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Gestão de Turmas e Horários: Como Otimizar Ocupação</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-14">14/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como gestão de turmas e horários: como otimizar ocupação, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Gestão de Turmas e Horários: Como Otimizar Ocupação não é apenas uma tendência - é uma necessidade para academias que querem
