...
export const metadata: Metadata = {
  title: "Agenda Para Personal Trainer: Como Gerenciar Alunos e Horários | NeoFitFlow",
  description: "Guia completo sobre agenda para personal trainer: como gerenciar alunos e horários. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "agenda personal trainer, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/agenda-personal-trainer',
  },
  openGraph: {
    title: "Agenda Para Personal Trainer: Como Gerenciar Alunos e Horários",
    description: "Guia completo sobre agenda para personal trainer: como gerenciar alunos e horários",
    url: 'https://neofitflow.com.br/blog/agenda-personal-trainer',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Agenda Para Personal Trainer",
    description: "Guia completo sobre agenda para personal trainer: como gerenciar alunos e horários. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Agenda Para Personal Trainer",
                item: "https://neofitflow.com.br/blog/agenda-personal-trainer",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Agenda Para Personal Trainer: Como Gerenciar Alunos e Horários",
            description: "Guia completo sobre agenda para personal trainer: como gerenciar alunos e horários",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Agenda Para Personal Trainer: Como Gerenciar Alunos e Horários</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-08">08/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como agenda para personal trainer: como gerenciar alunos e horários, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Agenda Para Personal Trainer: Como Gerenciar Alunos e Horários não é apenas uma tendência - é uma necessidade para academias que querem
