...
export const metadata: Metadata = {
  title: "Funil de Vendas Para Academia: Como Otimizar Cada Etapa | NeoFitFlow",
  description: "Guia completo sobre funil de vendas para academia: como otimizar cada etapa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "funil vendas academia otimizar, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/funil-vendas-academia-otimizar',
  },
  openGraph: {
    title: "Funil de Vendas Para Academia: Como Otimizar Cada Etapa",
    description: "Guia completo sobre funil de vendas para academia: como otimizar cada etapa",
    url: 'https://neofitflow.com.br/blog/funil-vendas-academia-otimizar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Como Otimizar o Funil de Vendas da Academia",
    description: "Guia completo sobre funil de vendas para academia: como otimizar cada etapa. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Como Otimizar o Funil de Vendas da Academia",
                item: "https://neofitflow.com.br/blog/funil-vendas-academia-otimizar",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Funil de Vendas Para Academia: Como Otimizar Cada Etapa",
            description: "Guia completo sobre funil de vendas para academia: como otimizar cada etapa",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Funil de Vendas Para Academia: Como Otimizar Cada Etapa</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-03">03/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como funil de vendas para academia: como otimizar cada etapa, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Funil de Vendas Para Academia: Como Otimizar Cada Etapa não é apenas uma tendência - é uma necessidade para academias que querem
