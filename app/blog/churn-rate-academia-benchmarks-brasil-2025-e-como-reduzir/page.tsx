...
export const metadata: Metadata = {
  title: "Churn Rate Academia: Benchmarks Brasil 2025 e Como Reduzir | NeoFitFlow",
  description: "Churn rate médio no Brasil: 25-35% ao ano. Seu está acima? Veja benchmarks por região, porte e modalidade + estratégias para reduzir para 15-20%.",
  ...
  alternates: { canonical: '/blog/churn-rate-academia-benchmarks-brasil-2025-e-como-reduzir' },
  openGraph: {
    title: "Churn Rate Academia: Benchmarks Brasil 2025 e Como Reduzir",
    description: "Churn rate médio no Brasil: 25-35% ao ano. Seu está acima? Veja benchmarks por região, porte e modalidade + estratégias para reduzir para 15-20%.",
    url: 'https://neofitflow.com.br/blog/churn-rate-academia-benchmarks-brasil-2025-e-como-reduzir',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Churn Rate Academia: Benchmarks Brasil 2025 e Como Reduzir", item: "https://neofitflow.com.br/blog/churn-rate-academia-benchmarks-brasil-2025-e-como-reduzir" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Churn Rate Academia: Benchmarks Brasil 2025 e Como Reduzir",
          description: "Churn rate médio no Brasil: 25-35% ao ano. Seu está acima? Veja benchmarks por região, porte e modalidade + estratégias para reduzir para 15-20%.",
...
<h1>Churn Rate Academia: Benchmarks Brasil 2025 e Como Reduzir</h1>
