...
export const metadata: Metadata = {
  title: "O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam | NeoFitFlow",
  description: "Modelos de mensagens testados e aprovados para diferentes cenários de ausência: 3 faltas, 1 semana, 2 semanas, 1 mês.",
  keywords: "scripts mensagem, o que falar, modelos prontos, mensagens testadas",
  alternates: {
    canonical: '/blog/o-que-falar-aluno-sumiu-scripts-funcionam',
  },
  openGraph: {
    title: "O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam",
    description: "Modelos de mensagens testados e aprovados para diferentes cenários de ausência: 3 faltas, 1 semana, 2 semanas, 1 mês.",
    url: 'https://neofitflow.com.br/blog/o-que-falar-aluno-sumiu-scripts-funcionam',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam",
                item: "https://neofitflow.com.br/blog/o-que-falar-aluno-sumiu-scripts-funcionam",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam",
            description: "Modelos de mensagens testados e aprovados para diferentes cenários de ausência: 3 faltas, 1 semana, 2 semanas, 1 mês.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar o que falar com aluno que sumiu: scripts que funcionam, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                O Que Falar Com Aluno Que Sumiu: Scripts Que Funcionam não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
