...
export const metadata: Metadata = {
  title: "Resposta Rápida a Leads: Por Que Primeiros 5 Minutos São Cruciais | NeoFitFlow",
  description: "Guia completo sobre resposta rápida a leads: por que primeiros 5 minutos são cruciais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "resposta rapida leads whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/resposta-rapida-leads-whatsapp',
  },
  openGraph: {
    title: "Resposta Rápida a Leads: Por Que Primeiros 5 Minutos São Cruciais",
    description: "Guia completo sobre resposta rápida a leads: por que primeiros 5 minutos são cruciais",
    url: 'https://neofitflow.com.br/blog/resposta-rapida-leads-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Resposta Rápida a Leads no WhatsApp",
    description: "Guia completo sobre resposta rápida a leads: por que primeiros 5 minutos são cruciais. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Resposta Rápida a Leads no WhatsApp",
                item: "https://neofitflow.com.br/blog/resposta-rapida-leads-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Resposta Rápida a Leads: Por Que Primeiros 5 Minutos São Cruciais",
            description: "Guia completo sobre resposta rápida a leads: por que primeiros 5 minutos são cruciais",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Resposta Rápida a Leads: Por Que Primeiros 5 Minutos São Cruciais</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-30">30/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como resposta rápida a leads: por que primeiros 5 minutos são cruciais, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Resposta Rápida a Leads: Por Que Primeiros 5 Minutos São Cruciais não é apenas uma tendência - é uma necessidade para academias que querem
