...
export const metadata: Metadata = {
  ...
  description: "Evasão zero é utopia, mas 10-15% é possível. Análise realista: benchmarks globais, melhores academias Brasil, estratégias para chegar lá.",
  ...
  alternates: { canonical: '/blog/evasao-zero-em-academia-e-possivel-ou-utopia-analise-realista' },
  openGraph: {
    title: "Evasão Zero em Academia: É Possível ou Utopia? Análise Realista",
    description: "Evasão zero é utopia, mas 10-15% é possível. Análise realista: benchmarks globais, melhores academias Brasil, estratégias para chegar lá.",
    url: 'https://neofitflow.com.br/blog/evasao-zero-em-academia-e-possivel-ou-utopia-analise-realista',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Evasão Zero em Academia: É Possível ou Utopia? Análise Realista", item: "https://neofitflow.com.br/blog/evasao-zero-em-academia-e-possivel-ou-utopia-analise-realista" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Evasão Zero em Academia: É Possível ou Utopia? Análise Realista
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-10">9 de março de 2025</time>
                <span>•</span>
...
<h1>Evasão Zero em Academia: É Possível ou Utopia? Análise Realista</h1>
