...
export const metadata: Metadata = {
  title: "Verão e Queda de Frequência: Férias, Viagens e Retenção | NeoFitFlow",
  description: "Estratégias para manter engajamento durante dezembro/janeiro quando alunos viajam e quebram rotina de treinos.",
  keywords: "verão academia, férias treino, dezembro janeiro, manter engajamento",
  alternates: {
    canonical: '/blog/verao-queda-frequencia-ferias-viagens-retencao',
  },
  openGraph: {
    title: "Verão e Queda de Frequência: Férias, Viagens e Retenção",
    description: "Estratégias para manter engajamento durante dezembro/janeiro quando alunos viajam e quebram rotina de treinos.",
    url: 'https://neofitflow.com.br/blog/verao-queda-frequencia-ferias-viagens-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Verão e Queda de Frequência: Férias, Viagens e Retenção",
                item: "https://neofitflow.com.br/blog/verao-queda-frequencia-ferias-viagens-retencao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Verão e Queda de Frequência: Férias, Viagens e Retenção",
            description: "Estratégias para manter engajamento durante dezembro/janeiro quando alunos viajam e quebram rotina de treinos.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Verão e Queda de Frequência: Férias, Viagens e Retenção</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar verão e queda de frequência: férias, viagens e retenção, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Verão e Queda de Frequência: Férias, Viagens e Retenção não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
