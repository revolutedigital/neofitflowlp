...
export const metadata: Metadata = {
  ...
  description: "Aluno de 2+ anos que some é diferente de novato. Burnout, rotina, tédio. Como detectar sinais em veteranos e reengajar quem 'já viu de tudo'.",
  ...
  alternates: { canonical: '/blog/aluno-veterano-que-some-como-recuperar-engajamento-antigo' },
  openGraph: {
    title: "Aluno Veterano que Some: Como Recuperar Engajamento Antigo",
    description: "Aluno de 2+ anos que some é diferente de novato. Burnout, rotina, tédio. Como detectar sinais em veteranos e reengajar quem 'já viu de tudo'.",
    url: 'https://neofitflow.com.br/blog/aluno-veterano-que-some-como-recuperar-engajamento-antigo',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Aluno Veterano que Some: Como Recuperar Engajamento Antigo", item: "https://neofitflow.com.br/blog/aluno-veterano-que-some-como-recuperar-engajamento-antigo" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-28">27 de março de 2025</time>
                <span>•</span>
...
<h1>Aluno Veterano que Some: Como Recuperar Engajamento Antigo</h1>
