...
export const metadata: Metadata = {
  title: "Perfil de Aluno Que Cancela Mais: Segmentação de Risco | NeoFitFlow",
  description: "Análise de perfis demográficos e comportamentais com maior propensão ao cancelamento para monitoramento prioritário.",
  keywords: "perfil risco, segmentação aluno, grupos vulneráveis, propensão cancelamento",
  alternates: {
    canonical: '/blog/perfil-aluno-cancela-mais-segmentacao-risco',
  },
  openGraph: {
    title: "Perfil de Aluno Que Cancela Mais: Segmentação de Risco",
    description: "Análise de perfis demográficos e comportamentais com maior propensão ao cancelamento para monitoramento prioritário.",
    url: 'https://neofitflow.com.br/blog/perfil-aluno-cancela-mais-segmentacao-risco',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Perfil de Aluno Que Cancela Mais: Segmentação de Risco",
                item: "https://neofitflow.com.br/blog/perfil-aluno-cancela-mais-segmentacao-risco",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Perfil de Aluno Que Cancela Mais: Segmentação de Risco",
            description: "Análise de perfis demográficos e comportamentais com maior propensão ao cancelamento para monitoramento prioritário.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Perfil de Aluno Que Cancela Mais: Segmentação de Risco</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar perfil de aluno que cancela mais: segmentação de risco, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Perfil de Aluno Que Cancela Mais: Segmentação de Risco não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
