...
export const metadata: Metadata = {
  title: "Tráfego Pago Para Academia: Guia Para Iniciantes | NeoFitFlow",
  description: "Guia completo sobre tráfego pago para academia: guia para iniciantes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "trafego pago academia iniciantes, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/trafego-pago-academia-iniciantes',
  },
  openGraph: {
    title: "Tráfego Pago Para Academia: Guia Para Iniciantes",
    description: "Guia completo sobre tráfego pago para academia: guia para iniciantes",
    url: 'https://neofitflow.com.br/blog/trafego-pago-academia-iniciantes',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Tráfego Pago Para Academia: Guia Iniciantes",
    description: "Guia completo sobre tráfego pago para academia: guia para iniciantes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Tráfego Pago Para Academia: Guia Iniciantes",
                item: "https://neofitflow.com.br/blog/trafego-pago-academia-iniciantes",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Tráfego Pago Para Academia: Guia Para Iniciantes",
            description: "Guia completo sobre tráfego pago para academia: guia para iniciantes",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Tráfego Pago Para Academia: Guia Para Iniciantes</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-02">02/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como tráfego pago para academia: guia para iniciantes, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Tráfego Pago Para Academia: Guia Para Iniciantes não é apenas uma tendência - é uma necessidade para academias que querem
