...
export const metadata: Metadata = {
  ...
  description: "Não espere vencimento para agir. 45 dias antes: analise frequência. 30 dias: mensagem preventiva. 15 dias: oferta renovação antecipada. Fluxo completo.",
  ...
  alternates: { canonical: '/blog/aluno-que-nao-renova-como-prevenir-antes-do-vencimento' },
  openGraph: {
    title: "Aluno que Não Renova: Como Prevenir Antes do Vencimento",
    description: "Não espere vencimento para agir. 45 dias antes: analise frequência. 30 dias: mensagem preventiva. 15 dias: oferta renovação antecipada. Fluxo completo.",
    url: 'https://neofitflow.com.br/blog/aluno-que-nao-renova-como-prevenir-antes-do-vencimento',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Aluno que Não Renova: Como Prevenir Antes do Vencimento", item: "https://neofitflow.com.br/blog/aluno-que-nao-renova-como-prevenir-antes-do-vencimento" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Aluno que Não Renova: Como Prevenir Antes do Vencimento
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-03">2 de março de 2025</time>
                <span>•</span>
...
<h1>Aluno que Não Renova: Como Prevenir Antes do Vencimento</h1>
