...
export const metadata: Metadata = {
  title: "CRM Para Gestão de Leads: Como Organizar e Não Perder Oportunidades | NeoFitFlow",
  description: "Guia completo sobre crm para gestão de leads: como organizar e não perder oportunidades. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "crm gestao leads academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/crm-gestao-leads-academia',
  },
  openGraph: {
    title: "CRM Para Gestão de Leads: Como Organizar e Não Perder Oportunidades",
    description: "Guia completo sobre crm para gestão de leads: como organizar e não perder oportunidades",
    url: 'https://neofitflow.com.br/blog/crm-gestao-leads-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "CRM Para Gestão de Leads de Academia",
    description: "Guia completo sobre crm para gestão de leads: como organizar e não perder oportunidades. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "CRM Para Gestão de Leads de Academia",
                item: "https://neofitflow.com.br/blog/crm-gestao-leads-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "CRM Para Gestão de Leads: Como Organizar e Não Perder Oportunidades",
            description: "Guia completo sobre crm para gestão de leads: como organizar e não perder oportunidades",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">CRM Para Gestão de Leads: Como Organizar e Não Perder Oportunidades</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-23">23/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como crm para gestão de leads: como organizar e não perder oportunidades, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                CRM Para Gestão de Leads: Como Organizar e Não Perder Oportunidades não é apenas uma tendência - é uma necessidade para academias que querem
