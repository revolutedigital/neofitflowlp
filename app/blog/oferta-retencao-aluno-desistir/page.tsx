...
export const metadata: Metadata = {
  title: "Oferta de Retenção: Como Criar Proposta Irrecusável Para Aluno Que Quer Sair | NeoFitFlow",
  description: "Guia completo sobre oferta de retenção: como criar proposta irrecusável para aluno que quer sair. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "oferta retencao aluno desistir, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/oferta-retencao-aluno-desistir',
  },
  openGraph: {
    title: "Oferta de Retenção: Como Criar Proposta Irrecusável Para Aluno Que Quer Sair",
    description: "Guia completo sobre oferta de retenção: como criar proposta irrecusável para aluno que quer sair",
    url: 'https://neofitflow.com.br/blog/oferta-retencao-aluno-desistir',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Oferta de Retenção Quando Aluno Quer Desistir",
    description: "Guia completo sobre oferta de retenção: como criar proposta irrecusável para aluno que quer sair. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Oferta de Retenção Quando Aluno Quer Desistir",
                item: "https://neofitflow.com.br/blog/oferta-retencao-aluno-desistir",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Oferta de Retenção: Como Criar Proposta Irrecusável Para Aluno Que Quer Sair",
            description: "Guia completo sobre oferta de retenção: como criar proposta irrecusável para aluno que quer sair",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Oferta de Retenção: Como Criar Proposta Irrecusável Para Aluno Que Quer Sair</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-02">02/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como oferta de retenção: como criar proposta irrecusável para aluno que quer sair, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Oferta de Retenção: Como Criar Proposta Irrecusável Para Aluno Que Quer Sair não é apenas uma tendência - é uma necessidade para academias que querem
