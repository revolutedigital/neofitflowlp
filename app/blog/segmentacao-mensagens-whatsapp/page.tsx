...
export const metadata: Metadata = {
  title: "Segmentação de Mensagens no WhatsApp: Como Personalizar Comunicação | NeoFitFlow",
  description: "Guia completo sobre segmentação de mensagens no whatsapp: como personalizar comunicação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "segmentacao mensagens whatsapp, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/segmentacao-mensagens-whatsapp',
  },
  openGraph: {
    title: "Segmentação de Mensagens no WhatsApp: Como Personalizar Comunicação",
    description: "Guia completo sobre segmentação de mensagens no whatsapp: como personalizar comunicação",
    url: 'https://neofitflow.com.br/blog/segmentacao-mensagens-whatsapp',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Segmentação de Mensagens no WhatsApp",
    description: "Guia completo sobre segmentação de mensagens no whatsapp: como personalizar comunicação. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Segmentação de Mensagens no WhatsApp",
                item: "https://neofitflow.com.br/blog/segmentacao-mensagens-whatsapp",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Segmentação de Mensagens no WhatsApp: Como Personalizar Comunicação",
            description: "Guia completo sobre segmentação de mensagens no whatsapp: como personalizar comunicação",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Segmentação de Mensagens no WhatsApp: Como Personalizar Comunicação</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-13">13/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como segmentação de mensagens no whatsapp: como personalizar comunicação, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Segmentação de Mensagens no WhatsApp: Como Personalizar Comunicação não é apenas uma tendência - é uma necessidade para academias que querem
