...
export const metadata: Metadata = {
  title: "Detecção Automática de Faltas Consecutivas: Sistema que Não Falha | NeoFitFlow",
  description: "Sistema monitora faltas 24/7: 1 falta = observação, 2 = alerta, 3 = ação automática via WhatsApp. Nenhum aluno em risco passa despercebido.",
  ...
  alternates: { canonical: '/blog/deteccao-automatica-de-faltas-consecutivas-sistema-que-nao-falha' },
  openGraph: {
    title: "Detecção Automática de Faltas Consecutivas: Sistema que Não Falha",
    description: "Sistema monitora faltas 24/7: 1 falta = observação, 2 = alerta, 3 = ação automática via WhatsApp. Nenhum aluno em risco passa despercebido.",
    url: 'https://neofitflow.com.br/blog/deteccao-automatica-de-faltas-consecutivas-sistema-que-nao-falha',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Detecção Automática de Faltas Consecutivas: Sistema que Não Falha", item: "https://neofitflow.com.br/blog/deteccao-automatica-de-faltas-consecutivas-sistema-que-nao-falha" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Detecção Automática de Faltas Consecutivas: Sistema que Não Falha",
          description: "Sistema monitora faltas 24/7: 1 falta = observação, 2 = alerta, 3 = ação automática via WhatsApp. Nenhum aluno em risco passa despercebido.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Detecção Automática de Faltas Consecutivas: Sistema que Não Falha
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-02-23">22 de fevereiro de 2025</time>
                <span>•</span>
...
<h1>Detecção Automática de Faltas Consecutivas: Sistema que Não Falha</h1>
