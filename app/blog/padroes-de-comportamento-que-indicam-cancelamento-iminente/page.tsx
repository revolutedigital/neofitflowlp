...
export const metadata: Metadata = {
  ...
  description: "10 padrões que antecedem 80% dos cancelamentos: queda frequência + mudança horário + não resposta mensagens + faltas pós-treino intenso + mais.",
  ...
  alternates: { canonical: '/blog/padroes-de-comportamento-que-indicam-cancelamento-iminente' },
  openGraph: {
    title: "Padrões de Comportamento que Indicam Cancelamento Iminente",
    description: "10 padrões que antecedem 80% dos cancelamentos: queda frequência + mudança horário + não resposta mensagens + faltas pós-treino intenso + mais.",
    url: 'https://neofitflow.com.br/blog/padroes-de-comportamento-que-indicam-cancelamento-iminente',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Padrões de Comportamento que Indicam Cancelamento Iminente", item: "https://neofitflow.com.br/blog/padroes-de-comportamento-que-indicam-cancelamento-iminente" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Padrões de Comportamento que Indicam Cancelamento Iminente
              </h1>
...
<h1>Padrões de Comportamento que Indicam Cancelamento Iminente</h1>
