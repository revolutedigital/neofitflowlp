...
export const metadata: Metadata = {
  title: "Aula Experimental Que Converte: Do Agendamento à Matrícula | NeoFitFlow",
  description: "Guia completo sobre aula experimental que converte: do agendamento à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "aula experimental converter matricula, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/aula-experimental-converter-matricula',
  },
  openGraph: {
    title: "Aula Experimental Que Converte: Do Agendamento à Matrícula",
    description: "Guia completo sobre aula experimental que converte: do agendamento à matrícula",
    url: 'https://neofitflow.com.br/blog/aula-experimental-converter-matricula',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Aula Experimental: Como Converter em Matrícula",
    description: "Guia completo sobre aula experimental que converte: do agendamento à matrícula. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Aula Experimental: Como Converter em Matrícula",
                item: "https://neofitflow.com.br/blog/aula-experimental-converter-matricula",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Aula Experimental Que Converte: Do Agendamento à Matrícula",
            description: "Guia completo sobre aula experimental que converte: do agendamento à matrícula",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Aula Experimental Que Converte: Do Agendamento à Matrícula</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-02">02/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como aula experimental que converte: do agendamento à matrícula, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Aula Experimental Que Converte: Do Agendamento à Matrícula não é apenas uma tendência - é uma necessidade para academias que querem
