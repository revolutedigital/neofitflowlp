...
export const metadata: Metadata = {
  title: "Aluno Se Sentir Especial: Estratégia de Retenção Emocional | NeoFitFlow",
  description: "Academia que faz aluno se sentir especial (não número) retém 2x mais. Técnicas: lembrar nome, histórico, objetivos, datas importantes, conquistas.",
  ...
  alternates: { canonical: '/blog/aluno-se-sentir-especial-estrategia-de-retencao-emocional' },
  openGraph: {
    title: "Aluno Se Sentir Especial: Estratégia de Retenção Emocional",
    description: "Academia que faz aluno se sentir especial (não número) retém 2x mais. Técnicas: lembrar nome, histórico, objetivos, datas importantes, conquistas.",
    url: 'https://neofitflow.com.br/blog/aluno-se-sentir-especial-estrategia-de-retencao-emocional',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Aluno Se Sentir Especial: Estratégia de Retenção Emocional", item: "https://neofitflow.com.br/blog/aluno-se-sentir-especial-estrategia-de-retencao-emocional" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Aluno Se Sentir Especial: Estratégia de Retenção Emocional",
          description: "Academia que faz aluno se sentir especial (não número) retém 2x mais. Técnicas: lembrar nome, histórico, objetivos, datas importantes, conquistas.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Aluno Se Sentir Especial: Estratégia de Retenção Emocional
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-24">23 de março de 2025</time>
                <span>•</span>
...
<h1>Aluno Se Sentir Especial: Estratégia de Retenção Emocional</h1>
