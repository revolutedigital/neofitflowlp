...
export const metadata: Metadata = {
  title: "Academia Low Cost: Estratégia de Preço e Operação Enxuta | NeoFitFlow",
  description: "Guia completo sobre academia low cost: estratégia de preço e operação enxuta. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "academia low cost estrategia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/academia-low-cost-estrategia',
  },
  openGraph: {
    title: "Academia Low Cost: Estratégia de Preço e Operação Enxuta",
    description: "Guia completo sobre academia low cost: estratégia de preço e operação enxuta",
    url: 'https://neofitflow.com.br/blog/academia-low-cost-estrategia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Academia Low Cost: Estratégia",
    description: "Guia completo sobre academia low cost: estratégia de preço e operação enxuta. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Academia Low Cost: Estratégia",
                item: "https://neofitflow.com.br/blog/academia-low-cost-estrategia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Academia Low Cost: Estratégia de Preço e Operação Enxuta",
            description: "Guia completo sobre academia low cost: estratégia de preço e operação enxuta",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Academia Low Cost: Estratégia de Preço e Operação Enxuta</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-16">16/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como academia low cost: estratégia de preço e operação enxuta, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Academia Low Cost: Estratégia de Preço e Operação Enxuta não é apenas uma tendência - é uma necessidade para academias que querem
