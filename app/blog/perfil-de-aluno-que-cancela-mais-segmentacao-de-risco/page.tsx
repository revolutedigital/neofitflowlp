...
export const metadata: Metadata = {
  ...
  description: "Dados de 10k cancelamentos: perfil alto risco = 18-25 anos, matrícula solo, sem objetivo claro, horário variável. Como identificar e prevenir por perfil.",
  ...
  alternates: { canonical: '/blog/perfil-de-aluno-que-cancela-mais-segmentacao-de-risco' },
  openGraph: {
    title: "Perfil de Aluno que Cancela Mais: Segmentação de Risco",
    description: "Dados de 10k cancelamentos: perfil alto risco = 18-25 anos, matrícula solo, sem objetivo claro, horário variável. Como identificar e prevenir por perfil.",
    url: 'https://neofitflow.com.br/blog/perfil-de-aluno-que-cancela-mais-segmentacao-de-risco',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Perfil de Aluno que Cancela Mais: Segmentação de Risco", item: "https://neofitflow.com.br/blog/perfil-de-aluno-que-cancela-mais-segmentacao-de-risco" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Perfil de Aluno que Cancela Mais: Segmentação de Risco
              </h1>
...
<h1>Perfil de Aluno que Cancela Mais: Segmentação de Risco</h1>
