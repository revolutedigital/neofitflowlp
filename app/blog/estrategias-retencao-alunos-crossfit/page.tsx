...
export const metadata: Metadata = {
  title: "Estratégias de Retenção Para Box CrossFit: Como Manter Atletas Engajados | NeoFitFlow",
  description: "Guia completo sobre estratégias de retenção para box crossfit: como manter atletas engajados. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "estrategias retencao alunos crossfit, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/estrategias-retencao-alunos-crossfit',
  },
  openGraph: {
    title: "Estratégias de Retenção Para Box CrossFit: Como Manter Atletas Engajados",
    description: "Guia completo sobre estratégias de retenção para box crossfit: como manter atletas engajados",
    url: 'https://neofitflow.com.br/blog/estrategias-retencao-alunos-crossfit',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Estratégias de Retenção para Box CrossFit",
    description: "Guia completo sobre estratégias de retenção para box crossfit: como manter atletas engajados. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Estratégias de Retenção para Box CrossFit",
                item: "https://neofitflow.com.br/blog/estrategias-retencao-alunos-crossfit",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Estratégias de Retenção Para Box CrossFit: Como Manter Atletas Engajados",
            description: "Guia completo sobre estratégias de retenção para box crossfit: como manter atletas engajados",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Estratégias de Retenção Para Box CrossFit: Como Manter Atletas Engajados</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-12">12/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como estratégias de retenção para box crossfit: como manter atletas engajados, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Estratégias de Retenção Para Box CrossFit: Como Manter Atletas Engajados não é apenas uma tendência - é uma necessidade para academias que querem
