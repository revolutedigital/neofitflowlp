...
export const metadata: Metadata = {
  title: "Melhor CRM Para Academia Pequena: Comparativo Completo 2025 | NeoFitFlow",
  description: "Guia completo sobre melhor crm para academia pequena: comparativo completo 2025. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "melhor crm academia pequena, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/melhor-crm-academia-pequena',
  },
  openGraph: {
    title: "Melhor CRM Para Academia Pequena: Comparativo Completo 2025",
    description: "Guia completo sobre melhor crm para academia pequena: comparativo completo 2025",
    url: 'https://neofitflow.com.br/blog/melhor-crm-academia-pequena',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Melhor CRM Para Academia Pequena: Comparativo 2025",
    description: "Guia completo sobre melhor crm para academia pequena: comparativo completo 2025. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Melhor CRM Para Academia Pequena: Comparativo 2025",
                item: "https://neofitflow.com.br/blog/melhor-crm-academia-pequena",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Melhor CRM Para Academia Pequena: Comparativo Completo 2025",
            description: "Guia completo sobre melhor crm para academia pequena: comparativo completo 2025",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Melhor CRM Para Academia Pequena: Comparativo Completo 2025</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-20">20/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como melhor crm para academia pequena: comparativo completo 2025, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Melhor CRM Para Academia Pequena: Comparativo Completo 2025 não é apenas uma tendência - é uma necessidade para academias que querem
