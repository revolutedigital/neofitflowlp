...
export const metadata: Metadata = {
  ...
  description: "Prevenção inteligente vai além de alertas: IA sugere melhor horário para mensagem, tom ideal, oferta personalizada - tudo baseado em sucesso de casos similares.",
  ...
  alternates: { canonical: '/blog/prevencao-inteligente-de-evasao-alem-do-simples-alerta-automatico' },
  openGraph: {
    title: "Prevenção Inteligente de Evasão: Além do Simples Alerta Automático",
    description: "Prevenção inteligente vai além de alertas: IA sugere melhor horário para mensagem, tom ideal, oferta personalizada - tudo baseado em sucesso de casos similares.",
    url: 'https://neofitflow.com.br/blog/prevencao-inteligente-de-evasao-alem-do-simples-alerta-automatico',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Prevenção Inteligente de Evasão: Além do Simples Alerta Automático", item: "https://neofitflow.com.br/blog/prevencao-inteligente-de-evasao-alem-do-simples-alerta-automatico" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Prevenção Inteligente de Evasão: Além do Simples Alerta Automático
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-23">22 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Prevenção Inteligente de Evasão: Além do Simples Alerta Automático</h1>
