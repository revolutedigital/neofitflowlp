...
export const metadata: Metadata = {
  ...
  description: "Impossível dar atenção personalizada para 500 alunos manualmente. IA permite: mensagem específica, histórico considerado, momento certo - em escala infinita.",
  ...
  alternates: { canonical: '/blog/personal-touch-em-escala-com-ia-humanizacao-automatizada' },
  openGraph: {
    title: "Personal Touch em Escala com IA: Humanização Automatizada",
    description: "Impossível dar atenção personalizada para 500 alunos manualmente. IA permite: mensagem específica, histórico considerado, momento certo - em escala infinita.",
    url: 'https://neofitflow.com.br/blog/personal-touch-em-escala-com-ia-humanizacao-automatizada',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Personal Touch em Escala com IA: Humanização Automatizada", item: "https://neofitflow.com.br/blog/personal-touch-em-escala-com-ia-humanizacao-automatizada" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Personal Touch em Escala com IA: Humanização Automatizada
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-29">28 de março de 2025</time>
                <span>•</span>
...
<h1>Personal Touch em Escala com IA: Humanização Automatizada</h1>
