...
export const metadata: Metadata = {
  ...
  description: "Aluno fantasma: paga mas não aparece há 15+ dias. 85% cancelam em 60 dias. Sistema de detecção automática + estratégia de resgate antes do pedido.",
  ...
  alternates: { canonical: '/blog/aluno-fantasma-em-academia-como-identificar-e-resgatar' },
  openGraph: {
    title: "Aluno Fantasma em Academia: Como Identificar e Resgatar",
    description: "Aluno fantasma: paga mas não aparece há 15+ dias. 85% cancelam em 60 dias. Sistema de detecção automática + estratégia de resgate antes do pedido.",
    url: 'https://neofitflow.com.br/blog/aluno-fantasma-em-academia-como-identificar-e-resgatar',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Aluno Fantasma em Academia: Como Identificar e Resgatar", item: "https://neofitflow.com.br/blog/aluno-fantasma-em-academia-como-identificar-e-resgatar" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-27">26 de março de 2025</time>
                <span>•</span>
...
<h1>Aluno Fantasma em Academia: Como Identificar e Resgatar</h1>
