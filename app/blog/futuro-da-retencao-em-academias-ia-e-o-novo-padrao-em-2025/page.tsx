...
export const metadata: Metadata = {
  title: "Futuro da Retenção em Academias: IA é o Novo Padrão em 2025 | NeoFitFlow",
  description: "2025: IA deixa de ser diferencial e vira padrão. Academias sem sistema preditivo perdem competitividade. Entenda por que migração é urgente.",
  ...
  alternates: { canonical: '/blog/futuro-da-retencao-em-academias-ia-e-o-novo-padrao-em-2025' },
  openGraph: {
    title: "Futuro da Retenção em Academias: IA é o Novo Padrão em 2025",
    description: "2025: IA deixa de ser diferencial e vira padrão. Academias sem sistema preditivo perdem competitividade. Entenda por que migração é urgente.",
    url: 'https://neofitflow.com.br/blog/futuro-da-retencao-em-academias-ia-e-o-novo-padrao-em-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Futuro da Retenção em Academias: IA é o Novo Padrão em 2025", item: "https://neofitflow.com.br/blog/futuro-da-retencao-em-academias-ia-e-o-novo-padrao-em-2025" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Futuro da Retenção em Academias: IA é o Novo Padrão em 2025",
          description: "2025: IA deixa de ser diferencial e vira padrão. Academias sem sistema preditivo perdem competitividade. Entenda por que migração é urgente.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Futuro da Retenção em Academias: IA é o Novo Padrão em 2025
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-20">19 de março de 2025</time>
                <span>•</span>
...
<h1>Futuro da Retenção em Academias: IA é o Novo Padrão em 2025</h1>
