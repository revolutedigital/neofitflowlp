...
export const metadata: Metadata = {
  title: "Pesquisa de Satisfação NPS em Academia: Como Implementar e Usar Dados | NeoFitFlow",
  description: "Guia completo sobre pesquisa de satisfação nps em academia: como implementar e usar dados. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "pesquisa satisfacao nps academia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/pesquisa-satisfacao-nps-academia',
  },
  openGraph: {
    title: "Pesquisa de Satisfação NPS em Academia: Como Implementar e Usar Dados",
    description: "Guia completo sobre pesquisa de satisfação nps em academia: como implementar e usar dados",
    url: 'https://neofitflow.com.br/blog/pesquisa-satisfacao-nps-academia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Pesquisa de Satisfação (NPS) em Academia",
    description: "Guia completo sobre pesquisa de satisfação nps em academia: como implementar e usar dados. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Pesquisa de Satisfação (NPS) em Academia",
                item: "https://neofitflow.com.br/blog/pesquisa-satisfacao-nps-academia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Pesquisa de Satisfação NPS em Academia: Como Implementar e Usar Dados",
            description: "Guia completo sobre pesquisa de satisfação nps em academia: como implementar e usar dados",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Pesquisa de Satisfação NPS em Academia: Como Implementar e Usar Dados</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2025-01-04">04/01/2025</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como pesquisa de satisfação nps em academia: como implementar e usar dados, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Pesquisa de Satisfação NPS em Academia: Como Implementar e Usar Dados não é apenas uma tendência - é uma necessidade para academias que querem
