...
export const metadata: Metadata = {
  title: "Marketing Digital Para Academia: Guia Completo Para Iniciantes | NeoFitFlow",
  description: "Guia completo sobre marketing digital para academia: guia completo para iniciantes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "marketing digital academia guia, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/marketing-digital-academia-guia',
  },
  openGraph: {
    title: "Marketing Digital Para Academia: Guia Completo Para Iniciantes",
    description: "Guia completo sobre marketing digital para academia: guia completo para iniciantes",
    url: 'https://neofitflow.com.br/blog/marketing-digital-academia-guia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Marketing Digital Para Academia: Guia Completo",
    description: "Guia completo sobre marketing digital para academia: guia completo para iniciantes. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Marketing Digital Para Academia: Guia Completo",
                item: "https://neofitflow.com.br/blog/marketing-digital-academia-guia",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Marketing Digital Para Academia: Guia Completo Para Iniciantes",
            description: "Guia completo sobre marketing digital para academia: guia completo para iniciantes",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Marketing Digital Para Academia: Guia Completo Para Iniciantes</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-05">05/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como marketing digital para academia: guia completo para iniciantes, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Marketing Digital Para Academia: Guia Completo Para Iniciantes não é apenas uma tendência - é uma necessidade para academias que querem
