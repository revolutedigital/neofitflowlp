...
export const metadata: Metadata = {
  title: "Primeira Falta: Momento Crítico que Define Retenção | NeoFitFlow",
  description: "A primeira falta é o momento mais crítico: se vira rotina, evasão cresce 300%. Como agir na primeira falta para evitar que vire segunda e terceira.",
  ...
  alternates: { canonical: '/blog/primeira-falta-momento-critico-que-define-retencao' },
  openGraph: {
    title: "Primeira Falta: Momento Crítico que Define Retenção",
    description: "A primeira falta é o momento mais crítico: se vira rotina, evasão cresce 300%. Como agir na primeira falta para evitar que vire segunda e terceira.",
    url: 'https://neofitflow.com.br/blog/primeira-falta-momento-critico-que-define-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Primeira Falta: Momento Crítico que Define Retenção", item: "https://neofitflow.com.br/blog/primeira-falta-momento-critico-que-define-retencao" }
          ]
        })
      }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Primeira Falta: Momento Crítico que Define Retenção",
          description: "A primeira falta é o momento mais crítico: se vira rotina, evasão cresce 300%. Como agir na primeira falta para evitar que vire segunda e terceira.",
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Primeira Falta: Momento Crítico que Define Retenção
              </h1>
...
<h1>Primeira Falta: Momento Crítico que Define Retenção</h1>
