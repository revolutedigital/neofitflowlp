...
export const metadata: Metadata = {
  ...
  description: "HIIT: treino intenso pode gerar 'medo do próximo'. Aluno adia retorno. IA envia mensagem motivacional, lembra resultados, celebra coragem de voltar.",
  ...
  alternates: { canonical: '/blog/hiit-como-ia-motiva-aluno-a-voltar-apos-treino-intenso' },
  openGraph: {
    title: "HIIT: Como IA Motiva Aluno a Voltar Após Treino Intenso",
    description: "HIIT: treino intenso pode gerar 'medo do próximo'. Aluno adia retorno. IA envia mensagem motivacional, lembra resultados, celebra coragem de voltar.",
    url: 'https://neofitflow.com.br/blog/hiit-como-ia-motiva-aluno-a-voltar-apos-treino-intenso',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "HIIT: Como IA Motiva Aluno a Voltar Após Treino Intenso", item: "https://neofitflow.com.br/blog/hiit-como-ia-motiva-aluno-a-voltar-apos-treino-intenso" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                HIIT: Como IA Motiva Aluno a Voltar Após Treino Intenso
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-16">15 de março de 2025</time>
                <span>•</span>
...
<h1>HIIT: Como IA Motiva Aluno a Voltar Após Treino Intenso</h1>
