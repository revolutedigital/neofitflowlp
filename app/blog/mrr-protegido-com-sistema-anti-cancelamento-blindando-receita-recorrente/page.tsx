...
export const metadata: Metadata = {
  ...
  description: "Cada 1% de redução na evasão = 5-8% mais MRR ao ano. Aprenda a blindar receita recorrente com sistema anti-cancelamento que protege seu crescimento.",
  ...
  alternates: { canonical: '/blog/mrr-protegido-com-sistema-anti-cancelamento-blindando-receita-recorrente' },
  openGraph: {
    title: "MRR Protegido com Sistema Anti-Cancelamento: Blindando Receita Recorrente",
    description: "Cada 1% de redução na evasão = 5-8% mais MRR ao ano. Aprenda a blindar receita recorrente com sistema anti-cancelamento que protege seu crescimento.",
    url: 'https://neofitflow.com.br/blog/mrr-protegido-com-sistema-anti-cancelamento-blindando-receita-recorrente',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "MRR Protegido com Sistema Anti-Cancelamento: Blindando Receita Recorrente", item: "https://neofitflow.com.br/blog/mrr-protegido-com-sistema-anti-cancelamento-blindando-receita-recorrente" }
          ]
        })
      }} />
...
<h1>MRR Protegido com Sistema Anti-Cancelamento: Blindando Receita Recorrente</h1>
