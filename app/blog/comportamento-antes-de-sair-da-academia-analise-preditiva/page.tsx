...
export const metadata: Metadata = {
  ...
  description: "Análise de 5k ex-alunos revelou: 90 dias antes já mostravam sinais. Progressão típica: queda gradual → faltas → mudança horário → silêncio → pedido.",
  ...
  alternates: { canonical: '/blog/comportamento-antes-de-sair-da-academia-analise-preditiva' },
  openGraph: {
    title: "Comportamento Antes de Sair da Academia: Análise Preditiva",
    description: "Análise de 5k ex-alunos revelou: 90 dias antes já mostravam sinais. Progressão típica: queda gradual → faltas → mudança horário → silêncio → pedido.",
    url: 'https://neofitflow.com.br/blog/comportamento-antes-de-sair-da-academia-analise-preditiva',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Comportamento Antes de Sair da Academia: Análise Preditiva", item: "https://neofitflow.com.br/blog/comportamento-antes-de-sair-da-academia-analise-preditiva" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Comportamento Antes de Sair da Academia: Análise Preditiva
              </h1>
...
<h1>Comportamento Antes de Sair da Academia: Análise Preditiva</h1>
