...
export const metadata: Metadata = {
  title: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores | NeoFitFlow",
  description: "Compare métricas de academias antes e depois de implementar IA: evasão, MRR, tempo de gestão e satisfação de alunos.",
  keywords: "transformação digital, antes e depois, resultados comprovados, cases práticos",
  alternates: {
    canonical: '/blog/antes-depois-sistema-retencao-cases-reais-transformadores',
  },
  openGraph: {
    title: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores",
    description: "Compare métricas de academias antes e depois de implementar IA: evasão, MRR, tempo de gestão e satisfação de alunos.",
    url: 'https://neofitflow.com.br/blog/antes-depois-sistema-retencao-cases-reais-transformadores',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores",
                item: "https://neofitflow.com.br/blog/antes-depois-sistema-retencao-cases-reais-transformadores",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Antes e Depois de Sistema de Retenção: Cases Reais Transformadores",
            description: "Compare métricas de academias antes e depois de implementar IA: evasão, MRR, tempo de gestão e satisfação de alunos.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Antes e Depois de Sistema de Retenção: Cases Reais Transformadores</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar antes e depois de sistema de retenção: cases reais transformadores, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Antes e Depois de Sistema de Retenção: Cases Reais Transformadores não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
