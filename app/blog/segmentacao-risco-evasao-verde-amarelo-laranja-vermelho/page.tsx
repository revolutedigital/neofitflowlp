...
export const metadata: Metadata = {
  title: "Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho | NeoFitFlow",
  description: "Sistema de classificação de alunos por nível de risco usando código de cores para priorização de ações.",
  keywords: "classificação risco, código cores, priorização ação, sistema semáforo",
  alternates: {
    canonical: '/blog/segmentacao-risco-evasao-verde-amarelo-laranja-vermelho',
  },
  openGraph: {
    title: "Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho",
    description: "Sistema de classificação de alunos por nível de risco usando código de cores para priorização de ações.",
    url: 'https://neofitflow.com.br/blog/segmentacao-risco-evasao-verde-amarelo-laranja-vermelho',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho",
                item: "https://neofitflow.com.br/blog/segmentacao-risco-evasao-verde-amarelo-laranja-vermelho",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho",
            description: "Sistema de classificação de alunos por nível de risco usando código de cores para priorização de ações.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar segmentação por risco de evasão: verde, amarelo, laranja, vermelho, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Segmentação Por Risco de Evasão: Verde, Amarelo, Laranja, Vermelho não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
