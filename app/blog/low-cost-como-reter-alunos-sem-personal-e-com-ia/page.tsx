...
export const metadata: Metadata = {
  ...
  description: "Low cost: sem personal, sem aulas. Retenção é desafio. IA vira o 'personal virtual': orienta, motiva, celebra, previne - em escala e baixo custo.",
  keywords: "retenção low cost ia, academia econômica retenção, personal virtual ia, sistema low cost, ia substitui personal",
  alternates: { canonical: '/blog/low-cost-como-reter-alunos-sem-personal-e-com-ia' },
  openGraph: {
    title: "Low Cost: Como Reter Alunos Sem Personal e Com IA",
    description: "Low cost: sem personal, sem aulas. Retenção é desafio. IA vira o 'personal virtual': orienta, motiva, celebra, previne - em escala e baixo custo.",
    url: 'https://neofitflow.com.br/blog/low-cost-como-reter-alunos-sem-personal-e-com-ia',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Low Cost: Como Reter Alunos Sem Personal e Com IA", item: "https://neofitflow.com.br/blog/low-cost-como-reter-alunos-sem-personal-e-com-ia" }
          ]
        })
      }} />
...
<h1>Low Cost: Como Reter Alunos Sem Personal e Com IA</h1>
