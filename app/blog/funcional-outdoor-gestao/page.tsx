...
export const metadata: Metadata = {
  title: "Treino Funcional Outdoor: Como Gerenciar e Crescer | NeoFitFlow",
  description: "Guia completo sobre treino funcional outdoor: como gerenciar e crescer. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "funcional outdoor gestao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/funcional-outdoor-gestao',
  },
  openGraph: {
    title: "Treino Funcional Outdoor: Como Gerenciar e Crescer",
    description: "Guia completo sobre treino funcional outdoor: como gerenciar e crescer",
    url: 'https://neofitflow.com.br/blog/funcional-outdoor-gestao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Funcional Outdoor: Gestão",
    description: "Guia completo sobre treino funcional outdoor: como gerenciar e crescer. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Funcional Outdoor: Gestão",
                item: "https://neofitflow.com.br/blog/funcional-outdoor-gestao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Treino Funcional Outdoor: Como Gerenciar e Crescer",
            description: "Guia completo sobre treino funcional outdoor: como gerenciar e crescer",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Treino Funcional Outdoor: Como Gerenciar e Crescer</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-13">13/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como treino funcional outdoor: como gerenciar e crescer, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Treino Funcional Outdoor: Como Gerenciar e Crescer não é apenas uma tendência - é uma necessidade para academias que querem
