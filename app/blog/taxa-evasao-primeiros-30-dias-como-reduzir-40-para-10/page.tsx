...
export const metadata: Metadata = {
  title: "Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10% | NeoFitFlow",
  description: "Estratégias específicas para o período mais crítico de evasão - os primeiros 30 dias após matrícula do aluno novo.",
  keywords: "evasão 30 dias, onboarding aluno, primeiros dias, retenção inicial",
  alternates: {
    canonical: '/blog/taxa-evasao-primeiros-30-dias-como-reduzir-40-para-10',
  },
  openGraph: {
    title: "Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10%",
    description: "Estratégias específicas para o período mais crítico de evasão - os primeiros 30 dias após matrícula do aluno novo.",
    url: 'https://neofitflow.com.br/blog/taxa-evasao-primeiros-30-dias-como-reduzir-40-para-10',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10%",
                item: "https://neofitflow.com.br/blog/taxa-evasao-primeiros-30-dias-como-reduzir-40-para-10",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10%",
            description: "Estratégias específicas para o período mais crítico de evasão - os primeiros 30 dias após matrícula do aluno novo.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10%</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar taxa de evasão nos primeiros 30 dias: como reduzir de 40% para 10%, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Taxa de Evasão nos Primeiros 30 Dias: Como Reduzir de 40% Para 10% não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
