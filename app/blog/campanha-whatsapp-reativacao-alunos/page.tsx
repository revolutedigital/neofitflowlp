...
export const metadata: Metadata = {
  title: "Campanha de Reativação no WhatsApp: Fluxo Completo Para Alunos Inativos | NeoFitFlow",
  description: "Guia completo sobre campanha de reativação no whatsapp: fluxo completo para alunos inativos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "campanha whatsapp reativacao alunos, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/campanha-whatsapp-reativacao-alunos',
  },
  openGraph: {
    title: "Campanha de Reativação no WhatsApp: Fluxo Completo Para Alunos Inativos",
    description: "Guia completo sobre campanha de reativação no whatsapp: fluxo completo para alunos inativos",
    url: 'https://neofitflow.com.br/blog/campanha-whatsapp-reativacao-alunos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Campanha WhatsApp de Reativação de Alunos",
    description: "Guia completo sobre campanha de reativação no whatsapp: fluxo completo para alunos inativos. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Campanha WhatsApp de Reativação de Alunos",
                item: "https://neofitflow.com.br/blog/campanha-whatsapp-reativacao-alunos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Campanha de Reativação no WhatsApp: Fluxo Completo Para Alunos Inativos",
            description: "Guia completo sobre campanha de reativação no whatsapp: fluxo completo para alunos inativos",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Campanha de Reativação no WhatsApp: Fluxo Completo Para Alunos Inativos</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-17">17/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como campanha de reativação no whatsapp: fluxo completo para alunos inativos, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Campanha de Reativação no WhatsApp: Fluxo Completo Para Alunos Inativos não é apenas uma tendência - é uma necessidade para academias que querem
