...
export const metadata: Metadata = {
  title: "Aulas de Natação: Como Gerenciar Horários e Turmas | NeoFitFlow",
  description: "Guia completo sobre aulas de natação: como gerenciar horários e turmas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "natacao gestao horarios, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/natacao-gestao-horarios',
  },
  openGraph: {
    title: "Aulas de Natação: Como Gerenciar Horários e Turmas",
    description: "Guia completo sobre aulas de natação: como gerenciar horários e turmas",
    url: 'https://neofitflow.com.br/blog/natacao-gestao-horarios',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Natação: Gestão de Horários",
    description: "Guia completo sobre aulas de natação: como gerenciar horários e turmas. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Natação: Gestão de Horários",
                item: "https://neofitflow.com.br/blog/natacao-gestao-horarios",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Aulas de Natação: Como Gerenciar Horários e Turmas",
            description: "Guia completo sobre aulas de natação: como gerenciar horários e turmas",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Aulas de Natação: Como Gerenciar Horários e Turmas</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-11">11/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como aulas de natação: como gerenciar horários e turmas, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Aulas de Natação: Como Gerenciar Horários e Turmas não é apenas uma tendência - é uma necessidade para academias que querem
