...
export const metadata: Metadata = {
  title: "Instagram Para Academia: Como Atrair Alunos e Criar Conteúdo | NeoFitFlow",
  description: "Guia completo sobre instagram para academia: como atrair alunos e criar conteúdo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "instagram academia atrair alunos, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/instagram-academia-atrair-alunos',
  },
  openGraph: {
    title: "Instagram Para Academia: Como Atrair Alunos e Criar Conteúdo",
    description: "Guia completo sobre instagram para academia: como atrair alunos e criar conteúdo",
    url: 'https://neofitflow.com.br/blog/instagram-academia-atrair-alunos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Instagram Para Academia: Como Atrair Alunos",
    description: "Guia completo sobre instagram para academia: como atrair alunos e criar conteúdo. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Instagram Para Academia: Como Atrair Alunos",
                item: "https://neofitflow.com.br/blog/instagram-academia-atrair-alunos",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Instagram Para Academia: Como Atrair Alunos e Criar Conteúdo",
            description: "Guia completo sobre instagram para academia: como atrair alunos e criar conteúdo",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Instagram Para Academia: Como Atrair Alunos e Criar Conteúdo</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-11-04">04/11/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como instagram para academia: como atrair alunos e criar conteúdo, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Instagram Para Academia: Como Atrair Alunos e Criar Conteúdo não é apenas uma tendência - é uma necessidade para academias que querem
