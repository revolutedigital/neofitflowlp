...
export const metadata: Metadata = {
  ...
  description: "Alunos engajados viram embaixadores. 1 aluno ativo contagia 3-5 outros. Como criar feedback loop positivo: depoimentos, indicações, grupos de treino.",
  ...
  alternates: { canonical: '/blog/feedback-loop-como-aluno-ativo-ajuda-a-reter-outros-alunos' },
  openGraph: {
    title: "Feedback Loop: Como Aluno Ativo Ajuda a Reter Outros Alunos",
    description: "Alunos engajados viram embaixadores. 1 aluno ativo contagia 3-5 outros. Como criar feedback loop positivo: depoimentos, indicações, grupos de treino.",
    url: 'https://neofitflow.com.br/blog/feedback-loop-como-aluno-ativo-ajuda-a-reter-outros-alunos',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Feedback Loop: Como Aluno Ativo Ajuda a Reter Outros Alunos", item: "https://neofitflow.com.br/blog/feedback-loop-como-aluno-ativo-ajuda-a-reter-outros-alunos" }
          ]
        })
      }} />
...
<h1>Feedback Loop: Como Aluno Ativo Ajuda a Reter Outros Alunos</h1>
