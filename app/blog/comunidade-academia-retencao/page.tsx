...
export const metadata: Metadata = {
  title: "Como Criar Comunidade na Academia Para Aumentar Retenção | NeoFitFlow",
  description: "Guia completo sobre como criar comunidade na academia para aumentar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "comunidade academia retencao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/comunidade-academia-retencao',
  },
  openGraph: {
    title: "Como Criar Comunidade na Academia Para Aumentar Retenção",
    description: "Guia completo sobre como criar comunidade na academia para aumentar retenção",
    url: 'https://neofitflow.com.br/blog/comunidade-academia-retencao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Comunidade na Academia e Retenção",
    description: "Guia completo sobre como criar comunidade na academia para aumentar retenção. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Comunidade na Academia e Retenção",
                item: "https://neofitflow.com.br/blog/comunidade-academia-retencao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Como Criar Comunidade na Academia Para Aumentar Retenção",
            description: "Guia completo sobre como criar comunidade na academia para aumentar retenção",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Como Criar Comunidade na Academia Para Aumentar Retenção</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-12-27">27/12/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como como criar comunidade na academia para aumentar retenção, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Como Criar Comunidade na Academia Para Aumentar Retenção não é apenas uma tendência - é uma necessidade para academias que querem
