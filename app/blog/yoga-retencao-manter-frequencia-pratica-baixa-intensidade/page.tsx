...
export const metadata: Metadata = {
  title: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade | NeoFitFlow",
  description: "Desafio único do yoga: manter engajamento em prática contemplativa sem intensidade física alta como gancho.",
  keywords: "yoga retenção, baixa intensidade, prática contemplativa, ia yoga",
  alternates: {
    canonical: '/blog/yoga-retencao-manter-frequencia-pratica-baixa-intensidade',
  },
  openGraph: {
    title: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade",
    description: "Desafio único do yoga: manter engajamento em prática contemplativa sem intensidade física alta como gancho.",
    url: 'https://neofitflow.com.br/blog/yoga-retencao-manter-frequencia-pratica-baixa-intensidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade",
                item: "https://neofitflow.com.br/blog/yoga-retencao-manter-frequencia-pratica-baixa-intensidade",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade",
            description: "Desafio único do yoga: manter engajamento em prática contemplativa sem intensidade física alta como gancho.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar yoga e retenção: como manter frequência em prática de baixa intensidade, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Yoga e Retenção: Como Manter Frequência em Prática de Baixa Intensidade não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
