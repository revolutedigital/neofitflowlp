...
export const metadata: Metadata = {
  title: "Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade | NeoFitFlow",
  description: "Como academias de escalada usam IA para monitorar progressão em rotas e manter motivação por conquistas.",
  keywords: "escalada indoor, boulder, progressão rotas, comunidade escalada",
  alternates: {
    canonical: '/blog/escalada-indoor-retencao-desafio-progressivo-comunidade',
  },
  openGraph: {
    title: "Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade",
    description: "Como academias de escalada usam IA para monitorar progressão em rotas e manter motivação por conquistas.",
    url: 'https://neofitflow.com.br/blog/escalada-indoor-retencao-desafio-progressivo-comunidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade",
                item: "https://neofitflow.com.br/blog/escalada-indoor-retencao-desafio-progressivo-comunidade",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade",
            description: "Como academias de escalada usam IA para monitorar progressão em rotas e manter motivação por conquistas.",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade</h1>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como dominar escalada indoor: retenção por desafio progressivo e comunidade, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Escalada Indoor: Retenção Por Desafio Progressivo e Comunidade não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
