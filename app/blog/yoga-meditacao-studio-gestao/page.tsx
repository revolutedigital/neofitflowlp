...
export const metadata: Metadata = {
  title: "Studio de Yoga e Meditação: Gestão e Marketing Consciente | NeoFitFlow",
  description: "Guia completo sobre studio de yoga e meditação: gestão e marketing consciente. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "yoga meditacao studio gestao, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/yoga-meditacao-studio-gestao',
  },
  openGraph: {
    title: "Studio de Yoga e Meditação: Gestão e Marketing Consciente",
    description: "Guia completo sobre studio de yoga e meditação: gestão e marketing consciente",
    url: 'https://neofitflow.com.br/blog/yoga-meditacao-studio-gestao',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Studio de Yoga e Meditação: Gestão",
    description: "Guia completo sobre studio de yoga e meditação: gestão e marketing consciente. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Studio de Yoga e Meditação: Gestão",
                item: "https://neofitflow.com.br/blog/yoga-meditacao-studio-gestao",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Studio de Yoga e Meditação: Gestão e Marketing Consciente",
            description: "Guia completo sobre studio de yoga e meditação: gestão e marketing consciente",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Studio de Yoga e Meditação: Gestão e Marketing Consciente</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-12">12/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como studio de yoga e meditação: gestão e marketing consciente, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Studio de Yoga e Meditação: Gestão e Marketing Consciente não é apenas uma tendência - é uma necessidade para academias que querem
