...
export const metadata: Metadata = {
  title: "Academia Pequena vs Grande: Estratégias de Gestão Para Cada Porte | NeoFitFlow",
  description: "Guia completo sobre academia pequena vs grande: estratégias de gestão para cada porte. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  keywords: "academia pequena vs grande, academia, gestão fitness, automação whatsapp",
  alternates: {
    canonical: '/blog/academia-pequena-vs-grande',
  },
  openGraph: {
    title: "Academia Pequena vs Grande: Estratégias de Gestão Para Cada Porte",
    description: "Guia completo sobre academia pequena vs grande: estratégias de gestão para cada porte",
    url: 'https://neofitflow.com.br/blog/academia-pequena-vs-grande',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
    card: "summary_large_image",
    title: "Academia Pequena vs Grande",
    description: "Guia completo sobre academia pequena vs grande: estratégias de gestão para cada porte. Aprenda estratégias práticas e comprovadas para melhorar resultados da sua academia.",
  },
};
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Academia Pequena vs Grande",
                item: "https://neofitflow.com.br/blog/academia-pequena-vs-grande",
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Academia Pequena vs Grande: Estratégias de Gestão Para Cada Porte",
            description: "Guia completo sobre academia pequena vs grande: estratégias de gestão para cada porte",
            author: {
              "@type": "Organization",
              name: "NeoFitFlow",
      ...
      <div className="min-h-screen bg-white text-black">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-600 mb-4">Específico</div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Academia Pequena vs Grande: Estratégias de Gestão Para Cada Porte</h1>

            <div className="text-gray-600 mb-12">
              Publicado em <time dateTime="2023-10-19">19/10/2023</time> • 8 min de leitura
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                como academia pequena vs grande: estratégias de gestão para cada porte, com estratégias práticas que você pode implementar hoje.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Academia Pequena vs Grande: Estratégias de Gestão Para Cada Porte não é apenas uma tendência - é uma necessidade para academias que querem
