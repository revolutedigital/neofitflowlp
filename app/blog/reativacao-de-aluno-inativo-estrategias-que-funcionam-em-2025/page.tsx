...
export const metadata: Metadata = {
  ...
  description: "Aluno inativo 30+ dias: taxa reativação 15-25% com abordagem certa. Mensagem empática + oferta específica + timing perfeito = volta dele.",
  ...
  alternates: { canonical: '/blog/reativacao-de-aluno-inativo-estrategias-que-funcionam-em-2025' },
  openGraph: {
    title: "Reativação de Aluno Inativo: Estratégias que Funcionam em 2025",
    description: "Aluno inativo 30+ dias: taxa reativação 15-25% com abordagem certa. Mensagem empática + oferta específica + timing perfeito = volta dele.",
    url: 'https://neofitflow.com.br/blog/reativacao-de-aluno-inativo-estrategias-que-funcionam-em-2025',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Reativação de Aluno Inativo: Estratégias que Funcionam em 2025", item: "https://neofitflow.com.br/blog/reativacao-de-aluno-inativo-estrategias-que-funcionam-em-2025" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Reativação de Aluno Inativo: Estratégias que Funcionam em 2025
              </h1>
...
<h1>Reativação de Aluno Inativo: Estratégias que Funcionam em 2025</h1>
