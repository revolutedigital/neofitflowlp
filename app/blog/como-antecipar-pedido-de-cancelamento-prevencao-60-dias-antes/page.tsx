...
export const metadata: Metadata = {
  ...
  description: "Maioria dos pedidos são previsíveis 60 dias antes. Score de risco + padrões comportamentais + IA = antecipar e agir antes. Sistema de early warning completo.",
  ...
  alternates: { canonical: '/blog/como-antecipar-pedido-de-cancelamento-prevencao-60-dias-antes' },
  openGraph: {
    title: "Como Antecipar Pedido de Cancelamento: Prevenção 60 Dias Antes",
    description: "Maioria dos pedidos são previsíveis 60 dias antes. Score de risco + padrões comportamentais + IA = antecipar e agir antes. Sistema de early warning completo.",
    url: 'https://neofitflow.com.br/blog/como-antecipar-pedido-de-cancelamento-prevencao-60-dias-antes',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Como Antecipar Pedido de Cancelamento: Prevenção 60 Dias Antes", item: "https://neofitflow.com.br/blog/como-antecipar-pedido-de-cancelamento-prevencao-60-dias-antes" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent leading-tight">
                Como Antecipar Pedido de Cancelamento: Prevenção 60 Dias Antes
              </h1>
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-01-17">16 de janeiro de 2025</time>
                <span>•</span>
...
<h1>Como Antecipar Pedido de Cancelamento: Prevenção 60 Dias Antes</h1>
