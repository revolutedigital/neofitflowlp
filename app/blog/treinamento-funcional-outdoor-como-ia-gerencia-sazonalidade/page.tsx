...
export const metadata: Metadata = {
  ...
  description: "Outdoor: clima afeta tudo. Chuva, frio, calor extremo = quedas previsíveis. IA antecipa, comunica alternativas, previne que pausa vire desistência.",
  ...
  alternates: { canonical: '/blog/treinamento-funcional-outdoor-como-ia-gerencia-sazonalidade' },
  openGraph: {
    title: "Treinamento Funcional Outdoor: Como IA Gerencia Sazonalidade",
    description: "Outdoor: clima afeta tudo. Chuva, frio, calor extremo = quedas previsíveis. IA antecipa, comunica alternativas, previne que pausa vire desistência.",
    url: 'https://neofitflow.com.br/blog/treinamento-funcional-outdoor-como-ia-gerencia-sazonalidade',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Treinamento Funcional Outdoor: Como IA Gerencia Sazonalidade", item: "https://neofitflow.com.br/blog/treinamento-funcional-outdoor-como-ia-gerencia-sazonalidade" }
          ]
        })
      }} />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <header className="mb-12">
              ...
              <div className="flex items-center gap-4 text-gray-600 text-sm">
                <time dateTime="2025-03-05">4 de março de 2025</time>
                <span>•</span>
...
<h1>Treinamento Funcional Outdoor: Como IA Gerencia Sazonalidade</h1>
