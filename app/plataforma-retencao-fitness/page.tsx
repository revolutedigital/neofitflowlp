...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/plataforma-retencao-fitness',
  },
  openGraph: {
    title: "Plataforma de Retenção Para Academia e Box Fitness | NeoFitFlow",
    description: "Plataforma all-in-one para retenção: IA detecta risco, WhatsApp age preventivamente, dashboard mostra alunos em risco. Tudo integrado.",
    url: 'https://neofitflow.com.br/plataforma-retencao-fitness',
    type: "website",
    locale: "pt_BR",
  },
  twitter: {
      ...
      <article className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">Plataforma Completa de Retenção Com IA, WhatsApp e Dashboard em Tempo Real</h1>
            <p className="text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Plataforma completa com todos os recursos necessários para reduzir evasão: IA, automação WhatsApp e analytics.
            </p>
            <a
