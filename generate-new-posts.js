...
// Load the structure
const structure = JSON.parse(fs.readFileSync('new-posts-structure.json', 'utf8'));
...
console.log(`\n✅ Complete! Created ${totalCreated} new posts, skipped ${totalSkipped} existing posts.`);

function generatePostContent(post) {
  // Extract category-specific intro based on category_tag
  const categoryIntros = {
    "IA e Prevenção": "A inteligência artificial está revolucionando a forma como academias identificam e previnem evasão de alunos. Neste guia, vamos explorar como a tecnologia pode transformar seu negócio.",
    "Impacto Financeiro": "Entender o impacto financeiro da evasão é o primeiro passo para justificar investimentos em retenção. Vamos analisar números reais e calcular o verdadeiro custo da perda de alunos.",
    "Sinais de Risco": "Identificar sinais precoces de evasão é crucial para agir preventivamente. Descubra os padrões comportamentais que indicam risco de cancelamento.",
    "Ação Preventiva": "Ação preventiva é mais eficaz e econômica que tentar recuperar alunos após cancelamento. Aprenda como agir no momento certo com a abordagem correta.",
    "Casos Por Modalidade": "Cada modalidade fitness tem características únicas de retenção. Entenda as especificidades e estratégias adaptadas para seu tipo de academia."
  };

  const categoryIntro = categoryIntros[post.category_tag] || "Se você é dono de academia, sabe o quanto é desafiador manter alunos engajados e prevenir evasão.";

  return `import type { Metadata } from "next";
import Link from "next/link";

export const metadata: Metadata = {
  title: "${post.title} | NeoFitFlow",
  ...
  openGraph: {
    title: "${post.title}",
    description: "${post.description}",
    url: 'https://neofitflow.com.br/blog/${post.slug}',
    type: "article",
    locale: "pt_BR",
  },
  twitter: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: "${post.title}",
                item: "https://neofitflow.com.br/blog/${post.slug}",
              },
            ],
          }),
        }}
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <article className="pt-32 pb-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-400 mb-4">${post.category_tag}</div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6">
                ${categoryIntro} Este guia completo vai te mostrar exatamente
                como dominar ${post.title.toLowerCase()}, com estratégias práticas que você pode implementar hoje mesmo na sua academia.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6">
                ...
                em tempo real. Sistemas como o <a href="/" className="text-white underline font-bold">NeoFitFlow</a> monitoram
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">• Levante taxa de evasão mensal atual</p>
                      <p className="text-gray-300">• Identifique principais causas reportadas</p>
                      <p className="text-gray-300">• Calcule CAC e LTV médio dos alunos</p>
                      <p className="text-gray-300">• Estabeleça meta realista de redução (ex: -15% evasão em 90 dias)</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-2xl">□</span>
                    <div>
                      ...
                      <p className="text-gray-300">• Escolha plataforma de IA para retenção (ex: NeoFitFlow)</p>
                      <p className="text-gray-300">• Integre com sistema de gestão existente</p>
                      <p className="text-gray-300">• Configure WhatsApp Business API</p>
                      <p className="text-gray-300">• Defina regras de risco (ex: 3 faltas = vermelho)</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-2xl">□</span>
                    <div>
                      ...
                      <p className="text-gray-300">• Monte fluxos de mensagens para diferentes cenários</p>
                      <p className="text-gray-300">• Teste tom e linguagem com pequeno grupo</p>
                      <p className="text-gray-300">• Treine equipe para acompanhar alertas e dashboard</p>
                      <p className="text-gray-300">• Estabeleça protocolo de escalação (quando humano deve intervir)</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-2xl">□</span>
                    <div>
                      ...
                      <p className="text-gray-300">• Ative monitoramento automático para todos os alunos</p>
                      <p className="text-gray-300">• Acompanhe taxa de resposta às mensagens</p>
                      <p className="text-gray-300">• Ajuste fluxos conforme feedback inicial</p>
                      <p className="text-gray-300">• Compare evasão semanal vs baseline</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-2xl">□</span>
                    <div>
                      ...
                      <p className="text-gray-300">• Analise quais mensagens têm melhor taxa de retorno</p>
                      <p className="text-gray-300">• Refine segmentação por perfil e modalidade</p>
                      <p className="text-gray-300">• Expanda para outros casos de uso (renovações, upsell)</p>
                      <p className="text-gray-300">• Calcule ROI do sistema vs alunos salvos</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="border-2 border-white p-6">
                  ...
                  <p className="text-gray-300">
                    <a href="/" className="text-white underline font-bold">NeoFitFlow</a> oferece detecção automática
              ...
              <p className="text-lg leading-relaxed mb-6">
                ${post.title} não é mais opcional no mercado fitness de 2025 - é uma necessidade estratégica
              ...
              <div className="bg-gray-900 border-2 border-white p-6 my-8">
                ...
                <ul className="space-y-2">
                  <li><Link href="/blog/como-ia-identifica-aluno-risco-cancelamento-antes-sair" className="text-white hover:text-gray-300 underline">→ Como IA Identifica Aluno em Risco de Cancelamento Antes de Sair</Link></li>
                  <li><Link href="/blog/dashboard-risco-tempo-real-monitore-cancelamentos-com-ia" className="text-white hover:text-gray-300 underline">→ Dashboard de Risco em Tempo Real: Monitore Cancelamentos 24/7</Link></li>
                  <li><Link href="/blog/prevenir-evasao-antes-aconteca-estrategia-preventiva-ia" className="text-white hover:text-gray-300 underline">→ Prevenir Evasão Antes Que Aconteça: Estratégia Preventiva Com IA</Link></li>
                  <li><Link href="/blog/custo-real-evasao-sua-academia-calculadora-completa" className="text-white hover:text-gray-300 underline">→ Custo Real da Evasão: Calculadora Completa</Link></li>
                </ul>
              </div>
            </div>
